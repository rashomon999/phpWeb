...
<div class="seccion izquierda">
    ...
    <h3>Ejecutar Código Scala</h3>
<textarea id="codigo" name="codigo" rows="10" cols="50" value="<?php echo $codigo; ?>" ><?php echo $codigo; ?></textarea>
<br>
...
async function ejecutarCodigo2() {
    ...
    <hr>
    <strong>Declarar un metodo que siempre que lo llame me devuelva una nueva instancia una lista "numeros": </strong>
    <br><br>
    <textarea id="codigo2" name="codigo2" rows="10" cols="50" value="<?php echo $codigo2; ?>" ><?php echo $codigo2; ?></textarea>
    <br>
