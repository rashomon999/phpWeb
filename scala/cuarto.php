...
<div class="seccion izquierda">
    ...
    <strong>¿Se puede hacer más eficiente? (convertir a con cola)</strong>

    <strong>Observaciones:</strong>
    <ul>
        <li><strong>Tiempo</strong> ≡ Número de nodos en el árbol de recursión.</li>
        <li><strong>Espacio</strong> ≡ Profundidad del árbol de llamadas.</li>
        <li><span class="highlight">Fácil de programar</span>, pero no siempre eficiente.</li>
        <li><span class="highlight">Mayor eficiencia ⇒ Menos natural</span> en su implementación.</li>
    </ul>

    <strong>Optimización de Fibonacci</strong>
    <p>Observemos el patrón de la sucesión:</p>

    <pre>
0, 1, 1, 2, 3 <span class="highlight">+</span> 5, 8, 13 <span class="highlight">+</span> 21, ...
    </pre>

    <p>Podemos optimizar Fibonacci usando <strong>dos acumuladores</strong> y un <strong>contador</strong>:</p>

    <code>
    import scala.annotation.tailrec
    <br><br>
    @tailrec <br><br>
    def fibIter(a: Int, b: Int, n: Int): Int =  <br><br>
    if (n == 0) b   <br><br>
    else fibIter(a + b, a, n - 1) <br><br>

    def fibonacci(n: Int): Int = fibIter(1, 0, n) <br><br>
    </code>

    <strong>¿Por qué es más eficiente?</strong>
    <ul>
        <li>Usa <strong>recursión de cola</strong>, evitando la sobrecarga de llamadas recursivas.</li>
        <li>Elimina la generación del <strong>árbol de llamadas</strong>, reduciendo el número de cálculos repetidos.</li>
        <li>Reduce el <strong>uso de memoria</strong>, ya que solo mantiene dos valores en cada iteración.</li>
    </ul>

    <strong>Ejemplo de ejecución para <code>fibonacci(5)</code>:</strong>
    <pre>
fibIter(1, 0, 5)
↠ fibIter(1, 1, 4)
↠ fibIter(2, 1, 3)
↠ fibIter(3, 2, 2)
↠ fibIter(5, 3, 1)
↠ fibIter(8, 5, 0) → Resultado: 5
    </pre>

    <strong>Conclusión</strong>
    <p>Con esta técnica, logramos una implementación <strong>más rápida y eficiente</strong>, evitando la recursión sin cola y aprovechando <strong>acumuladores</strong> para reducir la complejidad temporal y espacial.</p>
...
<p>
    Las funciones que descomponen la entrada en sus partes y procesan luego la parte 
    que tiene la misma forma de la entrada se llaman 
    <span class="highlight">funciones con recursión estructural</span>.
</p>

<p>Ejemplos comunes de recursión estructural:</p>
<ul>
    <li><strong>Listas</strong>: Se basan en la estructura de cabeza-cola.</li>
    <li><strong>Números enteros</strong>: Se procesan restando uno hasta llegar a cero.</li>
</ul>

<strong>Recursión Generativa</strong>
<p>
    Cuando la recursión no se hace teniendo en cuenta la estructura de la entrada, sino en 
    la solución de subproblemas que permiten obtener una solución general, se llama 
    <span class="highlight">recursión generativa</span>.
</p>

<p>La recursión generativa se aplica en la estrategia de resolución de problemas conocida como:</p>
