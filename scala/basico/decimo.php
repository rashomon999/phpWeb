...
<div class="seccion izquierda">
    ...
    <h1>El Guion Bajo (_) en Scala</h1>
    <p>El guion bajo (_) en Scala tiene varios usos dependiendo del contexto. Aquí tienes una lista detallada:</p>
    
    <h2>1. En Patrones de match case (Comodín, 2 casos)</h2>
    <p>1.Ignorar un valor en match case</p>
    <p>2.case _ para manejar cualquier caso</p>
    <p>Se usa como un comodín en una coincidencia de patrones cuando no nos importa el valor.</p>
    <pre>
val tupla = (1, "Scala")
tupla match {
  case (x, _) => println(s"El primer valor es $x")
}
    </pre>
    <pre>
val num = 5
num match {
  ...
  case 2 => println("Es dos")
  case _ => println("Es otro número")
}
    </pre>
    
    <h2>2. Para Acceder a Elementos de una Tupla (_._1, _._2, etc.)</h2>
    <pre>
val lista = List((10, "a"), (20, "b"), (30, "c"))
val primeros = lista.map(_._1)
println(primeros) // List(10, 20, 30)
    </pre>
    
    <h2>3. En Funciones Anónimas (Lambdas) (no sirve en scala 3)</h2>
    <pre>
val numeros = List(1, 2, 3, 4)
val cuadrados = numeros.map(_ * _)
println(cuadrados) // List(1, 4, 9, 16)
    </pre>
    
    <h2>4. En Importaciones (import _)</h2>
    <pre>
import scala.io._
    </pre>
    
    <h2>5. Como Parámetro Ignorado en una Función</h2>
    <pre>
def imprimirMensaje(mensaje: String, _: Int): Unit = {
  println(mensaje)
}
imprimirMensaje("Hola", 42) // "Hola"
    </pre>
    
    <h2>6. En _ => para Expresiones de No Uso</h2>
    <pre>
val lista = List(1, 2, 3, 4)
val sinUsar = lista.map(_ => 100)
println(sinUsar) // List(100, 100, 100, 100)
    </pre>
    
    <h2>7. En _* para Expandir Argumentos de una Lista</h2>
    <pre>
def sumar(nums: Int*): Int = nums.sum
val listaNumeros = List(1, 2, 3)
val resultado = sumar(listaNumeros: _*)
println(resultado) // 6
    </pre>
    
    <h2>Resumen Rápido del Uso de _</h2>
    <table>
        <tr>
            <th>Uso</th>
            <th>Ejemplo</th>
        ...
        <tr>
            <td>Comodín en match case</td>
            <td>case _ => "Otro caso"</td>
        </tr>
        <tr>
            <td>Acceder a tuplas</td>
            <td>lista.map(_._1)</td>
        </tr>
        <tr>
            <td>Funciones anónimas</td>
            <td>lista.map(_ * 2)</td>
        </tr>
        <tr>
            <td>Importar todo</td>
            <td>import scala.io._</td>
        </tr>
        <tr>
            <td>Parámetro ignorado</td>
            <td>def foo(x: Int, _: String) = x</td>
        </tr>
        <tr>
            <td>Ignorar valores en map</td>
            <td>lista.map(_ => 100)</td>
        </tr>
        <tr>
            <td>Expandir listas con _*</td>
            <td>sumar(lista: _*)</td>
        </tr>
    </table>
    </form>
