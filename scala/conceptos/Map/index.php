...
<div class="seccion izquierda">
    ...
    <h4>Map:</h4>
    <p>Una función como map es una función de orden superior, porque:
    Recibe otra función como parámetro.</p>
     
    <div class="section">
    <span class="check">✅ ¿Qué hace?</span><br>
    Una función <code>map</code> recibe una función transformadora y la aplica a cada elemento de una lista (u otra estructura), devolviendo una nueva lista con los resultados.
  </div>
    <br>
    <div class="section">
    ...
    <br>
    val nuevaLista = lista.map(x => x * 10)
    </div>
    <br>
    <ul>
      <li><code>x => x * 10</code> es la <strong>función transformadora</strong></li>
      <li><code>map</code> la aplica a cada elemento de <code>lista</code></li>
      <li><strong>Resultado:</strong> <code>List(10, 20, 30)</code></li>
    </ul>
  </div>

  <strong>🛠️ Esto es tu propia versión de <code>map</code>:</strong>
    <div class="code-block">
    def mapInt(f: Int => Int, lista: List[Int]): List[Int] = lista match {
        case Nil     => Nil
