...
if ($_POST) {
   ...
   if ($respuesta_1 === 'def numeros = List("Kevin", "Dave", "Bob")') {  
...
<div class="seccion izquierda">
    ...
    <h2>BigInt y BigDecimal</h2>
    <p>Cuando necesitas números realmente grandes, usa los tipos <code>BigInt</code> y <code>BigDecimal</code>:</p>
    <pre>
    <code>
...
var b = BigDecimal(123_456.789)
    ...
    <p>Mientras que <code>Double</code> y <code>Float</code> son aproximaciones de números decimales, <code>BigDecimal</code> se usa para cálculos aritméticos precisos.</p>

    <h2>String y Char</h2>
    <p>Scala también tiene los tipos de datos <code>String</code> y <code>Char</code>:</p>
    <pre>
    <code>
...
val c = 'a'         // Char
    ...
    <h2>Strings en Scala</h2>
    <p>Las cadenas en Scala son similares a las de Java, pero incluyen dos características adicionales:</p>
    <ul>
        <li>Soportan interpolación de cadenas.</li>
        <li>Es fácil crear cadenas multilínea.</li>
    </ul>

    <h2>Interpolación de Cadenas</h2>
    <p>La interpolación permite usar variables dentro de cadenas de manera más legible. Por ejemplo:</p>
    <pre>
    <code>
val firstName = "John"
val mi = 'C'
...
println(s"Name: $firstName $mi $lastName")   // "Name: John C Doe"
    ...
    <p>Solo debes preceder la cadena con <code>s</code> y usar <code>$</code> antes del nombre de la variable.</p>

    <h3>Expresiones en Interpolación</h3>
    <p>Puedes incluir expresiones dentro de llaves <code>{}</code>:</p>
    <pre>
    <code>
...
println(s"x.abs = ${x.abs}")   // prints "x.abs = 1"
    ...
    <p>También puedes usar otros interpoladores, como <code>f</code> para formato estilo <code>printf</code>.</p>

    <h2>Cadenas Multilínea</h2>
    <p>Se crean usando tres comillas dobles (<code>"""</code>):</p>
    <pre>
    <code>
val quote = """The essence of Scala:
    ...
    <p>Para más detalles sobre interpoladores y cadenas multilínea, consulta la documentación de Scala.</p>
    Es decir: <br><br> Comillas dobles "" → Para cadenas de una sola línea. <br><br>
    Comillas triples """ → Para cadenas de varias líneas (multiline strings).
    <hr>
    </form>
</div>
...
<div class="seccion derecha">
    <form action="./segundo.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
    <strong>Estructuras de Control en Scala:</strong>
 
    <p>Scala tiene las estructuras de control que se encuentran en otros lenguajes de
    programación y también cuenta con expresiones <code>for</code> avanzadas y expresiones
    <code>match</code>:</p>

    <ul>
        <li><code>if/else</code></li>
        <li>Bucles <code>for</code> y expresiones</li>
        <li>Expresiones <code>match</code></li>
        <li>Bucles <code>while</code></li>
        <li>Bloques <code>try/catch</code></li>
    </ul>
    ...
    <strong>Listas en Scala</strong>
 
    <p>La lista es una estructura de datos fundamental para la programación funcional.</p>

    <p>Una lista con los elementos <code>x1, ..., xn</code> se escribe en Scala como:</p>
    <pre><code>List(x1, ..., xn)</code></pre>

    <strong>Ejemplos</strong>
    <pre><code>
    def numeros = List(1, 2, 3, 4)
    def lDEl = List(List(1, 0, 0), List(0, 1, 0), List(0, 0, 1))
    def vacia = List(). (nota: expresion, no codigo ni nada ejecutable)
    </code></pre>

    <strong>Características de las Listas</strong>
    <ul>
        <li><strong>Inmutables:</strong> No pueden ser modificadas después de su creación.</li>
        <li><strong>Recursivas:</strong> Se pueden definir en términos de sí mismas.</li>
    </ul>

    "Introduce una definición sin parámetros en Scala usando def, que represente una lista 
    de tipo List[String] con los elementos "Kevin", "Dave", "Bob"." <br><br>
    <input type="text" name="respuesta_1" value="<?php echo htmlspecialchars($respuesta_1, ENT_QUOTES, 'UTF-8'); ?>" size="35">
    <br><br>
    ...
    <p>Las listas en Scala se construyen a partir de dos constructores principales:</p>

    <ul>
        <li>La lista vacía: <code>Nil</code></li>
        <li>El operador de construcción: <code>::</code> (se pronuncia "cons")</li>
    </ul>

    
    <strong>Uso del Operador</strong>  
      <code>::</code>

 
    <p>El operador <code>::</code> se utiliza para construir una lista colocando un elemento al inicio de otra lista.</p>
    
    Ejemplo de uso:
    <pre>
    <code>
val lista = 1 :: 2 :: 3 :: Nil
println(lista)  // Salida: List(1, 2, 3)
    </code>
    </pre>

    Este operador sigue la estructura:
    <pre>
    <code>
    x :: xs
    </code>
    ...
    <p>Donde:</p>
    <ul>
        <li><code>x</code> es el primer elemento de la lista.</li>
        <li><code>xs</code> es el resto de la lista.</li>
    </ul>
    ...
    <strong>Tener en cuenta: </strong> <br><br>
    :: no une dos listas existentes, sino que agrega un solo elemento a la cabeza de otra lista.
    <br><br>
    utiliza cons para definir la lista de "Kevin", "Dave", "Bob".
    <br><br>
    <input type="text" name="respuesta_2" value="<?php echo htmlspecialchars($respuesta_2, ENT_QUOTES, 'UTF-8'); ?>" size="35">
    <br><br><br><br><br>
    <hr>
    </form>
</div>
