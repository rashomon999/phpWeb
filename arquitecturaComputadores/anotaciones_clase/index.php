...
<div class="box">
  <strong>Regla:</strong>
  <ul>
    <li><strong>Bit 8 = 0</strong> → truncar.</li>
    <li><strong>Bit 8 = 1</strong> → redondear sumando 1 a la parte decimal (mantisa).</li>
  </ul>
</div>
...
<p><em>(El primer 1 no es parte del patrón repetitivo, el ciclo es <span class="mono">0110</span>).</em></p>

<h2>2️⃣ Q6.7: tomar 7 bits fraccionales y revisar bit 8</h2>
<p>Bits fraccionales (7): <span class="mono bits">1011001</span></p>
<p>Bit 8 = <strong>1</strong> → <strong>redondear</strong>.</p>

<h2>3️⃣ Aplicar redondeo</h2>
<p>Antes de redondear:</p>
<p class="mono bits">0&nbsp;011100,1011001</p>
<p>Redondeando la parte fraccional:</p>
<p class="mono bits">1011001<sub>2</sub> + 1 = 1011010<sub>2</sub></p>

<h2>4️⃣ Resultado final</h2>
<p>Bits Q6.7 (con coma binaria y barra de periódico sobre el patrón):</p>
<p class="mono bits">0&nbsp;011100,1<span class="over">0110</span> &nbsp;⇒&nbsp; (almacenado como) <strong>0&nbsp;011100,1011010</strong></p>
...
<h3>Interpretación de la parte fraccional <span class="mono">1011010</span></h3>
<p class="mono eq">Fracción = 2<sup>−1</sup> + 2<sup>−3</sup> + 2<sup>−4</sup> + 2<sup>−6</sup> = 0.5 + 0.125 + 0.0625 + 0.015625 = <strong>0.703125</strong></p>

<p class="mono eq">Valor total: 28 + 0.703125 = <strong>28.703125</strong></p>
