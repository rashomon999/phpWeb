...
<div class="seccion izquierda"> 
  ...
  <p>
    El siguiente ejercicio permite el análisis de desempeño de un programa que realiza la
    transposición parcial de una matriz y la suma de sus elementos en espejo. Este tipo de
    operación se utiliza en procesamiento de imágenes (rotaciones, detección de simetrías),
    machine learning (normalización de pesos en redes neuronales) y computación científica
    (análisis de correlaciones simétricas).
  </p>
  <p>
    El experimento busca evaluar el impacto de la localidad de memoria y la política de mapeo
    en caché sobre el desempeño de dos versiones del mismo programa, escritas en C++.
  </p>
  ...
  <table border="1" cellpadding="6" cellspacing="0">
    ...
    <tbody>
      <tr>
        <td><strong>Tamaño de memoria principal</strong></td>
        <td>2 kB</td>
      </tr>
      <tr>
        <td><strong>Latencia de acceso a la DRAM</strong></td>
        <td>20 ns</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><strong>Latencia de acceso a Cache</strong></td>
        <td>2 ns</td>
      </tr>
      <tr>
        <td><strong>Tamaño de bloque Cache</strong></td>
        <td>16 B</td>
      </tr>
      <tr>
        <td><strong>Mapeo Cache</strong></td>
        <td>Direct Mapped</td>
      </tr>
      <tr>
        <td><strong>Dirección inicial de matriz A</strong></td>
        <td>200h</td>
      </tr>
    </tbody>
  </table>

  <h3>Condiciones y suposiciones del experimento</h3>
  <p>
    La matriz <strong>A</strong> se almacena en memoria principal de forma consecutiva iniciando
    en la dirección <strong>200h</strong>.
  </p>
  <p>
    Los índices y el acumulador (<strong>total</strong>) se almacenan en registros del procesador,
    es decir que para el análisis solo considere los accesos a la matriz <strong>A</strong>.
  </p>
  <p>
    Las dos versiones de programa son las siguientes:
  </p>
...
for (int i = 0; i &lt; n; i += 2) {
  ...
  <p>
    <strong>Nota:</strong> Los valores y supuestos (tamaños, latencias, dirección inicial) se usan
    para calcular tiempos de acceso y tasas de misses/hits en la simulación del experimento.
  </p>

  <h3>TABLA CORRECTA – VERSIÓN A (n=4)</h3>

<table border="1" cellspacing="0" cellpadding="4">
  <tr>
    <th></th><th>0</th><th>1</th><th>2</th><th>3</th>
  </tr>
  <tr><td>0</td><td>1,2</td><td>3,10</td><td>5,18</td><td>7,26</td></tr>
  <tr><td>1</td><td>4,9</td><td>11,12</td><td>13,20</td><td>15,28</td></tr>
  <tr><td>2</td><td>6,17</td><td>14,19</td><td>21,22</td><td>23,30</td></tr>
  <tr><td>3</td><td>8,25</td><td>16,27</td><td>24,29</td><td>31,32</td></tr>
</table>

<br>

<h3>VERSIÓN B (CORRECTA – ya estaba bien)</h3>

<table border="1" cellspacing="0" cellpadding="4">
  <tr>
    <th></th><th>0</th><th>1</th><th>2</th><th>3</th>
  </tr>
  <tr><td>0</td><td>1,2</td><td>3,6</td><td>9,18</td><td>11,22</td></tr>
  <tr><td>1</td><td>4,5</td><td>7,8</td><td>13,20</td><td>15,24</td></tr>
  <tr><td>2</td><td>10,17</td><td>14,19</td><td>25,26</td><td>27,30</td></tr>
  <tr><td>3</td><td>12,21</td><td>16,23</td><td>28,29</td><td>31,32</td></tr>
</table>

<p>→ <strong>32 accesos</strong>, 4 misses, 12.5% miss rate, 315.2 ns</p>

<h3>Determinación de la complejidad algorítmica</h3>

<h4>Versión 1 (Original)</h4>
...
<p>Hay n × n = n² iteraciones.</p>

<p>En cada iteración:</p>
<ul>
  <li>1 multiplicación</li>
  <li>1 suma</li>
</ul>

<p><strong>Total de operaciones:</strong> n² + n² = 2n²</p>
<p><strong>Complejidad algorítmica:</strong> O(n²)</p>
...
<p>Hay (n/2) × (n/2) = n²/4 iteraciones.</p>

<p>En cada iteración:</p>
<ul>
  <li>4 multiplicaciones</li>
  <li>4 sumas</li>
</ul>

<p><strong>Total de operaciones:</strong> (n²/4) × 8 = 2n²</p>
<p><strong>Complejidad algorítmica:</strong> O(n²)</p>
...
<p>Ambas versiones tienen complejidad algorítmica <strong>O(n²)</strong>.</p>

<p>
<strong>Versión 1:</strong> n² multiplicaciones + n² sumas → 2n² operaciones.<br>
<strong>Versión 2:</strong> n² multiplicaciones + n² sumas → 2n² operaciones.
</p>

<p>El unrolling no cambia la complejidad.</p>
