...
<div class="seccion izquierda"> 
  ...
  <div class="container">
    ...
    <h2> ¿Qué es DSP?</h2>
    <p>
      El <strong>Procesamiento Digital de Señales (DSP)</strong> es el conjunto de técnicas matemáticas
      y computacionales que se usan para:
    </p>
    <p>
      <em>analizar, transformar, mejorar o extraer información de señales usando computadoras
      o sistemas digitales.</em>
    </p>

    <p>Una señal puede ser, por ejemplo:</p>
    <ul>
      <li>Audio (voz, música)</li>
      <li>Imágenes</li>
      <li>Video</li>
      <li>Señales biomédicas (ECG, EEG)</li>
      <li>Señales de sensores</li>
      <li>Señales de comunicaciones (radio, WiFi, celular)</li>
    </ul>

    <h2> ¿Qué hace el DSP en la práctica?</h2>
    <p>Con DSP se pueden hacer cosas como:</p>
    <ul>
      <li> Quitar ruido a un audio</li>
      <li> Mejorar la calidad de una imagen</li>
      <li> Transmitir datos por radio o internet</li>
      <li> Analizar señales del corazón</li>
      <li> Procesar señales de sensores en robots</li>
      <li> Detectar patrones en señales</li>
    </ul>

    <h2> ¿Por qué DSP se relaciona con tu tema de Q6.7 y punto fijo?</h2>
    <p>Porque en DSP:</p>
    <ul>
      <li>Se trabaja con números reales</li>
      <li>Pero las computadoras solo almacenan números finitos en binario</li>
    </ul>

    <p>Entonces se usan:</p>
    <ul>
      <li>Punto flotante (float)</li>
      <li>Punto fijo (fixed-point, Q-format) ← 👉 aquí entra tu Q6.7</li>
    </ul>

    <p>Y aparecen problemas como:</p>
    <ul>
      <li>Cuantización</li>
      <li>Redondeo</li>
      <li>Truncamiento</li>
      <li>Error numérico</li>
    </ul>

    <p>Por eso:</p>
    <ul>
      <li>El libro de <strong>Lyons (DSP)</strong> te da la base teórica</li>
      <li>El documento de <strong>Texas Instruments</strong> te da la base técnica del Q-format</li>
      <li>Tu conversión a <strong>Q6.7</strong> es una aplicación directa de DSP en hardware</li>
    </ul>

    <h2> Definición corta para tu informe (lista para pegar)</h2>
    <div class="highlight">
      <p>
        El <strong>Procesamiento Digital de Señales (DSP, por sus siglas en inglés)</strong> es el área
        de la ingeniería que estudia el análisis y la transformación de señales mediante sistemas
        digitales, empleando algoritmos matemáticos para el filtrado, la compresión, la transmisión
        y la mejora de señales como audio, imágenes y datos de sensores. En DSP es fundamental el uso
        de representaciones finitas como el punto fijo (Q-format), lo que introduce efectos de
        cuantización, truncamiento y redondeo.
      </p>
    </div>
