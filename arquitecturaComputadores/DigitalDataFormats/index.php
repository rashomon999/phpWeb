...
<h4>Abordaremos 2 textos:</h4>
    <h6>Understanding Digital Signal Processing — Richard G. Lyons</h6>
    <p class="lead">
      <strong>Descripción breve:</strong>
      Texto introductorio y práctico sobre procesamiento digital de señales (DSP) que explica conceptos fundamentales —señales discretas, muestreo,
      transformadas (DFT/FFT), diseño de filtros (FIR/IIR), y efectos prácticos como cuantización y finite word-length— con ejemplos intuitivos y aplicaciones.
    </p>

     <h6>Fixed-Point Arithmetic: An Introduction — Texas Instruments</h6>
    <p class="lead">
      <strong>Descripción breve:</strong>
      Documento técnico que explica en profundidad la aritmética de punto fijo (fixed-point), el uso de formatos Q (Qm.n), la conversión entre valores reales y representaciones binarias,
      y las consecuencias prácticas como saturación, overflow, truncamiento y redondeo en sistemas digitales con precisión limitada.
    </p>

<hr>
  <h1>Capítulo Doce. Formatos de Datos Digitales y Sus Efectos</h1>

  <p>En el procesamiento digital de señales, existen muchas maneras de representar datos numéricos en hardware de cómputo.</p>

  <p>Estas representaciones, conocidas como <strong>formatos de datos</strong>, tienen un efecto profundo en la <strong>precisión</strong> y en la <strong>facilidad de implementación</strong> de cualquier algoritmo dado de procesamiento de señales.</p>

  <p>Los formatos de datos más simples permiten usar diseños de hardware <em>no complicados</em>, pero a expensas de un <em>rango restringido</em> de representación numérica y una <em>susceptibilidad a errores aritméticos</em>.</p>

  <p>Los formatos de datos más elaborados son algo difíciles de implementar en hardware, pero nos permiten manipular números muy grandes y muy pequeños, mientras proporcionan inmunidad a muchos problemas asociados con la aritmética digital.</p>

  <p>El formato de datos elegido para cualquier aplicación dada puede significar la diferencia entre el <strong>éxito y el fracaso</strong> del procesamiento —es donde “la goma de nuestro algoritmo toca el camino”.</p>

  <p>En este capítulo, introduciremos los tipos más comunes de formatos digitales de <strong>punto fijo</strong> y mostraremos por qué y cuándo se usan.</p>

  <p>Luego, usaremos las operaciones de conversión <strong>analógica-digital (A/D)</strong> para establecer la <strong>precisión</strong> y el <strong>rango dinámico</strong> que estos formatos de punto fijo ofrecen, junto con los errores inherentes encontrados en su uso.</p>

  <p>Finalmente, cubriremos el interesante tema de los <strong>formatos binarios de punto flotante</strong>.</p>


    <h2>12.1 Formatos Binarios de Punto Fijo</h2>

  <p>Dentro del hardware digital, los números están representados por dígitos binarios conocidos como bits —de hecho, el término <em>bit</em> se originó de las palabras <em>Binary digIT</em>. Un solo bit puede estar únicamente en uno de dos estados posibles: o bien un uno, o bien un cero.</p>

  <p>† Un número binario de seis bits podría, por ejemplo, tomar la forma <strong>101101</strong>, teniendo el bit más a la izquierda el nombre de <strong>bit más significativo (msb)</strong>; el bit más a la derecha se llama <strong>bit menos significativo (lsb)</strong>.</p>

  <p>El número de bits en un número binario se conoce como su <strong>longitud de palabra</strong> —por lo tanto, <strong>101101</strong> tiene una longitud de palabra de seis.</p>

  <p>Al igual que en el sistema de números decimales tan familiar para nosotros, el sistema de números binarios asume un <strong>peso</strong> asociado con cada dígito en el número. Ese peso es la base del sistema (dos para números binarios y diez para números decimales) elevada a una potencia entera.</p>

  <p>Para ilustrar esto con un ejemplo simple, el número decimal <strong>4631</strong> es</p>

  <p>† Los números binarios se usan porque los pioneros de las primeras computadoras electrónicas se dieron cuenta rápidamente de que era mucho más práctico y confiable usar dispositivos eléctricos (relevos, tubos de vacío, transistores, etc.) que tuvieran solo dos estados, encendido o apagado. Así, el estado encendido/apagado de un dispositivo podía representar un único dígito binario.</p>


         <div class="equation">
                <strong>Ecuación (12-1)</strong><br>
                \[ (4 \cdot 10^3) + (6 \cdot 10^2) + (3 \cdot 10^1) + (1 \cdot 10^0) \]
            </div>
 ...
 <p>Los factores \(10^3, 10^2, 10^1\) y \(10^0\) son los <strong>pesos de los dígitos</strong> en la Ec. (12-1). De manera similar, el número binario de seis bits \(101101_2\) es igual a decimal 45, como se muestra a continuación:</p>
  ...
  <p>
    ...
    \]
              ...
              <div class="equation">
                <strong>Ecuación (12-2)</strong><br>
            ...
            <div class="result">
             ...
             <p>Usando subíndices para indicar la base de un número, podemos escribir la Ec. (12-2) como:</p>
  ...
  <p>La ecuación (12-2) nos muestra que, al igual que los números decimales, los números binarios utilizan el <strong>sistema de valor posicional</strong>, donde la posición de un dígito indica su peso. Si usamos \(B\) para denotar la base de un sistema numérico, la representación posicional del número de cuatro dígitos \(a_3 a_2 a_1 a_0\) es:</p>

  <p>
    \[
      a_3 a_2 a_1 a_0 = a_3 \cdot B^3 + a_2 \cdot B^2 + a_1 \cdot B^1 + a_0 \cdot B^0
    \]
  </p>

     <div class="equation">
                <span class="equation-number">(12-3)</span>
                \[\begin{align*}(a_3 \cdot B^3) + (a_2 \cdot B^2) + (a_1 \cdot B^1) + (a_0 \cdot B^0)\end{align*}\]
            </div>


      <p>En la Ec. (12-3), \(B^n\) es el multiplicador de peso para el dígito \(a_n\), donde \(0 \le a_n \le B-1\). (Este sistema de valor posicional para representar números es muy antiguo —tan antiguo, de hecho, que su origen es oscuro. Sin embargo, con su posicionamiento inherente del punto decimal o binario, este sistema numérico es tan conveniente y poderoso que su importancia ha sido comparada con la del alfabeto[1].)</p>
...
<div class="seccion derecha">
   ...
   <h3>12.1.1 Números Octales</h3>

  <p>Con la expansión rápida del uso de minicomputadoras y microprocesadores en la década de 1960, la gente se cansó de manipular largas cadenas de unos y ceros en papel y comenzó a usar formas más convenientes de representar números binarios. Una forma de expresar un número binario es el formato <strong>octal</strong>, con base ocho. (Por supuesto, los únicos dígitos válidos en el formato octal son del 0 al 7 —los dígitos 8 y 9 no tienen significado en la representación octal.)</p>

  <p>Convertir de binario a octal es tan simple como separar el número binario en grupos de tres bits comenzando desde la derecha. Por ejemplo, el número binario \(10101001_2\) se convierte a formato octal como:</p>
  ...
  <p>Así, el formato octal nos permite representar un valor binario de ocho dígitos con un valor octal más simple de tres dígitos. Sin embargo, el implacable avance de la tecnología está haciendo que los números octales, como las raquetas de tenis de madera, caigan en desuso.</p>

  <h3>12.1.2 Números Hexadecimales</h3>

  <p>Hoy en día, el formato predominante de representación de números binarios es el <strong>hexadecimal</strong>, usando 16 como base. Convertir de binario a hexadecimal se hace separando el número binario en grupos de cuatro bits, comenzando desde la derecha. El número binario \(10101001_2\) se convierte a formato hexadecimal como:</p>
  ...
  <p>Si no has visto antes el formato hexadecimal, no dejes que los dígitos A y 9 te confundan. En este formato, los caracteres A, B, C, D, E y F representan los dígitos cuyos valores decimales son 10, 11, 12, 13, 14 y 15 respectivamente. Convertimos los dos grupos de bits anteriores a dos dígitos hexadecimales comenzando con el grupo izquierdo: \(1010_2 = 10_{10} = A_{16}\) y \(1001_2 = 9_{10} = 9_{16}\).</p>

  <p>Los números en formato hexadecimal también utilizan el sistema de valor posicional, lo que significa que:</p>

  <p>
    \[
      A9_{16} = (A \cdot 16^1 + 9 \cdot 16^0)
    \]
  </p>

  <p>Por conveniencia, podemos representar el número binario de ocho dígitos \(10101001_2\) con el número hexadecimal de dos dígitos \(A9_{16}\).</p>

  <p>La Tabla 12-1 lista las representaciones de dígitos permitidas en los sistemas numéricos discutidos hasta ahora.</p>

  <img src="../../img/guia_284.png" alt="">

   <p>En el ejemplo anterior usamos un subíndice 16 para indicar un número hexadecimal.  
  Ten en cuenta que, en la literatura sobre formatos de números binarios, es común que los números hexadecimales estén precedidos por caracteres especiales para indicar que efectivamente son hexadecimales.  
  Por ejemplo, puedes ver números como <strong>$A9</strong> o <strong>0xA9</strong>, donde los caracteres “$” y “0x” especifican que los dígitos que siguen son hexadecimales.</p>

    <h3>2.1.3 Formato Binario Signo-Magnitud</h3>

  <p>Para que los números binarios sean útiles en la práctica, deben poder representar valores negativos.  
  Los números binarios lo hacen dedicando uno de los bits de una palabra binaria para indicar el <strong>signo</strong> de un número.</p>

  <p>Consideremos un formato binario popular conocido como <strong>signo-magnitud</strong>. Aquí, asumimos que el bit más a la izquierda de una palabra binaria es un <strong>bit de signo</strong> y los bits restantes representan la magnitud de un número que siempre es positivo.</p>

  <p>Por ejemplo:</p>

  <p>
    \[
      0011_2 = +3_{10} \quad \text{y} \quad 1011_2 = -3_{10}
    \]
  </p>
   <img src="../../img/guia_285.png" alt="">
   <hr>
</div>
</div>
 </form>
