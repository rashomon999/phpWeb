...
<div class="seccion izquierda"> 
 ...
 <p>Para nuestro ejemplo 11.0101<sub>2</sub> en la Ec. (12-4), el punto binario se coloca entre el segundo y el tercer bit más significativo, y llamamos a ese número binario un número fraccionario. Tener una posición fija para el punto binario es la razón por la cual este formato de número binario se llama binario de punto fijo.</p>

<p>El número sin signo 11.0101<sub>2</sub> tiene dos bits enteros y cuatro bits fraccionarios, así que, en la jerga de números binarios, a dicho número se le dice que tiene un formato 2.4, “dos punto cuatro” (dos bits enteros y cuatro bits fraccionarios).</p>

<p>Los números binarios en complemento a dos también pueden tener este formato de entero más fracción, y la Tabla 12-3 muestra, por ejemplo, los rangos de valores decimales para todos los posibles números binarios fraccionarios de ocho bits en complemento a dos.</p>

<p>Observe cómo la fila de formato 8.0 en la Tabla 12-3 muestra los valores decimales asociados con un número binario de ocho bits en complemento a dos cuyo punto binario está a la derecha del LSB, lo que significa un número binario completamente entero. Por otro lado, la fila de formato 1.7 en la Tabla 12-3 muestra los valores decimales asociados con un número binario de ocho bits en complemento a dos cuyo punto binario está justo a la derecha del MSB (el bit de signo), lo que significa un número binario completamente fraccionario.</p>
...
<table>
            <thead>
                <tr>
                    <th>Formato<br>binario<br>fraccional</th>
                    <th>Número de<br>bits enteros<br>(incluyendo<br>bit de signo)</th>
                    <th>Número de<br>bits<br>fraccionales</th>
                    <th>Valor<br>decimal<br>positivo<br>máximo</th>
                    <th>Valor<br>decimal<br>negativo<br>máximo</th>
                    <th>Valor<br>decimal<br>Lsb</th>
                </tr>
            </thead>
            <tbody>
                <tr>
...
<br><br>
<p>El rango de valores decimales de un número binario fraccionario en complemento a dos general es</p>
<p>(12-5)</p>
...
<div class="eq">
  $$
  -2^{(\#\,\text{of integer bits} - 1)} \leq \text{decimal value} \leq 
  2^{(\#\,\text{of integer bits} - 1)} 
   $$
    $$
...
<p>donde la notación “# de bits enteros” significa el número de bits a la izquierda del punto binario y “# de bits fraccionarios” significa el número de bits a la derecha del punto binario.</p>

<p>La Tabla 12-3 nos enseña dos lecciones importantes. Primero, podemos colocar el punto binario implícito en cualquier lugar que deseemos dentro de la palabra de ocho bits, siempre y cuando todos los que acceden a los datos estén de acuerdo con esa ubicación del punto binario y el diseñador mantenga un seguimiento de esa ubicación a lo largo de todos los cálculos aritméticos del sistema. El comportamiento del hardware de aritmética binaria no depende de la ubicación “acordada” del punto binario. Dicho de otra manera, la ubicación del punto binario no afecta las operaciones aritméticas binarias en complemento a dos. Es decir, sumar o multiplicar dos números binarios producirá el mismo resultado binario sin importar la ubicación implícita del punto binario dentro de las palabras de datos. Dejamos un ejemplo de este comportamiento como problema de tarea.</p>

<p>Segundo, para un número fijo de bits, los números binarios fraccionarios en complemento a dos nos permiten representar números decimales con poca precisión sobre un rango amplio de valores, o podemos representar números decimales con alta precisión pero solo sobre un rango estrecho de valores. En la práctica, debe “elegir su veneno” al escoger la posición del punto binario según lo que sea más importante para usted: el rango de números o la precisión de los números.</p>

<p>Debido a sus rutas de datos internas de 16 bits, es muy común que los chips DSP programables de 16 bits utilicen un formato 1.15 (un bit entero para representar el signo y 15 bits fraccionarios) para representar números en complemento a dos. Estos números binarios de 16 bits con signo y completamente fraccionarios son particularmente útiles porque multiplicar dos de esos números da como resultado un producto completamente fraccionario, evitando cualquier problema desagradable de desbordamiento binario, que se discutirá más adelante. (Tenga en cuenta que este formato 1.15 también se llama formato Q15).</p>

<p>Dado que el formato 1.15 se usa tan comúnmente en hardware programable, damos ejemplos de él y de otros formatos de 16 bits en la Tabla 12-4. En esa tabla, la “resolución” es el valor decimal del LSB del formato.</p>

<img src="../../img/guia_286.png" alt="">
</div>
...
<div class="seccion derecha">
 ...
 <p>La multiplicación de dos palabras binarias 1.15 da como resultado un número fraccionario en formato 2.30 (también llamado formato Q30). Esa palabra producto de 32 bits contiene dos bits de signo y 30 bits fraccionarios, siendo el MSB llamado bit de signo extendido. Tenemos dos formas de convertir (truncar) dicho producto de 32 bits al formato 1.15 para que pueda almacenarse como una palabra de 16 bits. Estas son:</p>

<ul>
  <li>Desplazar la palabra de 32 bits hacia la izquierda un bit y almacenar los 16 bits superiores, y</li>
  <li>Desplazar la palabra de 32 bits hacia la derecha 15 bits y almacenar los 16 bits inferiores.</li>
</ul>

<p>Para concluir esta discusión sobre números binarios fraccionarios, proporcionamos los pasos para convertir un número decimal cuyo valor absoluto sea menor que uno, como un coeficiente de un filtro digital FIR, al formato binario 1.15.</p>

<p>Como ejemplo, para convertir el valor decimal 0.452 al formato binario en complemento a dos 1.15:</p>

<ol>
  <li>Multiplique el valor absoluto del número decimal original 0.452 por 32768 (2<sup>15</sup>), obteniendo un decimal escalado de 14811.136.</li>
  <li>Redondee el valor 14811.136 a un entero, usando su método de redondeo preferido, produciendo un valor decimal escalado de 14811.</li>
  <li>Convierta el decimal 14811 a un entero binario y coloque el punto binario a la derecha del MSB, obteniendo 0◊011 1001 1101 1011 (39DB<sub>16</sub>).</li>
  <li>Si el valor decimal original era positivo, deténgase aquí. Si el valor decimal original era negativo, implemente la conversión a complemento a dos invirtiendo los bits binarios del Paso 3 y sumando uno.</li>
</ol>

<p>Si, desafortunadamente, no dispone de software para realizar la conversión del entero decimal positivo al binario 1.15 en el Paso 3, aquí se muestra cómo puede hacerse (dolorosamente) a mano:</p>

<ol>
  <li>Divida 14811 entre 2, obteniendo entero 7405 más un residuo de 0.5. Como el residuo no es cero, coloque un uno como el LSB del número binario deseado. Nuestro número binario es 1.</li>
  <li>Divida 7405 entre 2, obteniendo entero 3702 más un residuo de 0.5. Como el residuo no es cero, coloque un uno como el bit a la izquierda del bit LSB establecido en el Paso 3.1 anterior. Nuestro número binario es ahora 11.</li>
  <li>Divida 3702 entre 2, obteniendo entero 1851 más un residuo de cero. Como el residuo es cero, coloque un cero a la izquierda del bit establecido en el Paso 3.2 anterior. Nuestro número binario es ahora 011.</li>
  <li>Continúe este proceso hasta que la porción entera del cociente de dividir entre dos sea cero. Agregue ceros a la izquierda de la palabra binaria para extender su longitud a 16 bits.</li>
</ol>

<p>Usando los pasos anteriores para convertir el decimal 14811<sub>10</sub> al formato binario 1.15 se procede como se muestra en la Tabla 12-5, produciendo nuestro número binario deseado 0◊011 1001 1101 1011 (39DB<sub>16</sub>).</p>

<img src="../../img/guia_287.png" alt="">

<hr>
<h3>3.3 Notación Q</h3>
<p>Esta notación ha sido definida previamente por Texas Instruments y ARM (y posiblemente otros). Véase [6] y [7, sec.4.7.9], respectivamente.</p>
<p>Tanto los números de punto fijo con signo como sin signo pueden ser designados mediante la notación Q. El tipo de representación, con signo o sin signo, debe especificarse o entenderse por el contexto.</p>

<h4>3.3.1 Notación sin signo</h4>
<p>El conjunto de racionales de punto fijo sin signo Pb(N) puede ser designado mediante la popular notación Q como Qb o como Qa.b. Al usar la notación Qb, la longitud de palabra N no puede determinarse a partir de la notación y debe especificarse o entenderse por el contexto.</p>
<p>La notación Qa.b es equivalente a la notación U(a, b), y la longitud de palabra N = a + b. En cualquier caso, hay b bits fraccionarios en la palabra. Si se especifica Qa.b, o se sabe que hay N bits totales en la palabra, entonces hay a = N − b bits enteros.</p>

<p><strong>Ejemplo 3.5 (Q15, racional de punto fijo sin signo con 15 bits fraccionarios)</strong></p>
<p>Este número tiene un número total e integer desconocido y 15 bits fraccionarios. Si se determina por contexto que tiene N bits totales, está compuesto por 15 bits fraccionarios y N − 15 bits enteros, equivalente a un U(N − 15, 15). Si N = 16, por ejemplo, es equivalente a las notaciones Q1.15 y U(1, 15).</p>

<p><strong>Ejemplo 3.6 (Q17.15, racional de punto fijo sin signo con 17 + 15 = 32 bits totales)</strong></p>
<p>Esto es similar al ejemplo anterior, excepto que el número total de bits es 32. Es equivalente a un U(17, 15).</p>

<h4>3.3.2 Notación con signo</h4>
<p>El conjunto de racionales de punto fijo con signo Rb(N) puede ser designado mediante la popular notación Q como Qb o como Qa.b. Al usar la notación Qb, la longitud de palabra N no puede determinarse a partir de la notación y debe especificarse o entenderse por el contexto.</p>
<p>La notación Qa.b es equivalente a la notación A(a, b), y la longitud de palabra N = a + b + 1. En cualquier caso, hay b bits fraccionarios en la palabra. Si se especifica Qa.b, o se sabe que hay N bits totales en la palabra, entonces hay a = N − b − 1 bits enteros. Como en la notación A(a, b), el bit de signo no se considera parte de la porción entera (a).</p>

<p><strong>Ejemplo 3.7 (Q15, racional de punto fijo sin signo con 15 bits fraccionarios)</strong></p>
<p>Este número tiene un número total e integer desconocido y 15 bits fraccionarios. Si se determina por contexto que tiene N bits totales, está compuesto por 15 bits fraccionarios y N − 15 bits enteros, equivalente a un U(N − 15, 15). Si N = 16, por ejemplo, es equivalente a las notaciones Q1.15 y U(1, 15).</p>

<p>Nota lo siguiente:</p>
<ol>
  <li>La notación Q es ambigua, ya que puede representar números de punto fijo con o sin signo.</li>
  <li>Existe una notación Q alternativa para racionales de punto fijo con signo Qa.b en la que a = N − b.</li>
</ol>

<p><strong>Ejemplo 3.8 (Q0.15, racional de punto fijo con signo con 15 bits fraccionarios)</strong></p>
<p>Este número tiene 0 + 15 + 1 = 16 bits totales y 15 bits fraccionarios. Está compuesto por 15 bits fraccionarios y un bit de signo.</p>
