...
<div class="seccion izquierda"> 
  ...
  <p>Por supuesto, usar uno de los bits como bit de signo reduce la <strong>magnitud</strong> de los números que podemos representar.  
  Si la longitud de palabra de un número binario sin signo es de \(b\) bits, el número de valores diferentes que se pueden representar es \(2^b\).  
  Por ejemplo, una palabra de ocho bits puede representar \(2^8 = 256\) valores enteros diferentes.</p>

  <p>Considerando que el cero es uno de los valores que debemos expresar, una palabra binaria sin signo de \(b\) bits puede representar enteros de \(0\) a \(2^{b}-1\).  
  El valor más grande representado por una palabra sin signo de ocho bits es:</p>

  <p>
    \[
      2^8 - 1 = 255_{10} = 11111111_2
    \]
  </p>

  <p>En el formato binario signo-magnitud, una palabra de \(b\) bits solo puede representar una magnitud de \(\pm (2^{b-1}-1)\),  
  así que el mayor valor positivo o negativo que podemos representar con una palabra signo-magnitud de ocho bits es:</p>
  ...
  <h3>12.1.4 Formato Complemento a Dos</h3>

  <p>Otro esquema común de números binarios, conocido como <strong>formato complemento a dos</strong>, también utiliza el bit más a la izquierda como <strong>bit de signo</strong>.  
  El formato complemento a dos es el esquema de numeración más conveniente desde el punto de vista del diseño de hardware y se ha utilizado durante décadas.  
  Permite a las computadoras realizar tanto <strong>suma</strong> como <strong>resta</strong> utilizando la misma lógica de sumador de hardware.</p>

  <p>Para obtener la versión negativa de un número positivo en complemento a dos, simplemente complementamos (cambiamos unos por ceros y ceros por unos) cada bit, sumamos un uno binario a la palabra complementada y descartamos cualquier bit que se exceda de la longitud original de la palabra.  
  Por ejemplo, con \(0011_2\) representando un 3 decimal en formato complemento a dos, se obtiene un -3 decimal mediante los siguientes pasos:</p>

     <div class="containerr">
        <h2>Complemento a Dos</h2>
        <div class="operacion">
            <span class="descripcion">+3 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">0011</span>
        </div>
        <div class="operacion">
            <span class="descripcion">complemento de +3</span>
            <span class="flecha">→</span>
            <span class="binario">1100</span>
        </div>
        <div class="operacion suma">
            <span class="descripcion">sumar uno</span>
            <span class="flecha">→</span>
            <span class="binario"><span class="carry">1</span>0001</span>
        </div>
        <div class="operacion">
            <span class="descripcion">-3 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">1101</span>
        </div>
    </div>
    <br><br>
    <p>
    En el formato de complemento a dos, una palabra de \( b \) bits puede representar
    amplitudes positivas tan grandes como
    \[
      2^{\,b-1} - 1,
    \]
    y amplitudes negativas tan grandes como
    \[
      -2^{\,b-1}.
    \]
  </p>
  ...
  <p>
    La Tabla 12-2 muestra ejemplos, usando palabras de cuatro bits, de los formatos
    binarios de signo‐magnitud y de complemento a dos.
  </p>
...
<table>
            <thead>
                <tr>
                    <th>Equivalente decimal</th>
                    <th>Signo-magnitud</th>
                    <th>Complemento a dos</th>
                    <th>Binario con desplazamiento</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>7</td>
                    <td class="binario">0111</td>
                    <td class="binario">0111</td>
                    <td class="binario">1111</td>
                </tr>
                <tr>
                    <td>6</td>
                    <td class="binario">0110</td>
                    <td class="binario">0110</td>
                    <td class="binario">1110</td>
                </tr>
                <tr>
                    <td>5</td>
                    <td class="binario">0101</td>
                    <td class="binario">0101</td>
                    <td class="binario">1101</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td class="binario">0100</td>
                    <td class="binario">0100</td>
                    <td class="binario">1100</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td class="binario">0011</td>
                    <td class="binario">0011</td>
                    <td class="binario">1011</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td class="binario">0010</td>
                    <td class="binario">0010</td>
                    <td class="binario">1010</td>
                </tr>
                <tr>
                    <td>1</td>
                    <td class="binario">0001</td>
                    <td class="binario">0001</td>
                    <td class="binario">1001</td>
                </tr>
                <tr>
                    <td>+0</td>
                    <td class="binario">0000</td>
                    <td class="binario">0000</td>
                    <td class="binario">1000</td>
                </tr>
                <tr>
                    <td>−0</td>
                    <td class="binario">1000</td>
    ...
    <p>
    Al usar números en complemento a dos, debemos ser cuidadosos cuando se suman dos números con
    diferentes longitudes de palabra. Consideremos el caso en el que un número de cuatro bits se suma
    a un número de ocho bits:
  </p>

    <div class="containerr">
        <h2>Suma en Complemento a Dos</h2>
        <div class="operacion">
            <span class="descripcion">+15 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">00001111</span>
        </div>
        <div class="operacion">
            <span class="descripcion">sumar +3 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario"><span class="signo-mas">+</span>0011</span>
        </div>
        <div class="operacion suma-linea">
            <span class="descripcion">+18 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">00010010</span>
        </div>
    </div>
</div>
...
<div class="seccion derecha">
 ...
 <div class="containerr">
        <h2>Suma Incorrecta en Complemento a Dos</h2>
        <div class="operacion">
            <span class="descripcion">+15 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">00001111</span>
        ...
        <div class="operacion">
            <span class="descripcion">sumar un −3 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario"><span class="signo-mas">+</span>1101</span>
        </div>
        <div class="operacion suma-linea">
            <span class="descripcion">+28 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">00011100</span>
 
        </div>
                    <span class="nota" style="padding-left: 570px;"> Respuesta incorrecta</span>
    </div>

<br>
  <p>
    El error aritmético anterior puede evitarse realizando lo que se denomina una operación de
    <em>extensión de signo</em> (<em>sign-extend</em>) sobre el número de cuatro bits. Este proceso,
    normalmente ejecutado automáticamente por el hardware, extiende el bit de signo del número
    negativo de cuatro bits hacia la izquierda, convirtiéndolo en un número negativo de ocho bits.
    Si extendemos el signo de \(-3\) y luego efectuamos la suma, obtendremos la respuesta correcta:
  </p>
     <br>
      <div class="containerr">
        <h2>Suma Correcta con Extensión de Signo</h2>
        <div class="operacion">
            <span class="descripcion">+15 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">00001111</span>
        ...
        <div class="operacion">
            <span class="descripcion">sumar un −3 extendido en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario"><span class="signo-mas">+</span>11111101</span>
        </div>
        <div class="operacion suma-linea">
            <span class="descripcion">+12 en complemento a dos</span>
            <span class="flecha">→</span>
            <span class="binario">100001100</span>
        </div>
        <span class="nota" style="padding-left: 570px;"> ¡Así está mejor!</span>
        <div class="overflow">
            <span class="overflow-arrow" style="padding-left: 390px;">↑</span>

            <span class="overflow-arrow" style="padding-left: 390px;">el bit de desbordamiento se ignora</span>
...
<button onmousedown="mostrarMensaje()" onmouseup="ocultarMensaje()">Ayuda</button>
  ...
  <p class="note"><span class="bold">Para 8 bits</span>, el <em>offset binary</em> funciona como si restaras <span class="bold">10000000<sub>2</sub></span> al valor binario.</p>

  <div class="binary-block" aria-label="Operación binaria">
  Tu operación está correcta:
  ...
  <p class="explain">Eso es lo que significa aplicar el offset (bias de <strong>128</strong>) pero hecho directamente en binario.</p>
        
  </div>
    <br><br>
  <h3>12.1.5 Formato Binario con Desplazamiento (Offset Binary)</h3>

  <p>
    Otro esquema útil de representación binaria se conoce como el
    <em>formato binario con desplazamiento</em> (<em>offset binary</em>).
    Aunque este formato no es tan común como el complemento a dos, todavía aparece en algunos
    dispositivos de hardware. La Tabla&nbsp;12-2 muestra ejemplos del formato offset binary
    para palabras de cuatro bits.
  </p>

  <p>
    El formato offset binary representa números restando \( 2^{\,b-1} \) de un valor binario sin signo.
    Por ejemplo, en la segunda fila de la Tabla&nbsp;12-2, el número en offset binary es
    \(1110_2\). Cuando este número se trata como un valor binario sin signo, es equivalente a
    \(14_{10}\).
  </p>

  <p>
    Para palabras de cuatro bits, \( b = 4 \) y
    \[
      2^{\,b-1} = 2^{3} = 8.
    \]
    Así, \( 14_{10} - 8_{10} = 6_{10} \), que es el equivalente decimal de
    \(1110_2\) en offset binary.
  </p>

  <p>
    La diferencia entre el equivalente binario sin signo y el equivalente decimal real de los números
    en offset binary en la Tabla&nbsp;12-2 es siempre \(-8\). Este tipo de desplazamiento a veces se
    denomina un <em>bias</em> cuando se utiliza el formato offset binary.
  </p>

  <p>
    (Puede interesarle al lector que podemos convertir de un formato de complemento a dos a offset
    binary —y viceversa— simplemente complementando el bit más significativo de la palabra.)
  </p>

  <p>
    La historia, aritmética y utilidad de los muchos formatos numéricos disponibles constituye un campo
    de estudio muy amplio. Una discusión completa y muy legible del tema es presentada por Knuth en la
    referencia&nbsp;[2].
  </p>

  <h3>12.1.6 Números Binarios Fraccionarios</h3>

<p>
Todos los números binarios que hemos considerado hasta ahora tenían valores decimales enteros.  
Los números decimales no enteros, es decir, números con dígitos no cero a la derecha del punto decimal,  
también pueden representarse con números binarios si usamos un <strong>binary point</strong>, también llamado  
<strong> radix point</strong>, idéntico en función a nuestro conocido punto decimal.
</p>

<p>
(Así, en los números binarios discutidos hasta ahora, se asume que el binary point está fijo justo a la derecha  
del bit menos significativo, <em>lsb</em>.)
</p>

<p>
Por ejemplo, usando el símbolo ◊ para denotar un binary point, el número binario sin signo de seis bits  
<strong>11◊0101₂</strong> es igual al decimal <strong>3.3125</strong> según:
</p>

<div class="container">
<div class="top">(12-4)</div>
...
$$
= 2 + 1 + 0 + 0.25 + 0 + 0.0625 = \mathbf{3.3125_{10}}
$$
</div>
</div>
