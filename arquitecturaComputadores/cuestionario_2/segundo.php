...
if ($_POST) {
   ...
   if ($respuesta_11 === 'negativos') {  
    ...
    if ($respuesta_19 === 'C_{10}(B)=10^n-B') {   
...
<p>
   ...
   <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="8">
     de números, especialmente en 
   sistemas digitales o cuando se hace a mano con cifras fijas. La idea principal es:
...
lidiar directamente con números 
...
<hr>
 ...
 <h3>Ejemplo: 23 − 16 usando complemento a <input type="text" value="<?php echo $respuesta_1; ?>" size="2" readonly> </h3>

<strong>indica la formulas a utilizar: </strong>
<br><br>
 <span id="formula">
        \(   \)
    </span> 
 
    <input type="text" name="respuesta_12"   id="respuesta_12" oninput="actualizarFormula()" 
    value="<?php echo $respuesta_12?>" size="13" >
    ...
    <input type="text" name="respuesta_13"   id="respuesta_13" oninput="actualizarFormula2()" 
    value="<?php echo $respuesta_13?>" size="13" >

      <p>
    Recordar que como trabajamos con 2 dígitos, si el resultado es de 3, 
    ...
    <p><strong>ingrese el resultado </strong></p>
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="8">

    <br><br>
    ahora realice: 273 − 094
    <p><strong>ingrese el resultado </strong></p>
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="8">

    <br><br>
    
    <strong>Fórmula general del complemento a 10</strong>

  <p>Si un número <strong>B</strong> tiene <strong>n</strong> 
  <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="8">
   , entonces:</p>
    ...
    <input type="text" name="respuesta_19"   id="respuesta_19" oninput="actualizarFormula3()" 
    value="<?php echo $respuesta_19?>" size="13" >
