...
if ($_POST) {
   ...
   if ($respuesta_1 === 'registro temporal') {  
   ...
   if ($respuesta_2 === 'valor de retorno') {  
   ...
   if ($respuesta_23 === 'temporales'
   || $respuesta_23 === 'temporary'
   ...
   if ($respuesta_25 === 'registros'
   || $respuesta_25 === 'registers'
   ) { 
...
<h3>Microsoft x64 ABI (Windows)</h3>
  ...
  <table border="1" cellspacing="0" cellpadding="6">
    ...
    <tr>
      <td><input type="text" name="respuesta_29" value="<?php echo $respuesta_29; ?>" size="4"></td>
      <td>2.º argumento</td>
      <td>❌ No</td>
    </tr>
    <tr>
      <td><input type="text" name="respuesta_30" value="<?php echo $respuesta_30; ?>" size="4"></td>
      <td>3.º argumento</td>
      <td>❌ No</td>
    </tr>
    <tr>
      <td><input type="text" name="respuesta_31" value="<?php echo $respuesta_31; ?>" size="4"></td>
      <td>4.º argumento</td>
      <td>❌ No</td>
    </tr>
    <tr>
      <td><input type="text" name="respuesta_32" value="<?php echo $respuesta_32; ?>" size="4"></td>
...
<h1>🧩 Common Jump Instructions in Assembly</h1>
...
<table>
  <thead>
    ...
    <tbody>
    <tr><td><code>JZ</code></td><td>Jump if Zero</td><td>ZF = 1</td></tr>
    <tr><td><code>JE</code></td><td>Jump if Equal</td><td>ZF = 1</td></tr>
    <tr><td><code>JNZ</code></td><td>Jump if Not Zero</td><td>ZF = 0</td></tr>
    <tr><td><code>JNE</code></td><td>Jump if Not Equal</td><td>ZF = 0</td></tr>
    <tr><td><code>JC</code></td><td>Jump if Carry</td><td>CF = 1</td></tr>
    <tr><td><code>JNC</code></td><td>Jump if No Carry</td><td>CF = 0</td></tr>
    <tr><td><code>JS</code></td><td>Jump if Signed (Negative)</td><td>SF = 1</td></tr>
    <tr><td><code>JG</code></td><td>Jump if Greater</td><td>(ZF = 0 and SF = OF)</td></tr>
    <tr><td><code>JNLE</code></td><td>Jump if Not Less or Equal</td><td>Same as JG</td></tr>
    <tr><td><code>JGE</code></td><td>Jump if Greater or Equal</td><td>SF = OF</td></tr>
    <tr><td><code>JNL</code></td><td>Jump if Not Less</td><td>Same as JGE</td></tr>
    <tr><td><code>JL</code></td><td>Jump if Less</td><td>SF ≠ OF</td></tr>
    <tr><td><code>JLE</code></td><td>Jump if Less or Equal</td><td>(ZF = 1 or SF ≠ OF)</td></tr>
    <tr><td><code>JNG</code></td><td>Jump if Not Greater</td><td>Same as JLE</td></tr>
    </tbody>
    </table>
