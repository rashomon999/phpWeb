...
<h1>Desglose: AL / AH / AX / EAX / RAX</h1>
  ...
  <tbody>
    ...
    <input type="text" name="respuesta_68" value="<?php echo $respuesta_68; ?>" size="4">    
     ...
     <input type="text" name="respuesta_69" value="<?php echo $respuesta_68; ?>" size="4">   
     SP</td><td>
     <input type="text" name="respuesta_70" value="<?php echo $respuesta_68; ?>" size="4">   
     N/A</td><td>
     <input type="text" name="respuesta_71" value="<?php echo $respuesta_68; ?>" size="4">   
     SPL</td><td>
     <input type="text" name="respuesta_72" value="<?php echo $respuesta_68; ?>" size="4">   
     Stack Pointer</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_73" value="<?php echo $respuesta_68; ?>" size="4">    
    RBP</td><td>
    <input type="text" name="respuesta_74" value="<?php echo $respuesta_68; ?>" size="4">    
    EBP</td><td>
    <input type="text" name="respuesta_75" value="<?php echo $respuesta_68; ?>" size="4">    
    BP</td><td>
    <input type="text" name="respuesta_76" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_77" value="<?php echo $respuesta_68; ?>" size="4">    
    BPL</td><td>
    <input type="text" name="respuesta_78" value="<?php echo $respuesta_68; ?>" size="4">    
    Base Pointer (meant for stack frames)</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_79" value="<?php echo $respuesta_68; ?>" size="4">    
    R8</td><td>
    <input type="text" name="respuesta_80" value="<?php echo $respuesta_68; ?>" size="4">    
    R8D</td><td>
    <input type="text" name="respuesta_81" value="<?php echo $respuesta_68; ?>" size="4">    
    R8W</td><td>
    <input type="text" name="respuesta_82" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_83" value="<?php echo $respuesta_68; ?>" size="4">    
    R8B</td><td>
    <input type="text" name="respuesta_84" value="<?php echo $respuesta_68; ?>" size="4">    
    General purpose</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_85" value="<?php echo $respuesta_68; ?>" size="4">    
    R9</td><td>
    <input type="text" name="respuesta_86" value="<?php echo $respuesta_68; ?>" size="4">    
    R9D</td><td>
    <input type="text" name="respuesta_87" value="<?php echo $respuesta_68; ?>" size="4">    
    R9W</td><td>
    <input type="text" name="respuesta_88" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_89" value="<?php echo $respuesta_68; ?>" size="4">    
    R9B</td><td>
    <input type="text" name="respuesta_90" value="<?php echo $respuesta_68; ?>" size="4">    
    General purpose</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_91" value="<?php echo $respuesta_68; ?>" size="4">    
    R10</td><td>
    <input type="text" name="respuesta_92" value="<?php echo $respuesta_68; ?>" size="4">    
    R10D</td><td>
    <input type="text" name="respuesta_93" value="<?php echo $respuesta_68; ?>" size="4">    
    R10W</td><td>
    <input type="text" name="respuesta_94" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_95" value="<?php echo $respuesta_68; ?>" size="4">    
    R10B</td><td>
    <input type="text" name="respuesta_96" value="<?php echo $respuesta_68; ?>" size="4">    
    General purpose</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_97" value="<?php echo $respuesta_68; ?>" size="4">    
    R11</td><td>
    <input type="text" name="respuesta_98" value="<?php echo $respuesta_68; ?>" size="4">    
    R11D</td><td>
    <input type="text" name="respuesta_99" value="<?php echo $respuesta_68; ?>" size="4">    
    R11W</td><td>
    <input type="text" name="respuesta_100" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_101" value="<?php echo $respuesta_68; ?>" size="4">    
    R11B</td><td>
    <input type="text" name="respuesta_102" value="<?php echo $respuesta_68; ?>" size="4">    
    General purpose</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_103" value="<?php echo $respuesta_68; ?>" size="4">    
    R12</td><td>
    <input type="text" name="respuesta_104" value="<?php echo $respuesta_68; ?>" size="4">    
    R12D</td><td>
    <input type="text" name="respuesta_105" value="<?php echo $respuesta_68; ?>" size="4">    
    R12W</td><td>
    <input type="text" name="respuesta_106" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_107" value="<?php echo $respuesta_68; ?>" size="4">    
    R12B</td><td>
    <input type="text" name="respuesta_108" value="<?php echo $respuesta_68; ?>" size="4">    
    General purpose</td></tr>
    <tr><td></td><td>
    <input type="text" name="respuesta_109" value="<?php echo $respuesta_68; ?>" size="4">    
    R13</td><td>
    <input type="text" name="respuesta_110" value="<?php echo $respuesta_68; ?>" size="4">    
    R13D</td><td>
    <input type="text" name="respuesta_112" value="<?php echo $respuesta_68; ?>" size="4">    
    R13W</td><td>
    <input type="text" name="respuesta_113" value="<?php echo $respuesta_68; ?>" size="4">    
    N/A</td><td>
    <input type="text" name="respuesta_114" value="<?php echo $respuesta_68; ?>" size="4">    
    R13B</td><td>
    <input type="text" name="respuesta_115" value="<?php echo $respuesta_68; ?>" size="4">    
    General purpose</td></tr>
    <tr><td></td><td>
    ...
    R15B</td><td>
    <input type="text" name="respuesta_127" value="<?php echo $respuesta_127; ?>" size="4">    
    General purpose</td></tr>
  </tbody>
</table>
