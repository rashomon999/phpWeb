...
<div class="seccion izquierda"> 
 ...
 <h3> Aplicado a tu caso (getline)</h3>

<p>lea     rax, [rbp+input]     ; RAX = dirección del buffer local 'input'</p>
<p>mov     r8d, 40h             ; tercer argumento = 64 bytes</p>
<p>mov     rdx, rax             ; segundo argumento = buffer destino</p>
<p>mov     rax, cs:_refptr__ZSt3cin</p>
<p>mov     rcx, rax             ; primer argumento = cin</p>
<p>call    _ZNSi7getlineEPcx    ; cin.getline(input, 64)</p>

<h3> Correspondencia directa:</h3>

<p><strong>Registro</strong> &nbsp; <strong>Argumento</strong> &nbsp; <strong>Valor</strong></p>
<p><strong>RCX</strong> &nbsp; 1º → this (cin) &nbsp; dirección de std::cin</p>
<p><strong>RDX</strong> &nbsp; 2º → char * buffer &nbsp; dirección de input</p>
<p><strong>R8</strong> &nbsp; 3º → long long size &nbsp; 64 (0x40)</p>

<h3> Por qué decimos “segundo argumento”</h3>

<p>Porque en la firma de la función <strong>getline</strong>, el primer argumento es implícito: el objeto <strong>cin</strong> (el <strong>this</strong>).</p>
<p>El segundo argumento visible es el puntero al buffer (<strong>input</strong>).</p>
<p>El tercero es el tamaño.</p>
<p>Por eso:</p>
<p><strong>mov rdx, rax</strong></p>
<p>significa:</p>
<p>“pasa el segundo argumento (input) a la función, usando el registro <strong>RDX</strong>”.</p>

<h3> Visual simple</h3>
 
<p> <strong>cin.getline(input, 64)</strong></p>
<p>│</p>
<p>├─ <strong>RCX</strong> → cin         (this)</p>
<p>├─ <strong>RDX</strong> → input       (segundo argumento)</p>
<p>└─ <strong>R8</strong>  → 64          (tercer argumento)</p>

    <hr>
    <strong>Destacar:</strong>
    <p><strong>std::cin.getline(input, 64); </strong> es el equivalente a parte del codigo ensamblador,
    por eso en la parte analizada se manejan 3 argumentos</p>
    <hr>


 
        <header>
            <h1>🔀 Análisis de la bifurcación después del cin</h1>
            <p>Validación completa del input del usuario</p>
        </header>
        ...
        <div class="content">
            ...
            <div class="section">
                <p style="font-size: 1.2em; line-height: 1.8;">
                    Vamos a analizar este flujo que se divide en múltiples caminos después de la validación del <span class="inline-code">cin</span>.
                </p>
            </div>

            <!-- Estructura del flujo -->
            <h2><span class="emoji">🔍</span>Estructura del flujo</h2>
            <div class="code-block flow">
<code>cin.getline() → validación → si OK (al=0) → loc_1400014D7
                           → si ERROR (al=1) → continúa</code>
            </div>
            
            <div class="highlight-box">
                <strong>Ahora estamos en <span class="inline-code">loc_1400014D7</span> (cuando el cin fue exitoso).</strong>
            </div>

            <!-- Bloque 1 -->
            <div class="block-header">
                <span class="emoji">📊</span>Bloque 1: loc_1400014D7
            </div>
            <div class="block-content">
                <div class="code-block">
 <pre><code>loc_1400014D7:
lea     rax, [rbp+input]     <span class="comment">; rax = dirección de input</span>
mov     rcx, rax             <span class="comment">; rcx = primer arg (dirección de input)</span>
call    strlen               <span class="comment">; strlen(input) - calcula longitud</span>
mov     [rbp+len], rax       <span class="comment">; guarda longitud en variable 'len'</span>
cmp     [rbp+len], 0         <span class="comment">; compara len con 0</span>
jz      short loc_140001511  <span class="comment">; si len == 0, salta</span></code> </pre>
                </div>

                <div class="step-box">
                    <h4><span class="emoji">🎯</span>¿Qué hace?</h4>
                    <ul class="step-list">
                        <li data-num="1"><strong>Calcula la longitud</strong> del input usando <span class="inline-code">strlen()</span></li>
                        <li data-num="2"><strong>Guarda la longitud</strong> en <span class="inline-code">[rbp+len]</span> (variable local <span class="inline-code">len</span>)</li>
                        <li data-num="3"><strong>Verifica si está vacío:</strong> si <span class="inline-code">len == 0</span> <span class="arrow">→</span> salta a <span class="inline-code">loc_140001511</span></li>
                    </ul>
                </div>

                <h3><span class="emoji">💡</span>En C++:</h3>
                <div class="code-block cpp">
<pre><code>len = strlen(input);
if (len == 0) {
    goto loc_140001511;  <span class="comment">// Input vacío</span>
}
<span class="comment">// Si len > 0, continúa</span></code></pre>
                </div>
            </div>

            <!-- Bloque 2 -->
            <div class="block-header">
                <span class="emoji">📊</span>Bloque 2: Primera validación (si len > 0)
            </div>
            <div class="block-content">
                <div class="code-block">
<pre><code>mov     rax, [rbp+len]           <span class="comment">; rax = len</span>
sub     rax, 1                   <span class="comment">; rax = len - 1</span>
movzx   eax, [rbp+rax+input]     <span class="comment">; eax = input[len-1] (último carácter)</span>
cmp     al, 0Dh                  <span class="comment">; compara con '\r' (retorno de carro)</span>
jnz     short loc_140001511      <span class="comment">; si NO es '\r', salta</span></code></pre>
                </div>

                <div class="step-box">
                    <h4><span class="emoji">🎯</span>¿Qué hace?</h4>
                    <ul class="step-list">
                        <li data-num="1"><strong>Accede al último carácter</strong> del input: <span class="inline-code">input[len-1]</span></li>
                        <li data-num="2"><strong>Compara con <span class="inline-code">0Dh</span></strong> (13 en decimal = <span class="inline-code">\r</span> = carriage return)</li>
                        <li data-num="3"><strong>Si NO es <span class="inline-code">\r</span>:</strong> salta a <span class="inline-code">loc_140001511</span></li>
                    </ul>
                </div>

                <h3><span class="emoji">💡</span>En C++:</h3>
                <div class="code-block cpp">
<pre><code>if (input[len - 1] != '\r') {
    goto loc_140001511;  <span class="comment">// No termina en \r</span>
}
<span class="comment">// Si termina en \r, continúa</span></code></pre>
                </div>

                <div class="warning-box">
                    <strong>⚠️ Nota importante:</strong>
                    <span class="inline-code">0Dh</span> = <span class="inline-code">\r</span> (retorno de carro, usado en Windows: <span class="inline-code">\r\n</span>)
                </div>
            </div>
...
<!-- Bloque 3 -->
            <div class="block-header">
                <span class="emoji">📊</span>Bloque 3: Segunda validación (si terminó en \r)
            </div>
            <div class="block-content">
                <div class="code-block">
<pre><code>mov     rax, [rbp+len]           <span class="comment">; rax = len</span>
sub     rax, 1                   <span class="comment">; rax = len - 1</span>
mov     [rbp+rax+input], 0       <span class="comment">; input[len-1] = '\0' (elimina \r)</span>
sub     [rbp+len], 1             <span class="comment">; len = len - 1</span></code></pre>
                </div>

                <div class="step-box">
                    <h4><span class="emoji">🎯</span>¿Qué hace?</h4>
                    <ul class="step-list">
                        <li data-num="1"><strong>Reemplaza el <span class="inline-code">\r</span></strong> con <span class="inline-code">\0</span> (terminador de string)</li>
                        <li data-num="2"><strong>Reduce la longitud</strong> en 1</li>
                    </ul>
                </div>

                <h3><span class="emoji">💡</span>En C++:</h3>
                <div class="code-block cpp">
<pre><code>input[len - 1] = '\0';  <span class="comment">// Elimina el \r</span>
len = len - 1;</code></pre>
                </div>
            </div>
...
<!-- Bloque 4 -->
            <div class="block-header">
                <span class="emoji">📊</span>Bloque 4: loc_140001511 (punto de convergencia)
            </div>
            <div class="block-content">
                <div class="code-block">
<pre><code>loc_140001511:
cmp     [rbp+len], 0Bh           <span class="comment">; compara len con 11 (0Bh)</span>
jbe     loc_140001625            <span class="comment">; si len <= 11, salta (error)</span></code></pre>
                </div>

                <div class="step-box">
                    <h4><span class="emoji">🎯</span>¿Qué hace?</h4>
                    <p style="font-size: 1.1em; margin-top: 15px;">
                        Verifica que la <strong>longitud sea mayor a 11 caracteres</strong>
                    </p>
                </div>
                ...
                <div class="code-block cpp">
<pre><code>if (len <= 11) {
    goto loc_140001625;  <span class="comment">// Password muy corto (error)</span>
}
<span class="comment">// Si len > 11, continúa (password válido)</span></code></pre>
                </div>
            </div>
            ...
            <div class="key-points">
                <h3><span class="emoji">🎯</span>Puntos clave para análisis rápido</h3>
                <ol>
                    <li><span class="inline-code" style="background: rgba(255,255,255,0.2);">call strlen</span> <span class="arrow">→</span> Está calculando longitud del input</li>
                    <li><span class="inline-code" style="background: rgba(255,255,255,0.2);">cmp [rbp+len], 0</span> <span class="arrow">→</span> Verifica si está vacío</li>
                    <li><span class="inline-code" style="background: rgba(255,255,255,0.2);">cmp al, 0Dh</span> <span class="arrow">→</span> Busca <span class="inline-code" style="background: rgba(255,255,255,0.2);">\r</span> (line ending de Windows)</li>
                    <li><span class="inline-code" style="background: rgba(255,255,255,0.2);">cmp [rbp+len], 0Bh</span> <span class="arrow">→</span> Verifica longitud mínima (11 caracteres)</li>
                    <li><span class="inline-code" style="background: rgba(255,255,255,0.2);">jbe loc_140001625</span> <span class="arrow">→</span> Si es menor o igual, va al error</li>
                </ol>
            </div>

            <strong>Resumen:</strong>
            <p>Bloque 1: Verificar si hay input</p>
            <p>Bloque 2: Verificar si termina en \r</p>
            <p>Bloque 3: Eliminar el \r</p>
            <p>Bloque 4: Punto de convergencia - VALIDACIÓN REAL</p>
         ...
         │     │        │
         ▼     ▼        ▼
    loc_140001625   (continúa validando)
    (ERROR)         (password válido)</pre>
            
    <strong>Continuamos (password válido)</strong>
    <img src="../../../img/guia_254.png" alt="">




    <h2>🧩 Fragmento visible</h2>
    <pre><code>mov     [rbp+i], 0
jmp     loc_140001618

loc_140001618:
cmp     [rbp+i], 0Bh
jbe     loc_140001529</code></pre>
  </section>

  <section class="card">
    <h2>🔍 Explicación instrucción por instrucción</h2>

    <h3>1️⃣ <span class="inline-code">mov [rbp+i], 0</span></h3>
    <ul>
      <li><strong>Traducción:</strong> inicializa la variable local <code>i</code> con 0.</li>
      <li><strong>En C++:</strong>
        <pre><code>i = 0;</code></pre>
      </li>
      <li class="muted">Contexto: probablemente <code>i</code> es un índice para recorrer el array <code>input</code>.</li>
    </ul>

    <h3>2️⃣ <span class="inline-code">jmp loc_140001618</span></h3>
    <ul>
      <li>Salto incondicional a la etiqueta <code>loc_140001618</code>.</li>
      <li>Equivalente a empezar un bucle desde la condición (como un <code>while</code>), evitando ejecutar el cuerpo antes de comprobar la condición.</li>
    </ul>

    <h3>3️⃣ <span class="inline-code">loc_140001618:</span></h3>
    <p>Etiqueta que marca el inicio de la comprobación/condición del bucle.</p>

    <h3>4️⃣ <span class="inline-code">cmp [rbp+i], 0Bh</span></h3>
    <ul>
      <li>Compara <code>i</code> con <code>0Bh</code> (hex) = <strong>11</strong> (decimal).</li>
      <li>En C++ se interpreta como <code>if (i <= 11)</code> o la condición de un <code>while</code>.</li>
    </ul>

    <h3>5️⃣ <span class="inline-code">jbe loc_140001529</span></h3>
    <ul>
      <li><strong>jbe</strong> = <em>Jump if Below or Equal</em> (salta si es menor o igual).</li>
      <li>Si <code>i &le; 11</code> entonces salta al cuerpo del bucle (<code>loc_140001529</code>); si no, continúa después.</li>
    </ul>
  </section>
