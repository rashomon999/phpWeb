...
if ($_POST) {
   ...
   if ($respuesta_5 === 'media poblacional') {  
   ...
   if ($respuesta_7 === 'promedio medido') {  
   ...
   if ($respuesta_9 === 'estimacion caiga dentro') {  
   ...
   if ($respuesta_10 === 'margen de error') {  
   ...
   if ($respuesta_11 === 'si repites') {  
    ...
    if ($respuesta_12 === '95 de cada 100') {  
    ...
    if ($respuesta_21 === 'error absoluto') {  
...
<input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>"size="13">
  real.<br>
Ej.: ±3% significa que el promedio real del programa podría 
...
<p>
  ...
  <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="7">
    individual 
  <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="7">
    con un 
  <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="7">
   .
</p>

<p><strong>Depende de:</strong> la resolución del 
<input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="7">
  o la tolerancia del fabricante.</p>
...
<input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>" size="10">
  de que la 
<input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>" size="19">
    del 
<input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>" size="15">
 .<br>
Ej.: 95% significa que 
<input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="7">
  el experimento muchas veces, 
<input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="13">
  veces tu 
<input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>" size="7">
  estará 
