...
<p>
En la conducción de experimentos DoE (Design of Experiments), un ingeniero realiza cambios deliberados o intencionados en
 las variables controlables del sistema o proceso, observa entonces los datos de salida del sistema y luego hace una 
 inferencia o decisión acerca de qué variables son responsables de los cambios observados en el rendimiento de salida.
</p>

<p>
Como cualquier disciplina altamente técnica, DoE está lleno de siglas y terminología que pueden intimidar al 
estudiante que lo estudia por primera vez. El propósito de este capítulo es entonces proporcionar de una manera no 
tan compliacada, una introducción a los muchos términos, conceptos y cuestiones de conducción de DoE. No espere 
entender todos los aspectos del DoE presentados en este capítulo la primera vez que lo lee. Muchos de los matices 
solo se harán evidentes después de su aplicación, ya sea en el trabajo final en éste curso o luego en la aplicación
 en otras materias o tal vez en su trabajo de grado y vida profesional. Después de leer este capítulo, debe tener
  una comprensión suficiente de la terminología y lenguaje de DoE para pasar a la consideración de diseño de 
  experimentos y sus aplicaciones.
</p>
...
<p>
<strong>Figura 1.2</strong> Diagrama de causa y efecto de tiempo de inactividad (fuera de servicio) del computador. Imagen tomada de: 
<a href="https://www.slideshare.net/johnpadua/production-and-quality-tools-seven-quality-tools-andintroduction-to-statistics" target="_blank">
