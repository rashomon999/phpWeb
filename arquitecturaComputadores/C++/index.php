...
<div class="seccion izquierda"> 
 ...
 <h3>1. <strong>std::istream</strong></h3>
<ul>
  <li><strong>Significado:</strong> <em>input stream</em> → flujo de entrada.</li>
  <li><strong>Función principal:</strong> leer datos desde alguna fuente.</li>
  <li><strong>Ejemplos de uso:</strong>
    <ul>
      <li><strong>std::cin</strong> → leer desde la consola.</li>
      <li><strong>std::ifstream</strong> → leer desde archivos.</li>
      <li><strong>std::istringstream</strong> → leer desde un string en memoria.</li>
    </ul>
  </li>
  <li><strong>Jerarquía simplificada:</strong>
    <pre>ios_base
 └── std::ios
       └── std::istream   ← lectura</pre>
  </li>
  <li><strong>Forma de uso típica:</strong>
    <pre>int x;
std::cin >> x; // lee un entero desde la consola</pre>
  </li>
</ul>

<hr>

<h3>2. <strong>std::ostream</strong></h3>
<ul>
  <li><strong>Significado:</strong> <em>output stream</em> → flujo de salida.</li>
  <li><strong>Función principal:</strong> escribir datos hacia algún destino.</li>
  <li><strong>Ejemplos de uso:</strong>
    <ul>
      <li><strong>std::cout</strong> → imprimir en la consola.</li>
      <li><strong>std::ofstream</strong> → escribir en archivos.</li>
      <li><strong>std::ostringstream</strong> → escribir en un string en memoria.</li>
    </ul>
  </li>
  <li><strong>Jerarquía simplificada:</strong>
    <pre>ios_base
 └── std::ios
       └── std::ostream   ← escritura</pre>
  </li>
  <li><strong>Forma de uso típica:</strong>
    <pre>std::cout << "Hola mundo\n"; // escribe en la consola</pre>
  </li>
</ul>
...
<ul>
  <li><strong>std::istream</strong> → <strong>entrada</strong> (leer datos)</li>
  <li><strong>std::ostream</strong> → <strong>salida</strong> (escribir datos)</li>
</ul>
