...
if ($_POST) {
   ...
   if ($respuesta_9 === 'metodos de acceso') {  
   ...
   if ($respuesta_10 === 'agrupamiento de datos') {  
   ...
   if ($respuesta_11 === 'Lenguaje de definicion de datos'
   || $respuesta_11 === 'lenguaje de definicion de datos') {  
     ...
     if ($respuesta_12 === 'Lenguaje de manipulacion de datos'
     || $respuesta_12 === 'lenguaje de manipulacion de datos') {  
     ...
     if ($respuesta_16 === 'Recuperacion' || $respuesta_16 === 'recuperacion'
     ) {  
     ...
     if ($respuesta_19 === 'independencia de datos') {  
   ...
   if ($respuesta_27 === 'reprogramacion') {  
   ...
   if ($respuesta_32 === 'esquema global') {  
...
if ($respuesta_39 === 'implementacion') { 
...
if ($respuesta_53 === 'esquema global') { 
...
<div class="seccion izquierda">
    ...
    <strong>Sistemas de Gestión de Bases de Datos (DBMS)</strong>
    <br><br>
    <p>
        Un <strong>sistema de gestión de bases de datos (DBMS, por sus siglas en inglés)</strong>
        es un 
    ...
    <ul>
        ...
        <li><strong>Vista física</strong> (
        <input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>" size="18">    
        ,
        <input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>" size="22">  
        ).</li>
        <li><strong>
        <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="22">  
        (DDL)
        </strong>.</li>
        <li><strong>
        <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="22">     
        (DML)
        </strong>.</li>
        <li><strong>Utilidades importantes</strong>, como:
    <ul>
        <li>Gestión de 
...
<hr>
<p>
    Los <strong>sistemas de bases de datos relacionales (RDBMS)</strong>, que son el
    tipo dominante de sistemas para bases de datos empresariales bien estructuradas,
    también proporcionan un mayor grado de 
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="18">      
    en 
    comparación con los primeros sistemas jerárquicos y en red (
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="8">  
    ).
</p>

<p>
    La <strong>independencia de datos</strong> es la 
    ...
    . Esto también facilita la conversión y reorganización de la base de datos.
</p>

<p>
    Los <strong>RDBMS</strong> proporcionan un grado mucho mayor de independencia de datos
    que los sistemas anteriores y, por esta razón, son el enfoque principal de nuestra
    discusión sobre modelado de datos.
</p>
    <button type="submit">Enviar</button>
    ...
    <hr>
    <br>
    <strong>Ciclo de Vida de la Base de Datos</strong>
    ...
    Una vez que el diseño ha sido completado, el ciclo de vida continúa con la 
   ...
   <br><br>
   <strong>Análisis de Requisitos: </strong>
    Los requisitos de la base de datos se 
    ...
    para generar una especificación formal de requisitos, la cual incluye:
    <li>
    Los 
    ...
    Por ejemplo, en la Figura 1.2 (Paso I) se muestra la formulación 
    de conceptos clave como productos, clientes, vendedores y pedidos,
    los cuales surgen en la mente del usuario final durante el proceso de entrevistas.
    <br><br>
    <button type="submit">Enviar</button>
    ...
    <li>
    <input type="text" name="respuesta_61" value="<?php echo $respuesta_61; ?>" size="18">
    (UML).
    </li>
    Las construcciones del modelo de datos deben transformarse, en última instancia, en 
...
<div class="seccion derecha">
    <form action="./septimo.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
    <strong>a. 
    <input type="text" name="respuesta_66" value="<?php echo $respuesta_66; ?>" size="28">    
    </strong>
    Los 
    <input type="text" name="respuesta_67" value="<?php echo $respuesta_67; ?>" size="8">    
    de datos se analizan y modelan mediante un diagrama 
    ...
    , el cual 
    incluye diversas características que estudiaremos en los capítulos 2 y 3. Algunos ejemplos
    ...
    <li>
    Supertipos y subtipos (categorías).
    </li>
 
    Los requisitos de 
    <input type="text" name="respuesta_65" value="<?php echo $respuesta_65; ?>" size="8">
    generalmente se especifican mediante expresiones en 
    lenguaje natural o comandos SQL, junto con la frecuencia de ocurrencia.
    <br><br>
    <button type="submit">Enviar</button>
    ...
    , 
    es común que surjan múltiples vistas de los datos y sus relaciones. Esto puede generar
    inconsistencias debido a variaciones en la taxonomía, contexto o percepción de los datos.
    <br><br>
    Para eliminar 
    <input type="text" name="respuesta_74" value="<?php echo $respuesta_74; ?>" size="8">    
    e inconsistencias en el modelo, es necesario 
    ...
    estas vistas en una única vista global.
    <br><br>
    La integración de vistas requiere el uso de herramientas semánticas de 
    <input type="text" name="respuesta_77" value="<?php echo $respuesta_77; ?>" size="5">    
    , tales como:
    <br><br>
    <li>
    Identificación de 
    ...
    <br>
    En la Figura 1.2 (Paso II.b), dos posibles vistas de la base de datos de productos y 
    clientes se combinan en una sola vista global basada en los datos comunes de clientes y pedidos.

    La integración de vistas también es fundamental cuando es necesario integrar 
    <input type="text" name="respuesta_79" value="<?php echo $respuesta_79; ?>" size="8">    
    , 
    ya que cada una puede haber sido desarrollada con su propia visión de la base de datos.
    <br><br>
    <button type="submit">Enviar</button>
    ...
    y sus entidades asociadas se transforman en un conjunto
    de tablas relacionales específicas para el DBMS.
    <br><br>
    Mostraremos estas transformaciones utilizando SQL estándar en el Capítulo 5. Como parte
    de este proceso, se eliminan tablas redundantes para optimizar la estructura de la base de datos.
    <br><br>
    En nuestro ejemplo, las tablas en el Paso II.c de la Figura 1.2 son el resultado de la
    transformación del modelo ER integrado del Paso II.b.
    <br><br>
    <button type="submit">Enviar</button>
