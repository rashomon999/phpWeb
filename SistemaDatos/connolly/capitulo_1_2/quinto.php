...
if ($_POST) {
   ...
   if ($respuesta_23 === 'almacenamiento') { 
   ...
   if ($respuesta_31 === 'organizaciones') {  
...
if ($respuesta_45 === 'sistema operativo') { 
...
if ($respuesta_58 === 'registros almacenados') { 
...
if ($respuesta_59 === 'metodos de representacion') { 
...
if ($respuesta_60 === 'campos de datos') { 
...
if ($respuesta_62 === 'estructuras de almacenamiento') { 
...
if ($respuesta_65 === 'Sistema de Gestión de Bases de Datos') { 
...
if ($respuesta_66 === 'correspondencia') { 
...
if ($respuesta_72 === 'conceptual/interno') { 
...
if ($respuesta_73 === 'registros fisicos') { 
...
if ($respuesta_74 === 'externo/conceptual') { 
...
<div class="seccion izquierda">
    ...
    <h2>2.1.1 Nivel Externo</h2>
    <br>
    <p>
    <strong>Nivel externo</strong>    
    La 
    ...
    de la base de datos. Este nivel describe la parte de la base 
    de datos que es relevante para cada usuario.</p>

    <p>El nivel externo consta de varias vistas externas diferentes de la base de datos. 
    Cada usuario tiene una visión del "mundo real" representada en una forma familiar
    para él. La vista externa incluye solo aquellas entidades, atributos y relaciones 
    en el "mundo real" que interesan al usuario. Otras entidades, atributos o relaciones 
    que 
    <input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>" size="8">
    sean de interés pueden estar representadas en la base de datos, pero el usuario
    no será 
    <input type="text" name="respuesta_4" value="<?php echo $respuesta_4; ?>" size="8">
    de ellas.</p>

    <p>Además, diferentes vistas pueden tener diferentes representaciones de los mismos datos.
    Por ejemplo, un usuario puede ver las fechas en el formato (día, mes, año), mientras que
    otro puede verlas como (año, mes, día). Algunas vistas pueden incluir datos derivados o
    calculados, es decir, datos que no están realmente almacenados en la base de datos, sino
    que se generan cuando son necesarios. </p>

    <p>Por ejemplo, en el estudio de caso de DreamHome, podríamos querer ver la edad de un miembro 
    del personal. Sin embargo, es poco probable que las edades se almacenen, ya que estos datos
    tendrían que actualizarse diariamente. En su lugar, se almacenaría la fecha de nacimiento 
    del miembro del personal, y el DBMS calcularía la edad cuando se haga referencia a ella.</p>     
    ...
    <hr>
    <h2>2.1.2 Nivel Conceptual</h2>
    <p>
    <strong>Nivel conceptual: </strong>    
    La vista 
    ...
    en la arquitectura de tres niveles es el nivel conceptual. 
    Este nivel contiene la 
    <input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>" size="8">   
    lógica de toda la base de datos según la percibe el 
    <input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>" size="8">   
    . 
    Representa una visión completa de los 
    ...
    de cualquier consideración de almacenamiento. El nivel conceptual incluye:</p>
    ...
    <p>El nivel conceptual 
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="8">          
    cada vista externa, ya que cualquier dato disponible para
    un usuario debe estar contenido en este nivel o ser derivable de él. Sin embargo, este 
    nivel 
    ...
    de una entidad debe incluir solo los tipos de datos de sus atributos (como entero, real, 
    carácter) y su longitud (como el número máximo de dígitos o caracteres), pero no detalles de 
    almacenamiento como la cantidad de bytes ocupados.</p>
    <br>
    <button type="submit">Enviar</button>
    ...
    <hr>
    <h2>2.1.3 Nivel Interno</h2>
    <p>
    <strong>Nivel interno: </strong>    
    La representación 
    <input type="text" name="respuesta_24" value="<?php echo $respuesta_24; ?>" size="8">          
    de la base de datos en la computadora. Este nivel 
    ...
    los datos en la base de datos.</p>

    <p>El nivel interno abarca la implementación 
    <input type="text" name="respuesta_27" value="<?php echo $respuesta_27; ?>" size="8">              
    de la base de datos para lograr un
    <input type="text" name="respuesta_28" value="<?php echo $respuesta_28; ?>" size="8">              
    óptimo en tiempo de ejecución y una utilización 
    ...
    de almacenamiento. También interactúa con los métodos 
    de 
    <input type="text" name="respuesta_34" value="<?php echo $respuesta_34; ?>" size="8">              
    del sistema operativo (técnicas de gestión de archivos para almacenar y recuperar 
    registros de datos) para colocar los datos en los dispositivos de almacenamiento, construir 
    los índices, recuperar los datos, y más. El nivel interno se ocupa de aspectos como:</p>
    ...
    <ul>
        ...
        para almacenamiento (con tamaños almacenados para los 
        elementos de datos).</li>
        <li>
    ...
    <p>Por debajo del nivel interno, existe un nivel 
    <input type="text" name="respuesta_44" value="<?php echo $respuesta_44; ?>" size="8">                  
    que puede ser gestionado por el 
    <input type="text" name="respuesta_45" value="<?php echo $respuesta_45; ?>" size="18">              

    bajo la dirección del DBMS. Sin embargo, las funciones del DBMS y del 
    sistema operativo en el nivel físico 
    <input type="text" name="respuesta_46" value="<?php echo $respuesta_46; ?>" size="8">              
    están claramente definidas y varían de un sistema 
    a otro. Algunos DBMS aprovechan muchos de los métodos de acceso del sistema operativo,
     mientras que otros utilizan solo los más básicos y crean sus propias organizaciones de 
     archivos. El nivel físico, por debajo del DBMS, consta de elementos que solo el sistema 
     operativo conoce, como la forma exacta en que se implementa la secuenciación y si los 
     campos de los registros internos se almacenan como bytes contiguos en el disco.</p>
    <button type="submit">Enviar</button>
...
<div class="seccion derecha">
    <form action="./quinto.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
    <h2>2.1.4 Esquemas, Mapeos e Instancias</h2>
    <p>La 
    <input type="text" name="respuesta_47" value="<?php echo $respuesta_47; ?>" size="8">                  
    general de la base de datos se denomina 
    <strong>
    <input type="text" name="respuesta_48" value="<?php echo $respuesta_48; ?>" size="8">                      
    de la base de datos</strong>. Existen tres tipos diferentes de 
    esquemas en la base de datos, los cuales se definen de acuerdo con los niveles de 
    abstracción de la arquitectura de tres niveles.</p>
    ...
    <ul>
        ...
        <li><strong>Esquema conceptual:</strong> 
        ...
        y  <input type="text" name="respuesta_54" value="<?php echo $respuesta_54; ?>" size="8">,
        junto con las 
        <input type="text" name="respuesta_55" value="<?php echo $respuesta_55; ?>" size="8">  
        de integridad.</li>


        <li><strong>Esquema interno:</strong> Contiene la 
    ...
    <p>Cada base de datos tiene un 
    <input type="text" name="respuesta_63" value="<?php echo $respuesta_63; ?>" size="8">    
    <strong>esquema conceptual</strong> y un
    <input type="text" name="respuesta_63" value="<?php echo $respuesta_63; ?>" size="8" readonly> 
     <strong>esquema interno</strong>.</p>
    ...
    También verifica la consistencia de los esquemas,
     asegurándose de que:</p>
    <ul>
        <li>Cada esquema 
        <input type="text" name="respuesta_68" value="<?php echo $respuesta_68; ?>" size="8">        
        sea derivable del esquema 
        ...
        cada esquema externo al esquema 
    ...
    con el esquema conceptual mediante un <strong>mapeo 
    ...
    del usuario a su equivalente en 
    el esquema 
    ...
    <h2>Ejemplo de los diferentes niveles</h2>
    <p>Supongamos dos vistas externas de los datos del personal:</p>
    <ul>
        <li>Primera vista: número de empleado (<code>sNo</code>), nombre (<code>fName</code>), 
        apellido (<code>lName</code>), edad (<code>age</code>) y salario (<code>salary</code>).</li>

        <li>Segunda vista: número de empleado (<code>staffNo</code>), apellido (<code>lName</code>)
         y número de sucursal donde trabaja (<code>branchNo</code>).</li>
    </ul>
    
    <p>Estas vistas externas se combinan en una única <strong>vista conceptual</strong>.
    Durante este proceso, el campo <code>age</code> se transforma en <code>DOB</code> 
    (fecha de nacimiento). El DBMS mantiene los mapeos entre los niveles:</p>

    <ul>
        <li>Mapeo externo/conceptual: Traduce <code>sNo</code> al campo <code>staffNo</code> 
        del esquema conceptual.</li>

        <li>Mapeo conceptual/interno: Define la estructura de almacenamiento físico del 
        esquema conceptual.</li>
    </ul>
    
    <p>En el nivel interno, la estructura de los registros incluye punteros como <code>next</code>,
    que permiten enlazar físicamente los registros en una lista encadenada. Cabe destacar
    que el orden de los campos en el nivel interno puede diferir del nivel conceptual,
    y el DBMS es responsable de mantener la correspondencia entre ellos.</p>
    <hr>
    <br>
    ...
    <h1>Esquema e Instancia de Base de Datos</h1>

    <p>Es importante distinguir entre la descripción de la base de datos y la base de datos en sí.
    La descripción de la base de datos es el <strong>
    <input type="text" name="respuesta_79" value="<?php echo $respuesta_79; ?>" size="8">      
    de la base de datos</strong>.</p>

    <p>El esquema se especifica durante el proceso de 
    <input type="text" name="respuesta_80" value="<?php echo $respuesta_80; ?>" size="8">      
    de la base de datos y no 
    se espera que cambie con frecuencia. Sin embargo, los datos reales en la base de 
    datos pueden cambiar con frecuencia; por ejemplo, cambian cada vez que insertamos 
    los detalles de un nuevo miembro del personal o una nueva propiedad.</p>

    <p>Los datos en la base de datos en un momento determinado se denominan <strong>
    <input type="text" name="respuesta_81" value="<?php echo $respuesta_81; ?>" size="8">      
    de la base de datos</strong>. Por lo tanto, muchas instancias de la base de datos 
    pueden corresponder al mismo esquema de base de datos.</p>

    <p>El esquema a veces se llama la <strong>
    <input type="text" name="respuesta_82" value="<?php echo $respuesta_82; ?>" size="8">      
    </strong> de la base de datos; una 
    instancia se llama una <strong>extensión</strong> (o estado) de la base de datos.</p>
    <br><br>
    <button type="submit">Enviar</button>
