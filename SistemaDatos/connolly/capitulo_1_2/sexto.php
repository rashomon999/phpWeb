...
if ($_POST) {
   ...
   if ($respuesta_11 === 'organizacion') {  
     ...
     if ($respuesta_13 === 'almacenamiento') { 
   ...
   if ($respuesta_28 === 'almacenamiento') {  
   ...
   if ($respuesta_33 === 'elemento de dato') {  
...
if ($respuesta_52 === 'disponibilidad') { 
...
<div class="seccion izquierda">
    ...
    <h1>2.1.5 Independencia de Datos</h1>

    <p>Un objetivo principal de la 
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="8">    
    de tres niveles es proporcionar
    <strong>independencia de datos</strong>, lo que significa que los niveles 
    <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="8">
    no se vean afectados por cambios en los niveles 
    <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="8">
    . Existen 
    dos tipos de independencia de datos: <strong>
    ...
    <div class="box">
    <h2>Independencia de Datos Lógica</h2>
    <p>Los cambios en el <strong>
    <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="8">    
    conceptual</strong>, como la adición o eliminación 
    de nuevas entidades, atributos o relaciones, deben ser posibles sin necesidad de modificar
    los esquemas 
    <input type="text" name="respuesta_7" value="<?php echo $respuesta_7; ?>" size="8">    
    existentes o reescribir los programas de aplicación.</p>

    <p>Los usuarios para quienes se realizan estos cambios deben ser informados, pero 
    lo importante es que otros usuarios no se vean afectados por estas modificaciones.</p>
    </div>

    <div class="box">
    <h2>Independencia de Datos Física</h2>
    <p>Es la inmunidad del <strong>esquema 
    <input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>" size="8">    
    </strong> ante cambios en el
    <strong>esquema 
    <input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>" size="8">    
    </strong>. Es decir, los cambios en la forma en que 
    los datos están físicamente almacenados no deben afectar la estructura lógica
    de la base de datos.</p>
    </div>
    <button type="submit">Enviat</button>
    ...
    de almacenamiento</strong>, <strong>
    ...
    </strong>, o la modificación de <strong>índices</strong>
    y <strong>algoritmos de hashing</strong>. Idealmente, estos cambios deben realizarse sin
    afectar los esquemas <strong>
    ...
    <p>Desde la perspectiva de los usuarios, la única diferencia notable de estos cambios
    podría ser en el <strong>
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="8">
    </strong> del sistema. Por ejemplo, si se optimizan 
    los índices o se cambia la forma en que los datos están organizados en el disco, el
    tiempo de respuesta de las consultas puede mejorar o empeorar. De hecho, la razón
    más común para realizar cambios en el esquema 
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="8">
    es la necesidad de <strong>mejorar 
    el 
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="8">
    </strong>.</p>

    <h2>Relación con la Arquitectura de Tres Niveles</h2>
    <p>La <strong>arquitectura ANSI-SPARC</strong> establece un sistema de tres niveles
    donde cada nivel es independiente del otro mediante un proceso de <strong>mapeo de 
    datos</strong>:</p>

    <ul>
        <li><strong>Independencia de datos física</strong> → Se logra cuando los cambios
        en el esquema interno <strong>no afectan</strong> el esquema conceptual ni el externo.</li>

        <li><strong>Independencia de datos lógica</strong> → Se logra cuando los cambios en el
        esquema conceptual <strong>no afectan</strong> los esquemas externos.</li>

    </ul>

    <p>Sin embargo, este <strong>mapeo en dos etapas</strong> (del externo al conceptual y 
    luego al interno) puede ser <strong>ineficiente</strong>. Para mejorar el rendimiento,
    la arquitectura ANSI-SPARC permite hacer un <strong>mapeo 
        
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="8">

    </strong> del esquema 
    externo al esquema interno, sin pasar por el conceptual.</p>

    <p>El problema con este enfoque es que <strong>reduce la 
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="8">
    
    de datos</strong>. 
    Es decir, cualquier cambio en el esquema interno podría afectar directamente el esquema
    externo y los programas de aplicación, lo que haría el sistema más frágil y difícil 
    de mantener.</p>
    <br>
...
<div class="seccion derecha">
    ...
    <strong>Evolución y Diseño de Bases de Datos Relacionales: </strong>

    El diseño de bases de datos relacionales ha evolucionado de un arte a una ciencia que 
    se ha podido implementar parcialmente como un conjunto de herramientas de diseño de software.
    <br><br>
    Muchas de estas herramientas han aparecido como el componente de bases de datos de herramientas
    de ingeniería de software asistida por computadora (
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="8">    
    , por sus siglas en inglés), y muchas
    de ellas ofrecen capacidades de modelado interactivo utilizando un enfoque simplificado de 
    modelado de datos.
    <br><br>
    El diseño lógico, es decir, la 
    ...
    en particular, es en gran medida responsabilidad de los 
    diseñadores de aplicaciones. Estos diseñadores pueden realizar su trabajo de manera efectiva
    con herramientas CASE como ERwin Data Modeler o Rational Rose con Unified Modeling Language (UML), 
    así como con un enfoque completamente manual.
    <br><br>
    El diseño físico, que implica la 
    ...
    en la plataforma informática utilizada, es típicamente responsabilidad
    ...
    Los DBA de hoy en día cuentan con una variedad de herramientas proporcionadas por los proveedores 
    para ayudar a diseñar bases de datos de la manera más eficiente.
    <br><br>
    Este libro está dedicado a las metodologías de diseño lógico y a las herramientas más populares
    para bases de datos relacionales en la actualidad. Las metodologías y herramientas de diseño
    físico se cubren en un libro aparte.
    <hr>
    ...
    <strong>Gestión de Datos y Bases de Datos: </strong>
    <br>
    El componente 
    <input type="text" name="respuesta_32" value="<?php echo $respuesta_32; ?>" size="8">
    de un archivo en un sistema de archivos es un 
    ...
    Ejemplos
    de elemento de datos incluyen: apellido, nombre, dirección, número de identificación
    y partido político.
    <br><br>
    <button type="submit">Enviar</button>
    ...
    . Algunos ejemplos de registros incluyen pedidos, vendedores, 
    clientes, productos y departamentos.
    <br><br>
    ...
    Los sistemas de bases de datos han ampliado estas definiciones:
    <br><br>
    En una base de datos relacional, un elemento de datos se llama 
    ...
    Una base de datos es un objeto más complejo; es una colección de datos almacenados 
    e interrelacionados que sirven a las necesidades de múltiples usuarios dentro de 
    una o más organizaciones, es decir, una colección interrelacionada de muchos 
    tipos diferentes de tablas.
    <br><br>
    Las razones principales para usar bases de datos en lugar de archivos incluyen:
    <li>
    Mayor 
    ...
    de datos, lo que facilita el acceso y la actualización en transacciones complejas.
    </li>
    <li>
    Menor 
