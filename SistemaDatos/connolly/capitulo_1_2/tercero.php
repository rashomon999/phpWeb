...
if ($_POST) {
   ...
   if ($respuesta_11 === 'diseñadores de bases de datos') {  
     ...
     if ($respuesta_14 === 'usuarios finales.') {  
...
<div class="seccion izquierda">
    ...
    El modelo relacional no está exento de limitaciones, en particular sus capacidades de 
    ...
    En 1976, Chen presentó el modelo Entidad-Relación, que ahora es una técnica ampliamente aceptada
    ...
    intentos de proporcionar un modelo de datos que represente más fielmente el “mundo real” han 
    ...
    A finales de los 90, se desarrolló XML (eXtensible Markup Language), lo que tuvo un
    impacto significativo en muchos aspectos de la informática, incluyendo
    ...
    de bases de datos con la Web y XML en los Capítulos 29 y 30.
    <br><br>
