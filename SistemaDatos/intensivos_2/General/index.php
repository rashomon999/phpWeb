...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {        
        ...
        $respuesta_1 = 'Online Transaction Processing';
        $respuesta_2 = 'Online Analytical Processing';
        $respuesta_3 = 'Atomicity';
        $respuesta_4 = 'Consistency';
        $respuesta_5 = 'Isolation';
        $respuesta_6 = 'Durability';
        $respuesta_7 = '104';
        $respuesta_8 = '117';
        $respuesta_9 = '130';
        $respuesta_10 = '143';
   ...
   if ($respuesta_1 === 'Online Transaction Processing') {  
   ...
   if ($respuesta_2 === 'Online Analytical Processing') {  
...
<div class="seccion izquierda"> 
    <p>
    OLTP  (<input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="41">)
    </p>
 
    <p>
    OLAP (<input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="41">)
    </p>
 

    ACID:
    <ul>
        <li><input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>" size="21"></li>
        <li><input type="text" name="respuesta_4" value="<?php echo $respuesta_4; ?>" size="21"></li>
        <li><input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="21"></li>
        <li><input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="21"></li>
    </ul>
    <hr>
