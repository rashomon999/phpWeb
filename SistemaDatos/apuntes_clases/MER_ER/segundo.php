...
<div class="seccion izquierda">
    <form action="./segundo.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
     <strong>Por la relacion unitaria anterior, se planteo esta solucion: </strong>
      
     <img src="../../../img/actualizacion.png" alt="" width="600">
     <hr>
     <h1>Diferencia entre Entidades Débiles y Fuertes</h1>
    
    <div class="model">
        <h2>1. Modelo con ANIMAL como Entidad Débil (usa PF*)</h2>
        <ul>
            <li><span class="highlight">PF*</span> significa "Partial Key + Foreign Key"</li>
            <li>Aquí ANIMAL <span class="highlight">no puede existir sin</span> ECOSISTEMA</li>
            <li>Su identificador único es <span class="highlight">compuesto</span>: (id_animal + id_ecosistema)</li>
        </ul>
    </div>
    
    <div class="model">
        <h2>2. Modelo con ANIMALv1 como Entidad Fuerte (usa F*)</h2>
        <ul>
            <li><span class="highlight">F*</span> significa solo "Foreign Key"</li>
            <li>ANIMALv1 <span class="highlight">puede existir independientemente</span></li>
            <li>Su identificador es <span class="highlight">simple</span> (solo id_animal)</li>
            <li>La relación con ECOSISTEMAv1 es <span class="highlight">opcional</span></li>
        </ul>
    </div>
    <img src="../../../img/animal.png" alt="" width="600">
    <br><br>
    <img src="../../../img/animal_dos.png" alt="" width="600">
    <hr>
    <strong>Relacion consigo mismo</strong>
    <br><br>
    <img src="../../../img/empleado_tres.png" alt="" width="600">
    <img src="../../../img/empleado_cuatro.png" alt="" width="600">
   </form>
</div>
