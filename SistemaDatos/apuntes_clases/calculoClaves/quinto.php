...
<div class="seccion izquierda"> 
 ...
 <h3>Enunciado</h3>
  ...
  <p>
    Para el ejercicio anterior suponga que:
  </p>
  ...
  <p>
    Calcule todas las claves y determine su máximo nivel de normalización.
  </p>
  ...
  <h3>Cierre de una clave</h3>

  <p>
    \(C_1^{+} = \{ ab, f, c, e, b, g, d, h, a \}\)
  </p>
  ...
  <p>
    <strong>1FN:</strong> ✓ cumple
  </p>

  <p>
    <strong>2FN:</strong> no cumple
  </p>

  <p>
    Hay dependencias donde parte de la clave determina un atributo no primo.
    <br>
    Ejemplo: \( f \rightarrow c\)
  </p>
    <hr>


    <h5>3) Calcule todas las claves de los siguientes esquemas</h5>
...
<p>
  \(L = \{ ab \rightarrow c,\; h \rightarrow ij,\; bd \rightarrow fg,\; ae \rightarrow c,\; ij \rightarrow k \}\)
</p>
...
<p>
  \( L = \{ p \rightarrow c,\; c \rightarrow d,\; d \rightarrow t \}\)
</p>
...
<p>
  <strong>2FN:</strong> ✓ no hay dependencias parciales (atributos no clave dependientes de una parte de una clave compuesta)
</p>

<p>
  <strong>3FN:</strong> ✗ atributo no clave depende de otro atributo no clave
</p>

<p>
  Atributos no clave: \(\{ c,\; d,\; t \}\)
</p>

<p>
  Como son transitivas no están en 3FN
</p>
...
<p>
  Como todos los atributos son principales se encuentra en 3FN
</p>
</div>
