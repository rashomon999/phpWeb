...
<div class="seccion izquierda">
    ...
    <div class="section">
        <h2>Atributos importantes de cursores</h2>
        <table>
            <tr>
                <th>Atributo</th>
                <th>Descripción</th>
            ...
            <tr>
                <td>%NOTFOUND</td>
                <td>Verdadero cuando no hay más filas por leer</td>
                <td>exit when cursor%notfound;</td>
            </tr>
            <tr>
                <td>%FOUND</td>
                <td>Verdadero cuando se ha leído una fila</td>
                <td>if cursor%found then...</td>
            </tr>
            <tr>
                <td>%ROWCOUNT</td>
                <td>Número de filas procesadas hasta el momento</td>
                <td>if cursor%rowcount > 10 then...</td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <div class="code">
<pre>BEGIN
    -- Mostrar empleados del departamento 20 con su antigüedad
    muestra_emp(20);
END;
/
