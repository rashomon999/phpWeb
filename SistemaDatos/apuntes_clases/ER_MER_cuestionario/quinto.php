...
if ($_POST) {
   ...
   if ($respuesta_2 === 'tablas separadas') {  
   ...
   if ($respuesta_7 === 'Crear una tabla') {  
   ...
   if ($respuesta_11 === 'subtipo') {  
    ...
    if ($respuesta_13 === 'Crear una columna') { 
    ...
    if ($respuesta_16 === 'Crear una columna') {  
    ...
    if ($respuesta_17 === 'atributo especifico') {  
    ...
    if ($respuesta_19 === 'Crear columnas') {  
   ...
   if ($respuesta_23 === 'Crear columnas') {  
   ...
   if ($respuesta_28 === 'pocos atributos') {  
   ...
   if ($respuesta_29 === 'pocas asociaciones') {  
   ...
   if ($respuesta_30 === 'consultas frecuentes') {  
   ...
   if ($respuesta_31 === 'diferentes subtipos') {  
   ...
   if ($respuesta_33 === 'informacion') {  
    ...
    if ($respuesta_35 === 'acceso a los datos') { 
    ...
    if ($respuesta_45 === 'solo un subtipo') { 
...
if ($respuesta_53 === 'restriccion CHECK') { 
...
if ($respuesta_64 === 'admitir valores nulos') { 
...
if ($respuesta_72 === 'tablas independientes') { 
...
if ($respuesta_74 === 'Crear una tabla') { 
...
if ($respuesta_76 === 'Crear una columna') { 
...
if ($respuesta_79 === 'Crear columnas') { 
...
if ($respuesta_81 === 'relacion') { 
    ...
    if ($respuesta_86 === 'Crear columnas') { 
...
if ($respuesta_93 === 'tablas de subtipos') { 
...
if ($respuesta_94 === 'Crear columnas') { 
...
if ($respuesta_107 === 'la clave primaria') { 
...
if ($respuesta_109 === 'un solo subtipo') { 
...
if ($respuesta_118 === 'modelo relacional') {  
...
if ($respuesta_119 === 'controlarse por programacion') {  
...
if ($respuesta_122 === 'requiere control') {  
...
if ($respuesta_125 === 'pierde parcialmente') {  
...
if ($respuesta_127 === 'Restriccion'
|| $respuesta_127 === 'restriccion'
) {  
...
if ($respuesta_128 === 'Excluyentes'
|| $respuesta_128 === 'excluyentes'
) {  
...
if ($respuesta_129 === 'Eliminacion'
|| $respuesta_129 === 'eliminacion'
) {  
...
if ($respuesta_130 === 'Supertipo'
|| $respuesta_130 === 'supertipo'
...
<h5>6-Escoger opciones para las relaciones supertipo/subtipos</h5>
<ul>Opciones  
<li>Subtipos en 
...
<input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="15">    
 ...
 <img src="../../../img/guia_327.png" alt="" width="600">

 <h5>Opción 1: Subtipos en 
 <input type="text"  value="<?php echo $respuesta_1; ?>" size="15" readonly>    
 </h5>

<p>
Esta opción de diseño consiste en 
...
<h5>Pasos para la Implementación</h5>
...
<ul>
    ...
    <li>
        ...
        <input type="text" name="respuesta_39" value="<?php echo $respuesta_39; ?>" size="8">
          puede realizarse mediante el uso de 
...
<h5>Restricciones sobre los Atributos de los Subtipos</h5>
...
<p>
Esto se debe a que una fila representa 
...
<hr>
 <img src="../../../img/guia_328.png" alt="" width="600">

<p>La columna TIPO, identifica los subtipos (T -  TEMPORAL, P – DEPLANTA) </p>

<h5>Desventajas de la Opción 1: Subtipos en una Sola Tabla</h5>
...
<ul>
    <li>
        ...
        Entidad–Relación para cada subtipo 
        ...
        <input type="text" name="respuesta_62" value="<?php echo $respuesta_62; ?>" size="8">
          directamente en el esquema relacional, ya que las 
        <input type="text" name="respuesta_63" value="<?php echo $respuesta_63; ?>" size="8">
          de los subtipos deben 
    ...
    <li>
        ...
        <input type="text" name="respuesta_68" value="<?php echo $respuesta_68; ?>" size="8">
          del diseño y del mantenimiento.
    </li>
</ul>
...
<div class="seccion derecha">
  ...
  <h5>Opción 2: Subtipos en Tablas Separadas</h5>
...
<p>
<em>
*Relación en el sentido del modelo Entidad–Relación
</em>
</p>

<hr>
 
  <img src="../../../img/guia_329.png" alt="" width="600">
<h5>Características del Diseño</h5>
...
<ul>
    ...
    <li>
        ...
        de los 
        <input type="text" name="respuesta_98" value="<?php echo $respuesta_98; ?>" size="8">
        subtipos definidos en el modelo E-R
         se hacen cumplir 
         <input type="text" name="respuesta_98" value="<?php echo $respuesta_98; ?>" size="8">
         directamente 
        desde la definición de la base de datos.
    </li>
...
<ul>
    ...
    <li>
        ...
        <input type="text" name="respuesta_126" value="<?php echo $respuesta_126; ?>" size="8">
          de supertipo 
        definido en el modelo conceptual.
    </li>
</ul>


 <img src="../../../img/guia_330.png" alt="" width="600">
    <hr>
</div>
</div>
 </form>
