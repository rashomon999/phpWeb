...
if ($_POST) {
   ...
   if ($respuesta_10 === 'ambos sentidos') {  
   ...
   || $respuesta_11 === 'clave foranea'
    ...
    if ($respuesta_15 === 'menor cardinalidad') { 
    ...
    if ($respuesta_22 === 'claves foraneas') {  
   ...
   if ($respuesta_24 === 'clave primaria') {  
   ...
   if ($respuesta_30 === 'genera una nueva tabla') {  
   ...
   if ($respuesta_31 === 'Diseño de Arco Explicito'
   || $respuesta_31 === 'Diseño de arco explicito'
   || $respuesta_31 === 'diseño de arco explicito'
   ) {  
   ...
   if ($respuesta_32 === 'Diseño de Arco Generico'
   || $respuesta_32 === 'Diseño de arco generico'
   || $respuesta_32 === 'diseño de arco generico'
   ) {  
   ...
   if ($respuesta_33 === 'Una CF') {  
    ...
    if ($respuesta_36 === 'claves foraneas') { 
    ...
    if ($respuesta_37 === 'diferentes dominios') { 
    ...
    if ($respuesta_41 === 'contener nulos') { 
    ...
    if ($respuesta_45 === 'columna adicional') { 
...
<div class="seccion izquierda"> 
    ...
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="8">
     .</p>
    <img src="../../../img/guia_312.png" alt="" width="800">
    <p>Si ambos lados de la relación son 
    <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="8">    
     , la CF se debe colocar en 
    ...
    <hr>
    <img src="../../../img/guia_313.png" alt="" width="400">
    ...
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="8">
      la relación 1:1 en una 
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="8">
     .
    Razón: minimizar valores nulos</p>
 
     <p><strong>HOMBRE</strong> (identificacion, nombre)</p>

  <p><strong>MUJER</strong> (identificacion, nombre)</p>

  <p>
    <strong>MATRIMONIO</strong> (id_hombre, id_mujer)<br>
    <span style="margin-left: 40px;">Clave alternativa</span><br>
    <span style="margin-left: 40px;">UNIQUE, NOT NULL</span>
  </p>
  ...
  <p>Si el 
    ...
    <img src="../../../img/guia_314.png" alt="" width="800">

    <hr>

    <p>Para relaciones recursivas 1:N, se debe 
    ...
    <input type="text" name="respuesta_27" value="<?php echo $respuesta_27; ?>" size="8">
     . </p>
    <img src="../../../img/guia_315.png" alt="" width="800">
    <img src="../../../img/guia_316.png" alt="" width="400">

    <hr>
    <p>Para relaciones recursivas 1:1, se debe 
    ...
    <input type="text" name="respuesta_29" value="<?php echo $respuesta_29; ?>" size="8">
      a la relación.</p>
    <img src="../../../img/guia_317.png" alt="" width="800">
    <img src="../../../img/guia_318.png" alt="" width="400">
...
<div class="seccion derecha">
    ...
    <p>Para relaciones muchos a muchos, se 
    <input type="text" name="respuesta_30" value="<?php echo $respuesta_30; ?>" size="21">    
     , para almacenar la relación.</p>
    <img src="../../../img/guia_321.png" alt="" width="600">
    <img src="../../../img/guia_322.png" alt="" width="200">
    <hr>

    <h5>Escoger opciones de arco</h5>
    <img src="../../../img/guia_323.png" alt="" width="800">
    <ul>Se pueden llevar al modelo relacional de dos formas: 
        <li>
    ...
    <h5>
    <input type="text"  value="<?php echo $respuesta_31; ?>" size="21">    
     </h5>
    <li>
    ...
    <li>Se debe utilizar cuando las 
    ...
    <input type="text" name="respuesta_38" value="<?php echo $respuesta_38; ?>" size="8">    
      se debe recurrir a una cláusula de chequeo (check) la cual garantiza 
    que si una 
    ...
    <input type="text" name="respuesta_40" value="<?php echo $respuesta_40; ?>" size="8">
      las demás CF’s del arco deberán 
    <input type="text" name="respuesta_41" value="<?php echo $respuesta_41; ?>" size="8">
     </li>

    <img src="../../../img/guia_324.png" alt="" width="800">
    
    <hr>
    <h5>
    <input type="text"  value="<?php echo $respuesta_32; ?>" size="21">
    </h5>
    <p>Una sola columna que 
    ...
    <input type="text" name="respuesta_63" value="<?php echo $respuesta_63; ?>" size="8">    
      queda asegurada, no se debe hacer nada 
    <input type="text" name="respuesta_64" value="<?php echo $respuesta_64; ?>" size="8">
     .</li>
 
    <img src="../../../img/guia_325.png" alt="" width="800">
        
    <p>Se debe definir el dominio de TipoGenerador, por ejemplo: </p>
    <p><strong>P: Persona</strong></p>
    
    <p><strong>E: Empresa</strong></p>
      
    <p>En este diseño el campo cédula y nit en las tablas PERSONA y EMPRESA deben tener el mismo formato</p>
    <hr>
    <p>   Modelo relacional del 
    Diseño de Arco Explícito y
    Diseño de Arco Genérico.</p>
    <img src="../../../img/guia_326.png" alt="" width="400">
    <hr>
</div>
</div>
 </form>
