...
<div class="seccion izquierda">
    ...
    <h3>Identidades del ángulo mitad </h3>
<p>Las otras dos formas de la identidad de ángulo doble para coseno se derivan directamente de la forma general:</p>

<p>\[
\cos(2\alpha) = \cos^2(\alpha) - \sin^2(\alpha).
\]</p>

<p>Te muestro cómo se hace:</p>

<p>📌 1️⃣ A partir de la forma general</p>
<p>\[
\cos(2\alpha) = \cos^2(\alpha) - \sin^2(\alpha)
\]</p>

<p>📌 2️⃣ Usando \( \sin^2(\alpha) = 1 - \cos^2(\alpha) \)</p>
<p>Reemplaza \( \sin^2(\alpha) \):</p>
...
<p>📌 3️⃣ Usando \( \cos^2(\alpha) = 1 - \sin^2(\alpha) \)</p>
<p>Reemplaza \( \cos^2(\alpha) \):</p>
...
<p>Sí, todo sale de la forma general usando la relación fundamental:</p>
...
<p>Versión 1: \( \cos(2\alpha) = \cos^2 - \sin^2 \)<br>
Versión 2: \( \cos(2\alpha) = 2\cos^2 - 1 \)<br>
Versión 3: \( \cos(2\alpha) = 1 - 2\sin^2 \)</p>

<p>Todas son la misma identidad, solo escrita para conveniencia.</p>

<hr>

<p>Ahora, ¿cómo se pasa de eso a la fórmula de medio ángulo para seno?</p>

<p>📌 Vamos paso a paso:</p>

<p>🔹 1️⃣ Punto de partida</p>
<p>Partimos de la identidad de ángulo doble:</p>

<p>\[
\cos(2x) = 1 - 2\sin^2(x).
\]</p>

<p>🔹 2️⃣ Queremos despejar \( \sin(x) \):</p>

<p>\[
\cos(2x) - 1 = -2\sin^2(x).
\]</p>

<p>Multiplicamos por -1:</p>

<p>\[
1 - \cos(2x) = 2\sin^2(x).
\]</p>

<p>🔹 3️⃣ Dividir entre 2:</p>

<p>\[
\sin^2(x) = \frac{1 - \cos(2x)}{2}.
\]</p>

<p>🔹 4️⃣ Raíz cuadrada:</p>

<p>\[
\sin(x) = \pm \sqrt{ \frac{1 - \cos(2x)}{2} }.
\]</p>

<p>🔹 5️⃣ Cambiar la variable:</p>

<p>Sea \( x = \frac{\alpha}{2} \), entonces \( 2x = \alpha \). Así:</p>
...
<p>✔️ Clave:</p>
<p>No “partes la identidad”, sino que la transformas paso a paso:<br>
1️⃣ Usas la forma de ángulo doble.<br>
2️⃣ Despejas \( \sin^2 \).<br>
3️⃣ Divides.<br>
4️⃣ Sacas raíz.<br>
5️⃣ Cambias la variable.</p>
...
<div class="seccion derecha">
    ...
    <h3>Reduccion de potencias</h3>


    <p>📌 1️⃣ Partimos del ángulo doble</p>
<p>Por ejemplo:</p>
...
<p>De aquí sale la reducción de potencias para \(\sin^2(x)\).</p>

<p>📌 2️⃣ Despejamos \(\sin^2(x)\)</p>
<p>De la misma forma:</p>

<p>\[
\cos(2x) = 1 - 2\sin^2(x) \Longrightarrow 2\sin^2(x) = 1 - \cos(2x) \Longrightarrow \sin^2(x) = \frac{1 - \cos(2x)}{2}.
\]</p>

<p>✅ ¡Ahí está la reducción de potencia para seno al cuadrado!</p>

<p>📌 3️⃣ Lo mismo para \(\cos^2(x)\)</p>
<p>Usamos:</p>
...
<p>\[
\cos(2x) + 1 = 2\cos^2(x) \Longrightarrow \cos^2(x) = \frac{1 + \cos(2x)}{2}.
\]</p>

<p>✅ ¡Ahí está la reducción de potencia para coseno al cuadrado!</p>

<p>📌 4️⃣ ¿Por qué se llama reducción de potencias?</p>

<p>Porque convierte:</p>

<p>\(\sin^2(x)\) o \(\cos^2(x)\) en algo sin potencias, solo coseno de ángulo doble.</p>

<p>🔑 Clave: Misma idea</p>

<p>Despejas como en álgebra.</p>

<p>Solo usas identidad de ángulo doble.</p>

<p>No hay magia: es mover términos y dividir.</p>
...
<p>Usas Pitágoras para expresarlo solo en \(\sin^2\) o solo en \(\cos^2\).</p>

<p>Despejas, divides y listo.</p>
