...
if ($_POST) {
   ...
   $respuesta_11_dos = str_replace(' ','',subject: $respuesta_11);
    if ($respuesta_11_dos === '\frac{\pi}{2}+n\pi'
    || $respuesta_11_dos === '\frac{\pi}{2}+\pin'
...
<div class="seccion izquierda"> 
 ...
 <div>
    <h3> Ceros del seno \( \sin(x) \)</h3>
    <p>La función seno se 
    ...
    value="<?php echo $respuesta_1 ?>" size="8">  
  :</p>

  <p>\( \sin(x) = 0 \quad \text{cuando} \quad \)
    
    <span id="formula2">\( x = \)</span>
    <input type="text" name="respuesta_2" id="respuesta_2" oninput="actualizarFormula2()" 
    value="<?php echo $respuesta_2 ?>" size="8">
  
    \( \quad  \text{para todo} \quad n\)

    <span id="formula3">\( \)</span>
    <input type="text" name="respuesta_3" id="respuesta_3" oninput="actualizarFormula3()" 
    value="<?php echo $respuesta_3 ?>" size="8">
  ...
  <h3> Ceros del coseno \( \cos(x) \)</h3>
<p>La función coseno se 
  <input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>" size="8">
  en los puntos:
</p>

<p>\( \cos(x) = 0 \quad \text{cuando} \quad \)

  <span id="formula4">\( x = \)</span>
  <input type="text" name="respuesta_11" id="respuesta_11" oninput="actualizarFormula4()" 
  value="<?php echo $respuesta_11 ?>" size="8">

  \( \quad \text{para todo} \quad n  \)

  <span id="formula5">\( \)</span>
<input type="text" name="respuesta_12" id="respuesta_12" oninput="actualizarFormula5()" 
value="<?php echo $respuesta_12 ?>" size="8">
 
</p>

<p> Entonces, hay un cero cada 
  <input type="text" name="respuesta_13" value="<?php echo $respuesta_13 ?>" size="8">
  unidades, pero desplazado respecto al seno (empieza en 
  <input type="text" name="respuesta_14" value="<?php echo $respuesta_14 ?>" size="8">).
</p>

<p><strong>3 primeros:</strong></p>
<ul>
  <li>\( \cos(\)
...
<button onmousedown="mostrarMensaje()" onmouseup="ocultarMensaje()">Solucion</button>
    ...
    <p>Estás intentando comprender la estructura de la fórmula</p>

    <p>\(\frac{\pi}{2} + \pi n\)</p>

    <p>y cómo verla de forma sencilla, como cuando sumamos fracciones tipo:</p>

    <p>\(\frac{1}{2} + \frac{2}{2} = \frac{3}{2}\)</p>

    <p>Vamos a descomponer eso paso a paso y hacerlo muy claro.</p>

    <h3>🎯 ¿Qué es \(\frac{\pi}{2} + \pi n\)?</h3>

    <p>Primero, recordemos que:</p>

    <p>\(\pi = \frac{2\pi}{2} \Rightarrow \pi n = \frac{2\pi n}{2}\)</p>

    <p>Entonces podemos escribir:</p>

    <p>\(\frac{\pi}{2} + \pi n = \frac{\pi}{2} + \frac{2\pi n}{2}\)</p>

    <p>Y ahora como suma de fracciones con el mismo denominador:</p>

    <p>\(\frac{\pi + 2\pi n}{2} = \frac{\pi(1 + 2n)}{2}\)</p>
    </p>
