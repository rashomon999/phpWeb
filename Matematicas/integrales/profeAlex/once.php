...
if ($_POST) {
   ...
   if ($respuesta_1 === '-Cosx+\frac{2}{3}Cos^3x-\frac{1}{5}Cos^5x+C') {  
   ...
   if ($respuesta_2 === 'Senx-\frac{2}{3}Sen^3x+\frac{1}{5}Sen^5x+C') {  
   ...
   if ($respuesta_4 === '-\frac{1}{2}Cot^2x+C'
   || $respuesta_4 === '-\frac{1}{2}\frac{1}{Tan^2x}+C'
   ) {  
   ...
   if ($respuesta_5 === '-Ln|Cotx|+C'  
   || $respuesta_5 === 'Ln|Tanx|+C') {  
   ...
   if ($respuesta_7 === 'Ln|Sec(x)+Tan(x)|+C'
   || $respuesta_7 === 'Ln|Secx+Tanx|+C'
   ) {  
   ...
   if ($respuesta_8 === '\frac{1}{3}Sen^3x+C') {  
   ...
   if ($respuesta_10 === 'Ln|Secx+Tanx|-Senx+C') {  
   ...
   if ($respuesta_11 === 'Ln|Tanx|+C'
   || $respuesta_11 === 'Ln|Secx|+Ln|Senx|+C' 
    || $respuesta_11 === 'Ln|Senx|-Ln|Cosx|+C'
   ) {  
    ...
    if ($respuesta_12 === 'Ln|Secx+Tanx|-Senx+C') {  
...
<br><br>
    ...
    Cuando es impar, al escribir la expresion original como dos producto una expresion va a ser con exponente 1
    y la otra ahora va a ser exponente par, como ahora el exponente es par podemos usar la formula de reduccion de
    potencias.
    </p>
    </div>
    ...
    <img id="imagenMostrada" src="../../../img/solucion_sen_5.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada2" src="../../../img/integral_seno_5.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada3" src="../../../img/integral_seno_5_2.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada4" src="../../../img/integral_cose_final.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada5" src="../../../img/tan_seca.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada6" src="../../../img/guia.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada7" src="../../../img/guia_2.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada8" src="../../../img/guia_3.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada9" src="../../../img/guia_4.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada10" src="../../../img/guia_5.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada11" src="../../../img/guia_6.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada12" src="../../../img/guia_7.png" style="display: none; max-width: 100%" width="460">
...
<div class="seccion derecha">
    ...
    <img id="imagenMostrada13" src="../../../img/guia_8.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada14" src="../../../img/guia_9.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada15" src="../../../img/guia_10.png" style="display: none; max-width: 100%" width="460">
    ...
    <button onmousedown="mostrarImagen16()" onmouseup="ocultarImagen16()">1forma</button>
    <!-- Elemento para mostrar la imagen -->

    <img id="imagenMostrada16" src="../../../img/guia_11.png" style="display: none; max-width: 100%" width="460">
    ...
    <button onmousedown="mostrarImagen17()" onmouseup="ocultarImagen17()">2forma</button>
    <!-- Elemento para mostrar la imagen -->

    <img id="imagenMostrada17" src="../../../img/guia_12.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada18" src="../../../img/guia_13.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada19" src="../../../img/guia_14.png" style="display: none; max-width: 100%" width="460">
    ...
    <!-- Elemento para mostrar la imagen -->
    <img id="imagenMostrada20" src="../../../img/guia_15.png" style="display: none; max-width: 100%" width="460">
