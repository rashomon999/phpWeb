...
if ($_POST) {
   ...
   if ($respuesta_1 === '-\frac{1}{2}\frac{1}{Sen^2x}+C'
   || $respuesta_1 === '-\frac{1}{2Sen^2x}+C'
   || $respuesta_1 === '-\frac{1}{2}Csc^2x+C' 
   ...
   if ($respuesta_2 === '\frac{1}{4Cos^4x}+C'
   || $respuesta_2 === '\frac{1}{4}\frac{1}{Cos^4x}+C'
    || $respuesta_2 === '\frac{1}{4}Sec^4x+C'
   ) {  
   ...
   if ($respuesta_3 === '-\frac{1}{2Tan^2x}+C'
   || $respuesta_3 === '-\frac{1}{2}\frac{1}{Tan^2x}+C'
   || $respuesta_3 === '-\frac{1}{2}Cot^2x+C'
   ) {  
   ...
   if ($respuesta_4 === 'Tanx-x+C'
   || $respuesta_4 === '-x+Tanx+C'
   ) {  
   ...
   if ($respuesta_5 === '-Cotx-x+C'
   || $respuesta_5 === '-x-Cotx+C'
   ) {  
   ...
   if ($respuesta_6 === '\frac{1}{2}Tan^2x-Ln|Secx|+C') {  
   ...
   if ($respuesta_7 === '-\frac{1}{2}Cot^2x-Ln|senx|+C') {  
   ...
   if ($respuesta_8 === '\frac{1}{2}SecxTanx+\frac{1}{2}Ln|Secx+Tanx|+C') {  
   ...
   if ($respuesta_9 === '-\frac{1}{2}CscxCotx+\frac{1}{2}Ln|Cscx-Cotx|+C') {  
   ...
   if ($respuesta_10 === '\frac{1}{6}Sec^6x-\frac{1}{4}Sec^4x+C'
   || $respuesta_10 === '\frac{1}{6}Tan^6x-\frac{1}{4}Tan^4x+C'
   ) {  
...
<form action="./doce.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off"> 
<div class="form-container">

    
<div class="seccion izquierda"> 
 <p style="text-align: center;">
    \(  \int \frac{Cosx}{Sen^3x} \, \, dx \) = 
    <span id="formula">
        \(   \)
    </span> 
    <br><br>
    ...
    <img id="imagenMostrada" src="../../../img/guia_16.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada2" src="../../../img/guia_17.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada3" src="../../../img/guia_18.png" style="display: none; max-width: 100%" width="460">
 ...
 <hr> 
    ...
    clave: Tan y Csc no son integrales directas.
    </p>
    </div>
    <hr> 
    ...
    <img id="imagenMostrada4" src="../../../img/guia_19.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada5" src="../../../img/guia_20.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada6" src="../../../img/guia_21.png" style="display: none; max-width: 100%" width="460">
...
<div class="seccion derecha">
    ...
    <img id="imagenMostrada7" src="../../../img/guia_22.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada8" src="../../../img/guia_23.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada9" src="../../../img/guia24.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada10" src="../../../img/guia_24.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada11" src="../../../img/guia_25.png" style="display: none; max-width: 100%" width="460">
...
<div class="centered-container">
    <a
        ...
        href="./fracciones_parciales/index.php"
        role="button"
        width="50px"
        height="50px"
    >Siguiente</a>
