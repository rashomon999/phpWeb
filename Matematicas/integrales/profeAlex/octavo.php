...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
        ...
        $respuesta_1 = '\frac{1}{2}xe^{2x}-\frac{1}{4}e^{2x}+C';
        $respuesta_2 = '3xe^x-3e^x+C';
        $respuesta_3 = 'xSenx+Cosx+C';
        $respuesta_4 = '-2xCosx+2Senx+C';
        $respuesta_5 = 'xLnx-x+C';
        $respuesta_6 = 'xLn(2x)-x+C';
        $respuesta_7 = '\frac{1}{3}x^3Ln|x|-\frac{1}{9}x^3+C';
        $respuesta_8 = '\frac{1}{2}x^4Ln|x^2|-\frac{1}{4}x^4+C';
        $respuesta_9 = 'x^2e^x-2xe^x+2e^x+C';
        $respuesta_10 = '\frac{1}{2}x^3e^{2x}-\frac{3}{4}x^2e^{2x}+\frac{3}{4}xe^{2x}-\frac{3}{8}e^{2x}+C';
        $respuesta_11 = 'x^2Senx+2xCosx-2Senx+C';
        $respuesta_12 = '-\frac{1}{2}x^3Cos(2x)+\frac{3}{4}x^2Sen(2x)+\frac{3}{4}xCos(2x)-\frac{3}{8}Sen2x+C';
        $respuesta_13 = '\frac{e^x}{2}(Senx-Cosx)+C';
        $respuesta_14 = '\frac{e^x}{10}(Cos(3x)+3Sen(3x))+C';
   ...
   if ($respuesta_1 === '\frac{1}{2}xe^{2x}-\frac{1}{4}e^{2x}+C') {  
   ...
   if ($respuesta_7 === '\frac{1}{3}x^3Ln|x|-\frac{1}{9}x^3+C'
   || $respuesta_7 === '\frac{x^3Ln|x|}{3}-\frac{x^3}{9}+C'
   ) {   
   ...
   if ($respuesta_8 === '\frac{1}{2}x^4Ln|x^2|-\frac{1}{4}x^4+C') {  
   ...
   if ($respuesta_9 === 'x^2e^x-2xe^x+2e^x+C') {  
   ...
   if ($respuesta_10 === '\frac{1}{2}x^3e^{2x}-\frac{3}{4}x^2e^{2x}+\frac{3}{4}xe^{2x}-\frac{3}{8}e^{2x}+C') {  
   ...
   if ($respuesta_11 === 'x^2Senx+2xCosx-2Senx+C') {  
    ...
    if ($respuesta_12 === '-\frac{1}{2}x^3Cos(2x)+\frac{3}{4}x^2Sen(2x)+\frac{3}{4}xCos(2x)-\frac{3}{8}Sen2x+C') {  
    ...
    if ($respuesta_13 === '\frac{e^x}{2}(Senx-Cosx)+C') { 
    ...
    if ($respuesta_14 === '\frac{e^x}{10}(Cos(3x)+3Sen(3x))+C') {  
...
<div class="seccion izquierda"> 
  ...
  <p style="text-align: center;">
    ...
    <img id="imagenMostrada" src="../../../img/solucion_partes.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada2" src="../../../img/por_partes.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada3" src="../../../img/explicacion_inte.png" style="display: none; max-width: 100%" >
    ...
    <img id="imagenMostrada4" src="../../../img/logaritmo_natural.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada5" src="../../../img/nivel.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada6" src="../../../img/nivel_dos.png" style="display: none; max-width: 100%" width="460">
...
<div class="seccion derecha">
   <p style="text-align: center;">
    ...
    <img id="imagenMostrada7" src="../../../img/cuarenta_siete.png" style="display: none; max-width: 100%" width="460">
    ...
    <?php echo $verificar_9 ?>  
     ...
     <button onmousedown="mostrarImagen8()" onmouseup="ocultarImagen8()">Ayuda1</button>
    <!-- Elemento para mostrar la imagen -->

    <img id="imagenMostrada8" src="../../../img/primera_solucion.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada9" src="../../../img/tabulado.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada10" src="../../../img/solucion_partes_dos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada11" src="../../../img/solucion_c.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada12" src="../../../img/tabulado_dos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada13" src="../../../img/por_partes_dos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada14" src="../../../img/dos_dos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada15" src="../../../img/ultimo_partes.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada16" src="../../../img/aprietos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada17" src="../../../img/final_partes.png" style="display: none; max-width: 100%" width="460">
