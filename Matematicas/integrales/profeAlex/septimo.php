...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
        ...
        $respuesta_1 = '\frac{1}{5}Ln|Sen(5t)|+C';
        $respuesta_2 = '\frac{(Senx)^3}{3}+C';
        $respuesta_3 = '-\frac{Cos^4t}{4}+C';
        $respuesta_4 = '\frac{1}{2Cos^2x}+C';
        $respuesta_5 = '-\frac{1}{Sent}+C';
        $respuesta_6 = '\frac{-1}{2Sen^2x}+C';
        $respuesta_7 = '\frac{1}{2}Ln|Sen2x|+C';
        $respuesta_8 = '-2Ln|Cosx|+C';
        $respuesta_9 = 'integrando';
        $respuesta_10 = 'formado';
        $respuesta_11 = 'producto';
        $respuesta_12 = 'division';
        $respuesta_13 = 'escribir';
        $respuesta_14 = 'udv=uv-\int vdu';
        $respuesta_15 = 'ILATE';
        $respuesta_16 = 'u';
        $respuesta_17 = 'dv';
        ...
        $verificar_16 = $verificar_17 = "correcto";
    } else {
    $respuesta_1 = isset($_POST['respuesta_1']) ? $_POST['respuesta_1'] : '';
   if ($respuesta_1 === '\frac{1}{5}Ln|Sen(5t)|+C') {  
   ...
   if ($respuesta_2 === '\frac{(Senx)^3}{3}+C'
   || $respuesta_2 === '\frac{Sen^3x}{3}+C'
   ) {  
   ...
   if ($respuesta_3 === '-\frac{Cos^4t}{4}+C'
   || $respuesta_3 === '-\frac{1}{4}Cos^4t+C'
   ) {  
   ...
   if ($respuesta_4 === '\frac{1}{2Cos^2x}+C') {  
   ...
   if ($respuesta_6 === '\frac{-1}{2Sen^2x}+C'
   || $respuesta_6 === '-\frac{1}{2Sen^2x}+C'
   || $respuesta_6 === '-\frac{1}{2(Senx)^2}+C'
   ) {  
   ...
   if ($respuesta_7 === '\frac{1}{2}Ln|Sen2x|+C'
   ||  $respuesta_7 === '\frac{1}{2}Ln|Sen(2x)|+C'
   ) {  
   ...
   if ($respuesta_8 === '-2Ln|Cosx|+C'
   || $respuesta_8 === '-2Ln|Cos(x)|+C'
   ) {  
...
<div class="seccion izquierda"> 
   <p style="text-align: center;">
    ...
    <img id="imagenMostrada" src="../../../img/integral_video.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada2" src="../../../img/video_2.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada3" src="../../../img/cancelan.png" style="display: none; max-width: 100%" width="460">
    ...
    se cancelan los signos negativos.
    </p>
    </div>
    ...
    <img id="imagenMostrada4" src="../../../img/elevado.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada5" src="../../../img/elevado_dos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada6" src="../../../img/elevado_tres.png" style="display: none; max-width: 100%" width="460">
...
<div class="seccion derecha">
    ...
    <img id="imagenMostrada7" src="../../../img/final_uno.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada8" src="../../../img/resolver.png" style="display: none; max-width: 100%" width="460">
   ...
   <p style="text-align: center;">
    ...
    <img id="imagenMostrada9" src="../../../img/sen_cos.png" style="display: none; max-width: 100%" width="460">
    ...
    <br><br>
    <input type="text" name="respuesta_14"   id="respuesta_14" oninput="actualizarFormula9()" 
    value="<?php echo $respuesta_14?>" size="25" >
    </p>


    <h3>¿Cómo elegir <em>u</em> y <em>dv</em>?</h3>
    <p>Se usa 
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="8">    
    :</p>

    <p><strong>Se elige</strong>
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="8">
    como la función que aparece primero en ILATE; lo otro es
