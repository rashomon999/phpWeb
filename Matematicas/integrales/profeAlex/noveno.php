...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
        // Establecer todas las respuestas correctas (usando la primera variante cuando hay múltiples opciones)
        $respuesta_1 = '\frac{1}{6}Sen(3x^2)+C';
        $respuesta_2 = '\frac{1}{2}Tan(2x)+C';
        $respuesta_3 = '\frac{1}{4}Sec(4x)+C';
        $respuesta_4 = '\frac{1}{6}Sen(6x)+C';
        $respuesta_5 = '-2Cos(\frac{x}{2})+C';
        $respuesta_6 = '-\frac{2}{3}Cos(x^3)+C';
        $respuesta_7 = '\frac{2}{3}Sen(\frac{3x}{2})+C';
        $respuesta_8 = '-\frac{1}{5}Cos(5t)+C';
        $respuesta_9 = '-\frac{3}{4}Cos(2x^2)+C';
        $respuesta_10 = '-Ln|Cosx|+C';
        $respuesta_11 = 'Ln|Sen(x)|+C';
        $respuesta_12 = '-\frac{1}{3}Ln|Cos(3x)|+C';
        $respuesta_13 = '\frac{5}{2}Ln|Sen(\frac{2x}{5})|+C';
        $respuesta_14 = 'Ln|Secx+Tanx|+C';
   ...
   if ($respuesta_1 === '\frac{1}{6}Sen(3x^2)+C') {  
   ...
   if ($respuesta_2 === '\frac{1}{2}Tan(2x)+C') {  
   ...
   if ($respuesta_3 === '\frac{1}{4}Sec(4x)+C') {  
   ...
   if ($respuesta_4 === '\frac{1}{6}Sen(6x)+C') {  
   ...
   if ($respuesta_5 === '-2Cos(\frac{x}{2})+C') {  
   ...
   if ($respuesta_6 === '-\frac{2}{3}Cos(x^3)+C') {  
   ...
   if ($respuesta_7 === '\frac{2}{3}Sen(\frac{3x}{2})+C') {  
   ...
   if ($respuesta_8 === '-\frac{1}{5}Cos(5t)+C') {  
   ...
   if ($respuesta_9 === '-\frac{3}{4}Cos(2x^2)+C') {  
   ...
   if ($respuesta_10 === '-Ln|Cosx|+C'
   || $respuesta_10 === 'Ln|Secx|+C'
   ) {  
   ...
   if ($respuesta_11 === 'Ln|Sen(x)|+C') {  
    ...
    if ($respuesta_12 === '-\frac{1}{3}Ln|Cos(3x)|+C'
    || $respuesta_12 === '\frac{1}{3}Ln|Sec(3x)|+C'
    ) {  
    ...
    if ($respuesta_13 === '\frac{5}{2}Ln|Sen(\frac{2x}{5})|+C') { 
    ...
    if ($respuesta_14 === 'Ln|Secx+Tanx|+C') {  
