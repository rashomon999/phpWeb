...
if ($_POST) {
   ...
   if ($respuesta_1 === '\frac{1}{2}Ln|Sec(2x)+Tan(2x)|+C') {  
   ...
   if ($respuesta_2 === '3Ln|Sec(\frac{x}{3})+Tan(\frac{x}{3})|+C') {  
   ...
   if ($respuesta_3 === 'Ln|Cscx-Cotx|+C'
   || $respuesta_3 === 'Ln|Csc(x)-Cot(x)|+C'
   ) {  
   ...
   if ($respuesta_4 === '\frac{1}{4}Ln|Csc(4t)-Cot(4t)|+C') {  
   ...
   if ($respuesta_5 === '2Ln|Csc(\frac{3x}{2})-Cot(\frac{3x}{2})|+C') {  
   ...
   if ($respuesta_6 === '\frac{Sen^2(x)}{2}+C'
   || $respuesta_6 === '\frac{1}{2}Sen^2(x)+C'
   ) {  
   ...
   if ($respuesta_7 === '\frac{Sen^5(x)}{5}+C'
   || $respuesta_7 === '\frac{1}{5}Sen^5(x)+C'
   ) {  
   ...
   if ($respuesta_8 === '-\frac{Cos^4x}{4}+C') {  
   ...
   if ($respuesta_9 === '\frac{1}{2}Tan^2x+C'
   || $respuesta_9 === '\frac{Tan^2x}{2}+C'
   || $respuesta_9 === '\frac{Tan^2(x)}{2}+C'
   ) {  
   ...
   if ($respuesta_10 === '\frac{1}{2}x-\frac{1}{4}Sen(2x)+C') {  
   ...
   if ($respuesta_11 === '\frac{1}{2}x+\frac{1}{4}Sen(2x)+C') {  
    ...
    if ($respuesta_12 === '-Cosx+\frac{1}{3}Cos^3x+C') {  
    ...
    if ($respuesta_13 === 'Senx-\frac{1}{3}Sen^3x+C') { 
    ...
    if ($respuesta_14 === '\frac{1}{3}Tan^3x-Tanx-x+C') {  
    ...
    if ($respuesta_15 === '-\frac{1}{3}Cot^3x+Cotx+x+C') { 
...
<div class="seccion derecha">
    ...
    En este caso no se deriva el que tiene exponenete porque es la derivada exacta de Tan.
    </div>
    ...
    <img id="imagenMostrada" src="../../../img/clave_elevado.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada2" src="../../../img/secante_tangente.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada3" src="../../../img/tangente_secante.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada4" src="../../../img/secante_dos.png" style="display: none; max-width: 100%" width="460">
   ...
   <button onmousedown="mostrarImagen5()" onmouseup="ocultarImagen5()">Ayuda</button>
    ...
    <img id="imagenMostrada5" src="../../../img/secante_tres.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada6" src="../../../img/cotangente.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada7" src="../../../img/cotangente_dos.png" style="display: none; max-width: 100%" width="460">
