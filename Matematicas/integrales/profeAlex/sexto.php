...
if ($_POST) {
   ...
   if ($respuesta_2 === '-\frac{1}{3}Cos(3x)+C' || $respuesta_2 === '\frac{-1}{3}Cos(3x)+C') {  
   ...
   if ($respuesta_3 === '-\frac{1}{4}Cos(4x-5)dx') {  
   ...
   if ($respuesta_4 === '-\frac{1}{4}Cos(2x^2-5)+C') {  
...
<div class="seccion izquierda">
    ...
    <img id="imagenMostrada" src="../../../img/trigonometricas.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada2" src="../../../img/trigonometricas_dos.png" style="display: none; max-width: 100%" width="460">
    ...
    <img id="imagenMostrada3" src="../../../img/trigonometricas_tres.png" style="display: none; max-width: 100%" width="460">
