...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
        // Establecer todas las respuestas correctas (incluyendo múltiples formatos válidos)
        $respuesta_1 = 'Ln|x|+C';
        $respuesta_2 = '3Ln|u|+C';
        $respuesta_3 = '\frac{5}{4}Ln|x|+C';
        $respuesta_4 = 'Ln|x|+C';
        $respuesta_5 = '\frac{\sqrt{3}}{2}Ln|x|+C';
        $respuesta_6 = '\frac{2x^{\frac{3}{2}}}{3}+C'; // También acepta '\frac{2\sqrt{x^3}}{3}+C' y '\frac{2}{3}\sqrt{x^3}+C'
        $respuesta_7 = '\frac{3}{5}\sqrt[3]{x^5}+C'; // También acepta '\frac{3x^{5/3}}{5}+C'
        $respuesta_8 = '\frac{2\sqrt{3x^3}}{3}+C';
        $respuesta_9 = '\frac{8}{3}x\sqrt{x}+C'; // También acepta '\frac{8}{3}\sqrt{x^3}+C'
        $respuesta_10 = '10\sqrt{x}+C';
        $respuesta_11 = '\frac{-4}{\sqrt{x}}+C';
        $respuesta_12 = '\frac{x^4}{2}+\frac{5x^3}{3}-x^2+x+C';
        $respuesta_13 = '\frac{x^6}{6}-\frac{x^4}{2}+C';
        $respuesta_14 = '\frac{3x^5}{5}-x^4+2x^3-\frac{x^2}{4}+3x+C';
        $respuesta_15 = '\frac{x^4}{2}-\frac{4x^3}{3}+\frac{x^2}{2}+C';
        $respuesta_16 = '\frac{4x^3}{9}-\frac{2x}{3}+C';
        $respuesta_17 = '\frac{5x^2}{4}-\frac{3x}{2}-\frac{1}{x}+C';
        $respuesta_18 = '\frac{5x}{4}+\frac{1}{2x}-\frac{1}{4x^2}+C';

        // Marcar todas como correctas
        $verificar_1 = $verificar_2 = $verificar_3 = $verificar_4 = $verificar_5 = 
        $verificar_6 = $verificar_7 = $verificar_8 = $verificar_9 = $verificar_10 = 
        $verificar_11 = $verificar_12 = $verificar_13 = $verificar_14 = $verificar_15 = 
        $verificar_16 = $verificar_17 = $verificar_18 = "correcto";
    } else {
   ...
   if ($respuesta_3 === '\frac{5}{4}Ln|x|+C') {  
   ...
   if ($respuesta_6 === '\frac{2x^{\frac{3}{2}}}{3}+C' || $respuesta_6 === '\frac{2\sqrt{x^3}}{3}+C'
   || $respuesta_6 === '\frac{2}{3}\sqrt{x^3}+C'
   ) {  
   ...
   if ($respuesta_7 === '\frac{3}{5}\sqrt[3]{x^5}+C' || $respuesta_7 === '\frac{3x^{5/3}}{5}+C') {  
   ...
   if ($respuesta_8 === '\frac{2\sqrt{3x^3}}{3}+C') {  
   ...
   if ($respuesta_9 === '\frac{8}{3}x\sqrt{x}+C' 
   || $respuesta_9 === '\frac{8}{3}\sqrt{x^3}+C'
   ||  $respuesta_9 === '\frac{8x^{\frac{3}{2}}}{3}+C' 
   ||  $respuesta_9 === '\frac{8\sqrt{x^3}}{3}+C' 
   ...
   if ($respuesta_11 === '\frac{-4}{\sqrt{x}}+C'
   || $respuesta_11 === '\frac{-4}{x^\frac{1}{2}}+C'
   ) {  
     ...
     if ($respuesta_13 === '\frac{x^6}{6}-\frac{x^4}{2}+C') { 
     ...
     if ($respuesta_14 === '\frac{3x^5}{5}-x^4+2x^3-\frac{x^2}{4}+3x+C') {  
     ...
     if ($respuesta_15 === '\frac{x^4}{2}-\frac{4x^3}{3}+\frac{x^2}{2}+C') { 
     ...
     if ($respuesta_16 === '\frac{4x^3}{9}-\frac{2x}{3}+C') {  
     ...
     if ($respuesta_18 === '\frac{5x}{4}+\frac{1}{2x}-\frac{1}{4x^2}+C') {  
...
<div class="seccion izquierda">
        <strong>se recomienda expresar en raiz y en una sola</strong>
    <br><br>
...
<div class="seccion derecha">
    ...
    value="<?php echo $respuesta_12?>" size="35" >
    </p>
    ...
    value="<?php echo $respuesta_13?>" size="35" >
    </p>
