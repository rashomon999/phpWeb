...
<p>(b) ¿Es una combinación lineal de los vectores \( \begin{bmatrix} 1 \\ 0 \\ 3 \end{bmatrix} \) y \( \begin{bmatrix} -1 \\ 1 \\ -3 \end{bmatrix} \)?</p>

<h4>Solución</h4>
<p>(a) Se quiere encontrar escalares \( x \) y \( y \) tales que</p>
<p>\[x \begin{bmatrix} 1 \\ 0 \\ 3 \end{bmatrix} + y \begin{bmatrix} -1 \\ 1 \\ -3 \end{bmatrix} = \begin{bmatrix} 1 \\ 2 \\ 3 \end{bmatrix}\]</p>

<p>Al desarrollar, se obtiene el sistema</p>
<p>\[x - y = 1\]</p>
<p>\[y = 2\]</p>
<p>\[3x - 3y = 3\]</p>
...
<p>Revise nuevamente el ejemplo 2.4 e interpretelo a la luz del Teorema 2.4.</p>
...
<p>\[2 \begin{bmatrix} 1 \\ 1 \end{bmatrix} + 1 \begin{bmatrix} -1 \\ 1 \end{bmatrix} = \begin{bmatrix} 1 \\ 3 \end{bmatrix}\]</p>
...
<p>\[(2 + t) \begin{bmatrix} 1 \\ 2 \end{bmatrix} + t \begin{bmatrix} -1 \\ -2 \end{bmatrix} = \begin{bmatrix} 2 \\ 4 \end{bmatrix}\]</p>

<p>para todos los valores de \(t\). Geométricamente, los vectores \(\begin{bmatrix} 1 \\ 2 \end{bmatrix}, \begin{bmatrix} -1 \\ -2 \end{bmatrix}, y \begin{bmatrix} 2 \\ 4 \end{bmatrix}\) son todos paralelos y por tanto todos yacen a lo largo de la misma recta que pasa por el origen [vea la figura 2.8(b)].</p>

<img src="../../../img/guia_220.png" alt="" width="600">
...
<p>\[x \begin{bmatrix} 1 \\ 1 \end{bmatrix} + y \begin{bmatrix} -1 \\ -1 \end{bmatrix} = \begin{bmatrix} 1 \\ 3 \end{bmatrix}\]</p>
...
<h3>Definición</h3>
<p>Si \(S = \{v_1, v_2, \ldots, v_k\}\) es un conjunto de vectores en \(\mathbb{R}^n\), entonces el conjunto de todas las combinaciones lineales de \(v_1, v_2, \ldots, v_k\) se llama el <strong>generador</strong> de \(v_1, v_2, \ldots, v_k\) y se denota mediante gen\((v_1, v_2, \ldots, v_k)\) o gen\((S)\). Si gen\((S) = \mathbb{R}^n\), entonces \(S\) se llama <strong>conjunto generador</strong> de \(\mathbb{R}^n\).</p>


    <hr>
    <strong>parentesis</strong>
    <h2>Diferencia entre independencia y dependencia</h2>

  <ul>
    <li>
      <strong>Independencia lineal:</strong><br>
      La única forma de escribir \(\mathbf{0}\) como combinación lineal de los vectores es la trivial
      (todos los coeficientes son \(0\)).
    </li>
    <li>
      <strong>Dependencia lineal:</strong><br>
      Existen coeficientes <b>no todos cero</b> tales que la combinación lineal da \(\mathbf{0}\).<br>
      Eso significa que <b>algún vector es combinación lineal de los otros</b>.
    </li>
  </ul>
    ...
    <div class="container">
        <h2>Demostración: \(\mathbb{R}^2 = \text{gen}\left(\begin{bmatrix} 2 \\ -1 \end{bmatrix}, \begin{bmatrix} 
            1 \\ 3 \end{bmatrix}\right)\)</h2>
        ...
        <div class="solucion">
            <h2>Solución <span class="check">✓</span></h2>
            <p>Necesitamos demostrar que un vector arbitrario \(\begin{bmatrix} a \\ b \end{bmatrix}\) puede escribirse como una combinación lineal de \(\begin{bmatrix} 2 \\ -1 \end{bmatrix}\) y \(\begin{bmatrix} 1 \\ 3 \end{bmatrix}\); esto es, debemos demostrar que la ecuación</p>
            
            <p>\[ x \begin{bmatrix} 2 \\ -1 \end{bmatrix} + y \begin{bmatrix} 1 \\ 3 \end{bmatrix} = \begin{bmatrix} a \\ b \end{bmatrix} \]</p>
            
            <p>siempre puede resolverse para \(x\) y \(y\) (en términos de \(a\) y \(b\)), sin importar los valores de \(a\) y \(b\).</p>
            
            <div class="paso">
                <p>La matriz aumentada es:</p>
                <p>\[ \left[ \begin{array}{cc|c} 2 & 1 & a \\ -1 & 3 & b \end{array} \right] \]</p>
            </div>
            
            <div class="paso">
                <p>Realizamos reducción por renglones:</p>
                <p>\[ \left[ \begin{array}{cc|c} 2 & 1 & a \\ -1 & 3 & b \end{array} \right] \xrightarrow{R_1 \leftrightarrow R_2} \left[ \begin{array}{cc|c} -1 & 3 & b \\ 2 & 1 & a \end{array} \right] \]</p>
            </div>
...
<div class="seccion derecha">
    ...
    <div class="paso">
                <p>\[ \xrightarrow{R_2 + 2R_1} \left[ \begin{array}{cc|c} -1 & 3 & b \\ 0 & 7 & a + 2b \end{array} \right] \]</p>
                <p>En este punto es claro que el sistema tiene una solución única (¿Por qué?).</p>
            </div>
            
            <div class="paso">
                <p>Si continuamos, obtenemos:</p>
                <p>\[ \xrightarrow{\frac{1}{7}R_2} \left[ \begin{array}{cc|c} -1 & 3 & b \\ 0 & 1 & \frac{a + 2b}{7} \end{array} \right] \]</p>
            </div>
            
            <div class="paso">
                <p>\[ \xrightarrow{R_1 - 3R_2} \left[ \begin{array}{cc|c} -1 & 0 & b - 3\left(\frac{a + 2b}{7}\right) \\ 0 & 1 & \frac{a + 2b}{7} \end{array} \right] = \left[ \begin{array}{cc|c} -1 & 0 & \frac{7b - 3a - 6b}{7} \\ 0 & 1 & \frac{a + 2b}{7} \end{array} \right] = \left[ \begin{array}{cc|c} -1 & 0 & \frac{b - 3a}{7} \\ 0 & 1 & \frac{a + 2b}{7} \end{array} \right] \]</p>
            </div>
            
            <div class="paso">
                <p>\[ \xrightarrow{-R_1} \left[ \begin{array}{cc|c} 1 & 0 & \frac{3a - b}{7} \\ 0 & 1 & \frac{a + 2b}{7} \end{array} \right] \]</p>
            </div>
            
            <p>De donde se ve que \(x = \frac{3a - b}{7}\) y \(y = \frac{a + 2b}{7}\).</p>
            
            <div class="conclusion">
                <p>Por tanto, para cualquier elección de \(a\) y \(b\), se tiene:</p>
                <p>\[ \left( \frac{3a - b}{7} \right) \begin{bmatrix} 2 \\ -1 \end{bmatrix} + \left( \frac{a + 2b}{7} \right) \begin{bmatrix} 1 \\ 3 \end{bmatrix} = \begin{bmatrix} a \\ b \end{bmatrix} \]</p>
                <p>(Compruebe esto.)</p>
            </div>
            
  <div class="comentario">
            <h2>Comentario</h2>
            <p>También es cierto que \(\mathbb{R}^2 = \text{gen} \left( \begin{bmatrix} 2 \\ -1 \end{bmatrix}, \begin{bmatrix} 1 \\ 3 \end{bmatrix}, \begin{bmatrix} 5 \\ 7 \end{bmatrix} \right)\): si, dado \(\begin{bmatrix} a \\ b \end{bmatrix}\), podemos encontrar \(x\) y \(y\) tales que \(x \begin{bmatrix} 2 \\ -1 \end{bmatrix} + y \begin{bmatrix} 1 \\ 3 \end{bmatrix} = \begin{bmatrix} a \\ b \end{bmatrix}\), entonces también se tiene:</p>
            
            <p>\[ x \begin{bmatrix} 2 \\ -1 \end{bmatrix} + y \begin{bmatrix} 1 \\ 3 \end{bmatrix} + 0 \begin{bmatrix} 5 \\ 7 \end{bmatrix} = \begin{bmatrix} a \\ b \end{bmatrix} \]</p>
