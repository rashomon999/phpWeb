...
<div class="seccion izquierda">
    ...
    <h4>1.4 Uso Periódico de Energía</h4>
    <p>El vector de dimensión 168, \( w \), representa el consumo horario de electricidad de una planta manufacturera, comenzando el domingo a la medianoche hasta la 1 AM, durante una semana, en MWh (megavatios-hora).</p>
    <p>El patrón de consumo es el mismo cada día, es decir, es <strong>24-periódico</strong>, lo que significa que:</p>
    <p>
        \[ w_{t+24} = w_t \quad \text{para } t = 1, \dots, 144. \]
    </p>
    <p>Sea \( d \) un vector de dimensión 24 que representa el consumo de energía durante un solo día, comenzando a la medianoche.</p>
    
    <h4>Preguntas:</h4>
    <ol>
        <li>
            <p>Usa notación vectorial para expresar \( w \) en términos de \( d \).</p>
        </li>
        <li>
            <p>Usa notación vectorial para expresar \( d \) en términos de \( w \).</p>
        </li>
    </ol>
    <hr>
    <strong>analisis del problema: </strong>
    <h4>¿Qué representa \( w_1 \)?</h4>
    <p>\( w_1 \) es el consumo de la primera hora de la semana, es decir, desde el domingo a medianoche hasta la 1 AM del domingo.</p>

    <h4>¿Por qué \( w_t = w_{t+24} \) para \( t = 1,2,\dots,144 \)?</h4>
    <p>Esta ecuación significa que el consumo se repite cada 24 horas, es decir, cada día es igual.</p>
    <ul>
        <li>\( w_1 \) (domingo 12 AM - 1 AM) es igual a \( w_{25} \) (lunes 12 AM - 1 AM).</li>
        <li>\( w_2 \) (domingo 1 AM - 2 AM) es igual a \( w_{26} \) (lunes 1 AM - 2 AM).</li>
    </ul>
    <p>Y así sucesivamente...</p>
    <p>La ecuación solo dice que el consumo a la misma hora cada día es idéntico.</p>

    <h4>¿Y qué significa \( w_{t+24} \)?</h4>
    <p>Es el consumo de la misma hora, pero al día siguiente.</p>


    <h4>Ejemplo:</h4>
    <ul>
        <li>Si \( t = 1 \), entonces \( w_1 = w_{25} \) \( \Rightarrow \) (Domingo 12AM - 1AM = Lunes 12AM - 1AM).</li>
        <li>Si \( t = 2 \), entonces \( w_2 = w_{26} \) \( \Rightarrow \) (Domingo 1AM - 2AM = Lunes 1AM - 2AM).</li>
    </ul>
    
    <p>Entonces, \( w_1 \) no es el consumo pasado 24 horas, sino el consumo de la primera hora de la semana, y \( w_{t+24} \) es el consumo de la misma hora pero al día siguiente.</p>
    una semana tiene 168, por eso t llega hasta 144. de esta manera la ecuacion es correcta.

    <hr>
    <h2>(a) Expresión de \( w \) en términos de \( d \)</h2>
    <p>Queremos escribir el vector semanal \( w \) en términos de un vector diario \( d \), que representa el consumo en un solo día.</p>
    <p>Ya que sabemos que el consumo diario se repite 7 veces durante la semana, podemos escribir:</p>
    <p>\[ w = (d, d, d, d, d, d, d) \]</p>
    <p>Esto simplemente significa que el vector semanal es la concatenación de 7 veces el vector diario.</p>
    <p>Si escribimos esto de manera expandida, se vería así:</p>
    <p>\[ w = (w_1, w_2, \dots, w_{24}, w_{25}, w_{26}, \dots, w_{48}, \dots, w_{145}, \dots, w_{168}) \]</p>
    <p>Como cada conjunto de 24 valores es idéntico, podemos representar cada bloque con \( d \), y la concatenación de estos bloques da el vector \( w \).</p>
    
    <h2>(b) Expresión de \( d \) en términos de \( w \)</h2>
    <p>Aquí queremos extraer un solo día del vector \( w \), ya que cualquier día es igual a otro.</p>
    <p>Una forma natural de hacerlo es tomar los primeros 24 valores:</p>
    <p>\[ d = w_{1:24} \]</p>
    <p>Esto significa que \( d \) está formado por los primeros 24 elementos de \( w \), es decir, el consumo horario del domingo de 12:00 AM a 11:59 PM.</p>
    <p>Pero como cualquier día es igual, también podríamos haber definido \( d \) de otra manera, como:</p>
    <p>\[ d = w_{25:48} \]</p>
    <p>Esto tomaría el consumo de lunes de 12:00 AM a 11:59 PM, lo cual también es válido.</p>
