...
<div class="seccion izquierda">
    <form action="./index.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
        <strong>ejercicios_1.2</strong>
        <h1>Producto Punto entre Vectores</h1>
    <p>El producto punto entre dos vectores \( u = (u_1, u_2, ..., u_n) \) y \( v = (v_1, v_2, ..., v_n) \) se calcula con la fórmula:</p>
    <p>\[ u \cdot v = u_1 v_1 + u_2 v_2 + \dots + u_n v_n \]</p>
    
    <h2>Ejercicio 1</h2>
    <p>\( u = [-1, 2] \), \( v = [3, 1] \)</p>
    <p>\[ u \cdot v = (-1)(3) + (2)(1) = -3 + 2 = -1 \]</p>
    
    <h2>Ejercicio 2</h2>
    <p>\( u = [2, -3] \), \( v = [9, 6] \)</p>
    <p>\[ u \cdot v = (2)(9) + (-3)(6) = 18 - 18 = 0 \]</p>
    
    <h2>Ejercicio 3</h2>
    <p>\( u = [1, 2, 3] \), \( v = [2, 3, 1] \)</p>
    <p>\[ u \cdot v = (1)(2) + (2)(3) + (3)(1) = 2 + 6 + 3 = 11 \]</p>
    
    <h2>Ejercicio 4</h2>
    <p>\( u = [1.5, 0.4, -2.1] \), \( v = [3.0, 5.2, -0.6] \)</p>
    <p>\[ u \cdot v = (1.5)(3.0) + (0.4)(5.2) + (-2.1)(-0.6) \]</p>
    <p>\[ = 4.5 + 2.08 + 1.26 = 7.84 \]</p>
    
    <h2>Ejercicio 5</h2>
    <p>\( u = [1, \sqrt{2}, \sqrt{3}, 0] \), \( v = [4, -\sqrt{2}, 0, -5] \)</p>
    <p>\[ u \cdot v = (1)(4) + (\sqrt{2})(-\sqrt{2}) + (\sqrt{3})(0) + (0)(-5) \]</p>
    <p>\[ = 4 - 2 + 0 + 0 = 2 \]</p>
    
    <h2>Ejercicio 6</h2>
    <p>\( u = [1.12, -3.25, 2.07, -1.83] \), \( v = [-2.29, 1.72, 4.33, -1.54] \)</p>
    <p>\[ u \cdot v = (1.12)(-2.29) + (-3.25)(1.72) + (2.07)(4.33) + (-1.83)(-1.54) \]</p>
    <p>\[ = -2.5648 - 5.59 + 8.9631 + 2.8182 = 3.6265 \]</p>  
    
    <hr>
    <h1>Soluciones para los ejercicios 7-12</h1>
    
    <div class="exercise">
        <h2>Ejercicio 7</h2>
        <p>Para el vector \( u \) del Ejercicio 1:</p>
        <p>\[ u = \begin{bmatrix} -1 \\ 2 \end{bmatrix} \]</p>
        
        <div class="solution">
            <p><strong>Norma \( \|u\| \):</strong></p>
            <p>\[ \|u\| = \sqrt{(-1)^2 + 2^2} = \sqrt{1 + 4} = \sqrt{5} \]</p>
            
            <p><strong>Vector unitario \( \hat{u} \):</strong></p>
            <p>\[ \hat{u} = \frac{1}{\sqrt{5}} \begin{bmatrix} -1 \\ 2 \end{bmatrix} \]</p>
        </div>
    </div>
    
    <div class="exercise">
        <h2>Ejercicio 8</h2>
        <p>Para el vector \( u \) del Ejercicio 2:</p>
        <p>\[ u = \begin{bmatrix} 2 \\ -3 \end{bmatrix} \]</p>
        
        <div class="solution">
            <p><strong>Norma \( \|u\| \):</strong></p>
            <p>\[ \|u\| = \sqrt{2^2 + (-3)^2} = \sqrt{4 + 9} = \sqrt{13} \]</p>
            
            <p><strong>Vector unitario \( \hat{u} \):</strong></p>
            <p>\[ \hat{u} = \frac{1}{\sqrt{13}} \begin{bmatrix} 2 \\ -3 \end{bmatrix} \]</p>
        </div>
    </div>
    
    <div class="exercise">
        <h2>Ejercicio 9</h2>
        <p>Para el vector \( u \) del Ejercicio 3:</p>
        <p>\[ u = \begin{bmatrix} 1 \\ 2 \end{bmatrix} \]</p>
    ...
    <div class="exercise">
        <h2>Ejercicio 10</h2>
        <p>Para el vector \( u \) del Ejercicio 4:</p>
        <p>\[ u = \begin{bmatrix} 1.5 \\ 0.4 \end{bmatrix} \]</p>
        
        <div class="solution">
            <p><strong>Norma \( \|u\| \):</strong></p>
            <p>\[ \|u\| = \sqrt{1.5^2 + 0.4^2} = \sqrt{2.25 + 0.16} = \sqrt{2.41} = 1.55 \]</p>
            
            <p><strong>Vector unitario \( \hat{u} \):</strong></p>
            <p>\[ \hat{u} = \frac{1}{1.55} \begin{bmatrix} 1.5 \\ 0.4 \end{bmatrix} \approx \begin{bmatrix} 0.968 \\ 0.258 \end{bmatrix} \]</p>
        </div>
    </div>
    
    <div class="exercise">
        <h2>Ejercicio 11</h2>
        <p>Para el vector \( u \) del Ejercicio 5:</p>
        <p>\[ u = [1, \sqrt{2}, \sqrt{3}, 0] \]</p>
        
        <div class="solution">
            <p><strong>Norma \( \|u\| \):</strong></p>
            <p>\[ \|u\| = \sqrt{1^2 + (\sqrt{2})^2 + (\sqrt{3})^2 + 0^2} = \sqrt{1 + 2 + 3} = \sqrt{6} \]</p>
            
            <p><strong>Vector unitario \( \hat{u} \):</strong></p>
            <p>\[ \hat{u} = \frac{1}{\sqrt{6}} [1, \sqrt{2}, \sqrt{3}, 0] \]</p>
        </div>
    </div>
    
    <div class="exercise">
        <h2>Ejercicio 12</h2>
        <p>Para el vector \( u \) del Ejercicio 6:</p>
        <p>\[ u = [1.12, -3.25, 2.07, -1.83] \]</p>
        
        <div class="solution">
            <p><strong>Norma \( \|u\| \):</strong></p>
            <p>\[ \|u\| = \sqrt{1.12^2 + (-3.25)^2 + 2.07^2 + (-1.83)^2} \approx 4.41 \]</p>
            
            <p><strong>Vector unitario \( \hat{u} \):</strong></p>
            <p>\[ \hat{u} \approx \frac{1}{4.41} [1.12, -3.25, 2.07, -1.83] \approx [0.254, -0.737, 0.469, -0.415] \]</p>
        </div>
    </div>
    <hr>
