...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
        ...
        $sexto = '2';
        $septimo = '+C';
        $octavo = '-\frac{1}{4}Cos(4x-5)+C';
        $noveno = '4';
        $decimo = 'x';
        $undecimo = '+C';
        $duodecimo = '-\frac{1}{2}Cos(3x^2-5)+C';
        $decimotercero = '3x';
        $decimocuarto = '3';
        $decimoquinto = '+C';
        $decimosexto = '-\frac{1}{4}Cos(2x^2-5)+C';
        $decimoseptimo = 'x';
        $decimooctavo = '3';
        $decimonoveno = '+C';
        $vigesimo = '\frac{1}{5}Sen(5x)+C';
        $vigesp = 'x';
        $vigesimo_segundo = '3';
        $vigesimo_tercero = '+C';
        $vigesimo_cuarto = '2Sin(\frac{x}{2})+C';
        $vigesimo_quinto = '5/3';
        $vigesimo_sexto = '3';
        $vigesimo_septimo = '+C';
        $vigesimo_octavo = '\frac{1}{6}Sen(3x^2+2)+C';
        $vigesimo_noveno = '3/2';
        $trigesimo = '3';
        $trigesimo_primero = '+C';
        $trigesimo_segundo = '\frac{2}{3}Cos(x^3+2)+C';
        $trigesimo_tercero = '2/3';
        $trigesimo_cuarto = '2';
        $trigesimo_quinto = '+C';
        $trigesimo_sexto = '-\frac{1}{3}ln[Cos(3x)]+C';
        $trigesimo_septimo = '|x|';
        $trigesimo_octavo = '+C';
        $trigesimo_noveno = '+C';
        $cuadragesimo = '\frac{1}{5}ln[Sen(5x)]+C';
