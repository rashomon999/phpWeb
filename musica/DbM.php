...
<body>
  <div class="contenedor">
    ...
    <button class="boton-triangulo" onclick="escribirTexto('GbM')"></button>
  ...
  <script>
    ...
    function verificarRespuestas() {
            ...
            if (respuesta2 === 'GbM' || respuesta2 == 'F#M') {
    ...
    <a href="AbM.php" style="width: 100px; height: 30px; margin-top:20px" class="btn btn-success" type="button" onclick="siguienteFormulario()">Siguiente</a>
    </div>
    </div>
