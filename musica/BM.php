...
<body>
  <div class="contenedor">
    ...
    <button class="boton-triangulo-tres" onclick="escribirTexto('EM')"></button>
    <button class="boton-triangulo-cuatro" onclick="escribirTexto('AM')"></button>
    <button class="boton-triangulo-cinco" onclick="escribirTexto('DM')"></button>
  ...
  <script>
    ...
    <a href="F%23M.php" style="width: 100px; height: 30px; margin-top:20px" class="btn btn-success" type="button" onclick="siguienteFormulario()">Siguiente</a>
    </div>
    </div>
