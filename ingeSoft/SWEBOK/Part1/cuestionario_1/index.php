...
if ($_POST) {
   ...
   if ($respuesta_11_dos === 'diseño de software') {  
     ...
     if ($respuesta_12_dos === 'construccion de software') {  
     ...
     if ($respuesta_13 === 'pruebas de software') { 
     ...
     if ($respuesta_14 === 'mantenimiento de software') {  
     ...
     if ($respuesta_15 === 'gestion de la configuracion del software') { 
     ...
     if ($respuesta_16 === 'gestion de la ingenieria de software') {  
     ...
     if ($respuesta_17 === 'proceso de ingenieria de software') {  
     ...
     if ($respuesta_18 === 'modelos y metodos de ingenieria de software') {  
     ...
     if ($respuesta_19 === 'calidad de software') {  
     ...
     if ($respuesta_20 === 'practica profesional de la ingenieria de software') {  
     ...
     if ($respuesta_21 === 'economia de la ingenieria de software') {  
     ...
     if ($respuesta_22 === 'fundamentos de la computacion') {  
   ...
   if ($respuesta_23 === 'fundamentos matematicos') {  
   ...
   if ($respuesta_24 === 'fundamentos de la ingenieria') {  
   ...
   if ($respuesta_27 === 'especificacion') {  
...
if ($respuesta_37 === 'requerimiento funcional') { 
...
if ($respuesta_38 === 'requerimiento no funcional') { 
...
if ($respuesta_53 === 'no funcionales') { 
...
if ($respuesta_57 === 'caracteristicas') { 
...
if ($respuesta_65 === 'mantenibilidad') { 
...
if ($respuesta_68 === 'interoperabilidad') { 
...
if ($respuesta_77 === 'cuantificables') { 
...
if ($respuesta_79 === 'cuantitativamente') { 
...
if ($respuesta_82 === 'interpretacion') { 
...
if ($respuesta_105 === 'usuarios finales') { 
...
if ($respuesta_112 === 'caracteristica') {  
...
<?php echo $verificar_8 ?>
    ...
    campos de actividad que un ingeniero de software debe comprender, dominar y aplicar profesionalmente:
    </p>
    <ul>
    <li>
    <input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>" size="40"> </li>
    <li>
    <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="40">
    </li>
    <li>
    <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="40">    
    </li>
    <li>
    <input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_21" value="<?php echo $respuesta_21; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_22" value="<?php echo $respuesta_22; ?>" size="40">       
    </li>
    <li>
    <input type="text" name="respuesta_23" value="<?php echo $respuesta_23; ?>" size="40">   
    </li>
    <li>
    <input type="text" name="respuesta_24" value="<?php echo $respuesta_24; ?>" size="40">       
    </li>
    </ul>
...
<?php echo $verificar_24 ?>
    <hr>
    <h4>1. Fundamentos de los requerimientos del Software</h4>
    <p>
    El área de conocimiento (KA) de Requisitos del Software se ocupa de la 
    ...
    impuestas a un producto software que 
    ...
    <input type="text" name="respuesta_35" value="<?php echo $respuesta_35; ?>" size="9">
        ...
        <p>
    Una propiedad esencial de todos los requerimientos de software es que puedan ser 
    <input type="text" name="respuesta_36" value="<?php echo $respuesta_36; ?>" size="9">
    , ya sea como una 
    <input type="text" name="respuesta_112" value="<?php echo $respuesta_112; ?>" size="11">     
    individual en forma de 
    <input type="text" name="respuesta_37" value="<?php echo $respuesta_37; ?>" size="20">
    , o a nivel del sistema como un 
    <input type="text" name="respuesta_38" value="<?php echo $respuesta_38; ?>" size="25">
    . 
    Puede ser difícil o costoso verificar ciertos requerimientos de software. 
    </p>
    ...
    <input type="text" name="respuesta_50" value="<?php echo $respuesta_50; ?>" size="7">    
    y de 
    ...
    (por ejemplo, “El software deberá verificar que un estudiante cumpla con todos los prerrequisitos 
    ...
    <p>
    Un requerimiento de 
        <input type="text"   value="<?php echo $respuesta_51; ?>" size="7" readonly>
    ...
    <p>
    Algunos requerimientos de software generan requerimientos de 
 ...
 <?php echo $verificar_50 ?>
  <?php echo $verificar_51 ?>
    ...
    ; por ejemplo, dar formato a un texto o modular una señal. A veces se les conoce como 
    ...
    <p>
    Los requerimientos 
    <input type="text"  value="<?php echo $respuesta_53; ?>" size="10" readonly>
    son aquellos que actúan como 
    ...
    .
    Pueden clasificarse además según si son requerimientos de 
    ...
    , sino que dependen de cómo todos los 
...
restringirá fuertemente la arquitectura del sistema.
  ...
  <input type="text"  value="<?php echo $respuesta_88; ?>" size="8" readonly> 
    ...
    , según lo definido por el Consejo Internacional de Ingeniería de
    Sistemas y Software (INCOSE) [3].
    </p>
