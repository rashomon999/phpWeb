...
$respuesta_21 = 'seguridad de software'; // nueva en V4.0
$respuesta_22 = 'practica profesional de la ingenieria de software';
$respuesta_23 = 'economia de la ingenieria de software';
$respuesta_24 = 'operaciones de ingenieria de software'; // nueva en V4.0
...
<?php echo $verificar_8 ?>
    ...
    <li>
    <input type="text" name="respuesta_25" value="<?php echo $respuesta_25; ?>" size="40">
    </li>
    <li>
    <input type="text" name="respuesta_26" value="<?php echo $respuesta_26; ?>" size="40">
    </li>
    <li>
