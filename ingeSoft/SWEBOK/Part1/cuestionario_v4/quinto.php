...
if ($_POST) {
   ...
   if ($respuesta_4 === 'Un interesado externo' || $respuesta_4 === 'un interesado externo') {  
   ...
   if ($respuesta_33 === 'actividades') {  
    ...
    if ($respuesta_37 === 'llegar a un acuerdo sobre qué software se va a construir') { 
...
<div class="seccion izquierda"> 
   ...
   <h3>1.10. Requerimiento <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="9"></h3>
    <p>
    ...
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="8">
      requerimiento desde la perspectiva de los actores generales del 
    proyecto, 
