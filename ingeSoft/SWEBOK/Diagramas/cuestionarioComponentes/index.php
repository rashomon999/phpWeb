...
if ($_POST) {
   ...
   if ($respuesta_4 === 'aspectos fisicos') {  
   ...
   if ($respuesta_5 === 'sistemas orientados a objetos') {  
   ...
   if ($respuesta_10 === 'sistemas ejecutables') {  
   ...
   if ($respuesta_11 === 'ingenieria directa') {  
    ...
    if ($respuesta_12 === 'ingenieria inversa') {  
    ...
    if ($respuesta_13 === 'diagramas de clases') { 
    ...
    if ($respuesta_17 === 'vista estatica') {  
    ...
    if ($respuesta_18 === 'implementacion') {  
    ...
    if ($respuesta_19 === 'Composite Structure Diagram') {  
    ...
    if ($respuesta_20 === 'Deployment Diagram') {  
    ...
    if ($respuesta_21 === 'Package Diagram') {  
    ...
    if ($respuesta_22 === 'Profile Diagram') {  
   ...
   if ($respuesta_24 === 'Object Diagram') {  
   ...
   if ($respuesta_25 === 'Component Diagram') { 
   ...
   if ($respuesta_26 === 'Activity Diagram') {  
   ...
   if ($respuesta_27 === 'Use Case Diagram') {  
   ...
   if ($respuesta_28 === 'State Machine Diagram') {  
   ...
   if ($respuesta_29 === 'Interaction Diagram') {  
   ...
   if ($respuesta_30 === 'Sequence Diagram') {  
   ...
   if ($respuesta_31 === 'Communication Diagram') {  
   ...
   if ($respuesta_32 === 'Interaction Overview Diagram') {  
   ...
   if ($respuesta_33 === 'Timing Diagram') {  
...
<div class="seccion izquierda"> 
    ...
    <input type="text" name="respuesta_4" value="<?php echo $respuesta_4; ?>" size="12">
      de los 
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="25">
     . 
    Se emplean para 
    ...
    <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="13">
      (forward engineering) e 
    <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="13">
      (reverse engineering).
    </p>

    <p>
    Los diagramas de componentes son esencialmente 
    ...
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="7">
      y se utilizan frecuentemente para modelar la 
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="13">
      de 
...
<div class="chart">
  ...
  <!-- ROOT -->
  <div class="root">UML Diagram Type</div>
  ...
  <div class="branches">
    ...
    <!-- STRUCTURAL -->
    <div class="branch">
      <div class="category-structural">Structural Diagrams</div>
      <div class="branch-line"></div>
      <div class="box structural">
        <div class="node">
        <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="27">    
         </div>
        <div class="node">
        ...
        <div class="node dark" style="grid-column: span 2;">
    ...
    <!-- BEHAVIORAL -->
    <div class="branch">
      <div class="category-behavioral">Behavioral Diagrams</div>
      <div class="branch-line"></div>
      <div class="behavioral-branch">
        <div class="box behavioral-top">
          <div class="node">
        ...
        <!-- Interaction sub-nodes -->
        <div class="interaction-wrapper">
          <div class="interaction-line"></div>
          <div class="box interaction" style="width:100%;">
            <div class="node interaction-node">
            <input type="text" name="respuesta_30" value="<?php echo $respuesta_30; ?>" size="17">     
             </div>
            <div class="node interaction-node">
            <input type="text" name="respuesta_31" value="<?php echo $respuesta_31; ?>" size="20">     
             </div>
            <div class="node interaction-node">
            <input type="text" name="respuesta_32" value="<?php echo $respuesta_32; ?>" size="26">     
             </div>
            <div class="node interaction-node">
 ...
 <?php echo $verificar_19 ?> 
    ...
    <h1>Ejemplo de Componentes Internos</h1>
    ...
    <p>
        ...
        y cuya implementación es reemplazable dentro de su entorno. En UML 2, un componente 
        se dibuja como un rectángulo con compartimentos opcionales apilados verticalmente.
    </p>

    <p>
        Una vista de alto nivel y abstracta de un componente en UML 2 puede modelarse como:
    </p>

    <ul>
        <li>Un rectángulo con el nombre del componente</li>
        <li>Un rectángulo con el ícono de componente</li>
        <li>Un rectángulo con el texto de estereotipo y/o su ícono</li>
    </ul>
     <img src="../../../../img/guia_353.png" alt="" width="700">
    ...
    <p>
        Los símbolos de <strong>interfaz proporcionada</strong>, representados con un círculo completo en su extremo,
        indican una interfaz que el componente ofrece. Este símbolo de “piruleta” (lollipop) es una forma abreviada
        de representar una relación de realización de un clasificador de interfaz.
    </p>

    <p>
        Los símbolos de <strong>interfaz requerida</strong>, representados con medio círculo en su extremo
        (también conocidos como <em>sockets</em>), indican una interfaz que el componente necesita.
        En ambos casos, el nombre de la interfaz se coloca cerca del símbolo correspondiente.
    </p>

 <img src="../../../../img/guia_354.png" alt="" width="700">
     <p><strong>Ejemplo de Diagrama de Componentes - Uso de Interfaz (Sistema de Pedidos)</strong></p>
    <img src="../../../../img/guia_355.png" alt="" width="700">
    ...
    <p>
        El clasificador de subsistema es una versión especializada de un clasificador de componente.
        Debido a esto, el elemento de notación de subsistema hereda todas las mismas reglas que el
        elemento de notación de componente.
    </p>

    <p>
        La única diferencia es que un elemento de notación de subsistema utiliza la palabra clave
        <strong>«subsystem»</strong> en lugar de <strong>«component»</strong>.
    </p>

    <img src="../../../../img/guia_356.png" alt="" width="700">


         <h2>Puertos</h2>
    <p>
        Los puertos se representan utilizando un cuadrado a lo largo del borde del sistema o de un componente. 
        Un puerto se utiliza con frecuencia para ayudar a exponer las interfaces requeridas y proporcionadas de un componente.
    </p>


    <img src="../../../../img/guia_357.png" alt="" width="700">

        <h2>Relaciones</h2>
    <p>
        Gráficamente, un diagrama de componentes es una colección de vértices y arcos, y comúnmente contiene 
