...
if ($_POST) {
   ...
   if ($respuesta_2 === 'architecture views') {  
   ...
   if ($respuesta_4 === 'synthetic approach' || $respuesta_4 === 'enfoque sintetico') {  
   ...
   if ($respuesta_5 === 'projective approach' || $respuesta_5 === 'enfoque proyectivo' ) {  
   ...
   if ($respuesta_6 === 'views' || $respuesta_6 === 'vistas') {  
   ...
   if ($respuesta_7 === 'architecture description') {  
   ...
   if ($respuesta_11 === 'extraccion') {  
     ...
     if ($respuesta_12 === 'unico modelo unificado') {  
     ...
     if ($respuesta_15 === 'projective approach'  || $respuesta_15 === 'enfoque proyectivo' ) { 
     ...
     if ($respuesta_16 === 'inconsistencias') {  
     ...
     if ($respuesta_21 === 'architectural style' || $respuesta_21 === 'diseño arquitectonico') {  
   ...
   if ($respuesta_23 === 'caracteristicas distintivas') {  
   ...
   if ($respuesta_24 === 'solucion comun') {  
   ...
   if ($respuesta_25 === 'problema recurrente') { 
   ...
   if ($respuesta_26 === 'todo el sistema') {  
   ...
   if ($respuesta_27 === 'Estructuras generales' || $respuesta_27 === 'estructuras generales') {  
   ...
   if ($respuesta_28 === 'Sistemas distribuidos' || $respuesta_28 === 'sistemas distribuidos') {  
   ...
   if ($respuesta_29 === 'Impulsados por métodos' || $respuesta_29 === 'impulsados por metodos') {  
   ...
   if ($respuesta_30 === 'orientado a objetos') {  
   ...
   if ($respuesta_31 === 'orientado a eventos') {  
   ...
   if ($respuesta_32 === 'Interaccion usuario-computador' || $respuesta_32 === 'interaccion usuario-computador') {  
   ...
   if ($respuesta_33 === 'modelo-vista-controlador') {  
...
if ($respuesta_35 === 'Sistemas adaptativos' || $respuesta_35 === 'sistemas adaptativos' ) { 
...
if ($respuesta_36 === 'Maquinas virtuales' || $respuesta_36 === 'maquinas virtuales') { 
...
if ($respuesta_43 === 'architectural pattern') { 
...
if ($respuesta_60 === 'expresar arquitecturas de software') { 
...
<div class="seccion izquierda">
    ...
    <p>
    Clements et al. han introducido el concepto de <strong>
    <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="8">       
    </strong>, que establecen 
  ...
  <button onmousedown="mostrarMensaje()" onmouseup="ocultarMensaje()">info</button>
...
<div id="mensaje" style="display:none;">
  ...
  <ul>
    ...
    <p>
    Las <strong>architecture descriptions</strong> suelen utilizar múltiples 
    <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="12"> 
    para representar las diversas 
    <input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>" size="8">
    necesarias que abordan las diferentes preocupaciones 
  ...
  <p>
    En el
    <input type="text" value="<?php echo $respuesta_4; ?>" size="18" readonly> 
    , los arquitectos construyen 
    <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="18"> 
    del 
    sistema de interés e integran estas 
    <input type="text" value="<?php echo $respuesta_6; ?>" size="18" readonly>
    dentro de una 
    <input type="text" name="respuesta_7" value="<?php echo $respuesta_7; ?>" size="18"> 
    utilizando reglas de correspondencia.
  </p>

    <p>
    En el 
    <input type="text" value="<?php echo $respuesta_5; ?>" size="18" readonly> 
    , un arquitecto 
    ...
    rutinario —posiblemente mecánico— de 
    <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="8"> 
    desde un 
    <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="19"> 
    (o “<em>uber model</em>”) [23].
    </p>
...
<?php echo $verificar_12 ?>
    ...
    <hr>
    <p>
    Una consecuencia de introducir múltiples 
    <input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>" size="8"> 
    en una <strong>AD</strong> 
    es el posible 
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="8"> 
    entre dichas 
    <input type="text" value="<?php echo $respuesta_13; ?>" size="8"> 
    . ¿Son consistentes? ¿Están 
    describiendo el mismo sistema? A esto se le ha llamado el <em>multiple 
    <input type="text" value="<?php echo $respuesta_13; ?>" size="8">     
    problem</em> [39].
    </p>
    ...
    , ya que 
    las <strong>views</strong> se derivan desde un 
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="11">
    (presumiblemente consistente),
    pero a costa de expresividad: el modelo subyacente puede no ser capaz de capturar preocupaciones arbitrarias.
    </p>
    ...
    las <strong>views</strong>
    en un todo, utilizando enlaces u otras formas de 
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="11">
    para hacer referencia cruzada entre 
    elementos de <strong>views</strong> y lograr consistencia [23, 25].
    </p>

    <p>
    Los <strong>viewpoints</strong> a menudo incluyen 
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="11">
    para establecer consistencia u otras 
    relaciones entre <strong>views</strong>.
    </p>

    
    <button onmousedown="mostrarMensaje2()" onmouseup="ocultarMensaje2()">Ejemplos</button>
...
<h3>Conceptos Clave</h3>
    ...
    <span class="icono"></span> Se pueden tener múltiples <em>views</em> en una misma <em>AD</em>.
        ...
        <p>    <span class="clave">viewpoint (punto de vista)</span><br>
    Define las convenciones, notaciones, reglas y perspectivas para construir una <em>view</em>.<br>
    <span class="icono"></span> Un <em>viewpoint</em> guía cómo se crea e interpreta una <em>view</em>.</p>


      <h3> Enfoques para construir <em>views</em></h3>
  <p>  <span class="clave">synthetic approach (enfoque sintético)</span><br>
...
<?php echo $verificar_20 ?>
    ...
    <p>
    Inspirado por su uso en la larga historia de la arquitectura de edificios, un 
    ...
    de un sistema de software. Un 
    <input type="text" value="<?php echo $respuesta_21; ?>" size="18" readonly>
    a menudo expresa la organización a gran escala 
    de un sistema de software.
    </p>

    <p>
    En contraste, un <strong>architectural pattern</strong> expresa una 
    ...
    dentro del contexto de un sistema de software — no necesariamente se 
    aplica a 
    <input type="text" name="respuesta_26" value="<?php echo $respuesta_26; ?>" size="13">
    . Los <em>design patterns</em> se discuten en la sección 4.4 del 
    área de conocimiento de Diseño de Software.
    </p>
...
<?php echo $verificar_26 ?>
    ...
    <ul>
    <li>
    <input type="text" name="respuesta_27" value="<?php echo $respuesta_27; ?>" size="17">    
    :
    por capas (<em>layered</em>), llamada y retorno 
    (<em>call-and-return</em>), filtros y tuberías (<em>pipes and filters</em>), pizarra (<em>blackboard</em>), 
    servicios y microservicios.</li>

    <li> 
    <input type="text" name="respuesta_28" value="<?php echo $respuesta_28; ?>" size="17">   
    : cliente-servidor, n-capas (<em>n-tier</em>), intermediario 
    (<em>broker</em>), publicación-suscripción, punto a punto, REST (<em>representational state transfer</em>).</li>

    <li>
    <input type="text" name="respuesta_29" value="<?php echo $respuesta_29; ?>" size="17">     
    : 
    <input type="text" name="respuesta_30" value="<?php echo $respuesta_30; ?>" size="17">,
    <input type="text" name="respuesta_31" value="<?php echo $respuesta_31; ?>" size="17">,
    flujo de datos 
    (<em>data flow</em>).</li>
    ...
    :
    <input type="text" name="respuesta_33" value="<?php echo $respuesta_33; ?>" size="30"> 
    (<input type="text" name="respuesta_34" value="<?php echo $respuesta_34; ?>" size="4"> ), 
    presentación-abstracción-control.</li>

    <li>
    <input type="text" name="respuesta_35" value="<?php echo $respuesta_35; ?>" size="18">    
    : microkernel, reflexión y arquitecturas meta-nivel.</li>

    <li>
    <input type="text" name="respuesta_36" value="<?php echo $respuesta_36; ?>" size="15">    
    : intérpretes, basadas en reglas, control de procesos.</li>
    </ul>

    <p>
    Los <strong>pattern catalogs</strong> (o sistemas de patrones) se utilizan para expresar 
    <strong>architectural styles</strong> y soluciones mediante 
    <input type="text" name="respuesta_37" value="<?php echo $respuesta_37; ?>" size="15">
    coordinados de patrones. 
    Ejemplos de <strong>pattern catalogs</strong> incluyen [7], [19] para arquitecturas n-tier, [13] 
    para arquitecturas orientadas a servicios, y [37] para arquitecturas de microservicios. 
    Los <strong>pattern catalogs</strong> no se limitan a estilos arquitectónicos y pueden estar
    enfocados en abordar preocupaciones específicas, como la seguridad [17].
    </p>
...
<?php echo $verificar_37 ?>
    ...
    <br><br>
     ...
     <button onmousedown="mostrarMensaje3()" onmouseup="ocultarMensaje3()">info</button>

<div id="mensaje3" style="display:none;">

<p>Puedes pensar en un <em>pattern catalog</em> como:</p>

<ul>
  <li>🔹 Un conjunto de <strong>estilos y patrones arquitectónicos</strong> relacionados por un mismo <strong>tema o propósito</strong>, organizados para ser usados juntos y resolver <strong>problemas recurrentes</strong>.</li>
</ul>
...
<div class="seccion derecha">
  ...
  <p>
    ...
    <input type="text" name="respuesta_43" value="<?php echo $respuesta_43; ?>" size="20">
    [7].
  </p>


      <p>
    Los <strong>architectural patterns</strong> existen en distintas escalas y pueden aplicarse 
    <input type="text" name="respuesta_44" value="<?php echo $respuesta_44; ?>" size="9">
    a un elemento del sistema o 
    <input type="text" name="respuesta_45" value="<?php echo $respuesta_45; ?>" size="9">
    en todo el sistema.
  </p>

    <p>
    En relación con los <strong>architecture viewpoints</strong>, que proporcionan los 
    <input type="text" name="respuesta_46" value="<?php echo $respuesta_46; ?>" size="9">
    para 
    hablar sobre varios aspectos de sistemas de software, una noción unificadora es que tanto los 
    <strong>patterns</strong> como los <strong>styles</strong> son expresiones idiomáticas en esos 
    lenguajes para expresar aspectos particulares de arquitecturas (y diseños; véase sección 4.4 
    <em>Design Patterns</em> en el área de conocimiento de Diseño de Software).
    </p>
...
<?php echo $verificar_45 ?>
    ...
    <hr>
    <p>
    Un <strong>architectural pattern</strong> o <strong>style</strong> usa un
    ...
    , de una forma específica, para hablar sobre los elementos 
    de la
    ...
    , sus instancias y las 
    restricciones sobre cómo combinarlos [23, 39].
    </p>

    <p>
    De esta manera, los <strong>viewpoints</strong>, <strong>patterns</strong> y <strong>styles</strong> 
    son mecanismos para codificar prácticas recomendadas que faciliten la 
    <input type="text" name="respuesta_52" value="<?php echo $respuesta_52; ?>" size="9">.
    </p>

    <p>
    Una <strong>reference architecture (RA)</strong> es una 
    ...
    . Documentada como una <em>reference architecture description</em>, una RA proporciona 
    una 
    <input type="text" name="respuesta_57" value="<?php echo $respuesta_57; ?>" size="9">
    para el desarrollo de arquitecturas de sistemas individuales, líneas de productos o 
    familias de sistemas y dominios de aplicación.
    </p>

    <p>
    Las <strong>reference architectures</strong> capturan elementos 
    <input type="text" name="respuesta_58" value="<?php echo $respuesta_58; ?>" size="9">
    para promover la facilidad 
    de desarrollo, integración e interoperabilidad, así como otros tipos de estandarización.
    </p>
...
<hr>
  ...
  <p>
    Un <strong>architecture description language (ADL)</strong> es un 
    <input type="text" name="respuesta_59" value="<?php echo $respuesta_59; ?>" size="9">
    específico de dominio utilizado para 
    <input type="text" name="respuesta_60" value="<?php echo $respuesta_60; ?>" size="30">
    . Los ADLs
    surgieron de los <em>module interconnection languages</em> [36] para la programación a gran escala.
  </p>

    <p>
    Algunos ADLs están dirigidos a un único 
    ...
    arquitectónico
    (por ejemplo, MetaH para sistemas de aviónica con estilo orientado a eventos); otros 
    son de amplio espectro y permiten enmarcar preocupaciones a nivel empresarial (como ArchiMate™).
    </p>

    <p>
    <input type="text" name="respuesta_63" value="<?php echo $respuesta_63; ?>" size="4">
    se ha utilizado con frecuencia como un ADL debido a su uso generalizado en actividades 
    de diseño de software [41*].
    </p>

    <p>
    Los ADLs a menudo proporcionan capacidades que van más allá de la descripción, permitiendo 
    el análisis de arquitecturas o la generación de código.
    </p>
<button type="submit">Enviar</button>
...
<?php echo $verificar_63 ?>
    ...
    <br><br>
     ...
     <button onmousedown="mostrarMensaje4()" onmouseup="ocultarMensaje4()">info</button>

<div id="mensaje4" style="display:none;">

   <p>
    Los viewpoints te dicen cómo mirar y documentar la arquitectura desde distintos ángulos.
Los styles, patterns y reference architectures te dicen qué estructura o solución puedes aplicar.
Todos se complementan: los viewpoints te ayudan a visualizar y comunicar lo que los estilos, patrones y arquitecturas de referencia proponen y estructuran.
