...
if ($_POST) {
   ...
   if ($respuesta_11 === 'definir') {  
     ...
     if ($respuesta_17 === 'concurrentemente') {  
     ...
     if ($respuesta_18 === 'idealizaciones') {  
...
<div class="seccion izquierda">
    ...
    <h2>b. Modelos de Ciclo de Vida del Software</h2>
    
    <p>La naturaleza 
    <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="8">                                
    del software permite una gran 
    ...
    (secuenciales) hasta modelos iterativos y ágiles.</p>
    
    <h3>Modelos Lineales (Predictivos)</h3>
    <p>Las fases se completan secuencialmente, con retroalimentación e iteración según sea necesario.
    Se enfocan en una planificación exhaustiva al inicio y un control 
    <input type="text" name="respuesta_4" value="<?php echo $respuesta_4; ?>" size="8">                                
    de los requisitos.
    Los cambios se gestionan mediante un proceso 
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="8">                                
    de solicitudes.</p>
    
    <h3>Modelos Iterativos (Adaptativos)</h3>
    <p>El software se desarrolla en 
    <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="8">                                    
    , con funcionalidades crecientes en cada ciclo.
    Los requisitos pueden ser más 
    <input type="text" name="respuesta_7" value="<?php echo $respuesta_7; ?>" size="8">                                
    y evolucionar durante el proyecto. Los modelos ágiles son 
    un tipo de modelo iterativo que
    enfatiza la entrega 
    <input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>" size="8">                                
    de software funcional y la 
    <input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>" size="8">                                
    con el cliente.</p>
    
    <p>La diferencia clave entre estos modelos radica en cómo gestionan los 
    <input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>" size="8">                                    
    . Los
    modelos lineales buscan 
    ...
    todos los requisitos al principio. Los
    modelos iterativos permiten que los requisitos 
    <input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>" size="8">                                    
    . Los modelos ágiles están
    diseñados para facilitar la evolución de los requisitos durante el proyecto.</p>
    
    <p>Es importante destacar que no hay una línea divisoria estricta entre estos modelos. Se pueden
    combinar elementos de diferentes enfoques. Por ejemplo, un modelo incremental puede tener
    fases de requisitos y diseño secuenciales, pero permite 
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="8">                                    
    en la construcción.</p>
    
    <h2>c. Adaptación de Procesos de Software</h2>
    <p>Los SDLC, SPLC y procesos individuales a menudo necesitan ser 
    ...
    específicas de cada proyecto. El contexto organizacional, la tecnología, el
    tamaño del proyecto, la criticidad, los requisitos regulatorios, las prácticas de la industria y
    la cultura corporativa influyen en esta adaptación. La adaptación puede implicar añadir
    detalles a los procesos, usar actividades alternativas o incluso omitir procesos o actividades
    que no sean aplicables.</p>
    
    <h2>d. Consideraciones Prácticas</h2>
    <p>En la práctica, los procesos y actividades a menudo se entrelazan, superponen y aplican
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="8">                                        
    . Los modelos de ciclo de vida que especifican procesos discretos con
    criterios de entrada y salida rigurosos son 
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="8">                                        
    que deben adaptarse a la realidad
    del desarrollo y mantenimiento.</p>
    
    <p>Los procesos también se pueden adaptar para facilitar la operación, el soporte, el
    mantenimiento, la migración y el retiro del software. Otros factores a considerar al definir un
    ciclo de vida incluyen el cumplimiento de estándares, las demandas del cliente, la criticidad
    del software, la madurez y las competencias de la organización, la naturaleza del trabajo
    (modificación vs. desarrollo nuevo) y el dominio de aplicación.</p>
    ...
    <hr>
    <h2>10 heurísticas de usabilidad para el diseño de interfaces de usuario</h2>
    <p>Los 10 principios generales de 
    ...
    Se denominan «heurísticas» porque son 
    ...
    y no directrices específicas de usabilidad.</p>

     
    <h2>1.Visibilidad del Estado del Sistema</h2>
    <p>El diseño debe mantener siempre informados a los usuarios sobre lo que está sucediendo, mediante 
    retroalimentación apropiada dentro de un período de tiempo razonable.</p>

    <p>Cuando los usuarios conocen el estado actual del sistema, conocen el resultado de sus interacciones
    previas y determinan los próximos pasos. Las interacciones predecibles generan confianza en el producto 
    y en la marca.</p>
    
    <p>Seguro que alguna vez has enviado un formulario y no sabes si se ha enviado correctamente o no.</p>

    <h3>Otros ejemplos de este principio:</h3>
    <ul>
        <li>Las barras de carga de las imágenes o de los procesos de descarga de archivos.</li>
        <li>Los Breadcrumbs o migas de pan que nos muestran dónde nos encontramos dentro de la web.</li>
        <li>Los indicadores de los procesos de compra que suelen indicarnos en qué fase nos encontramos.</li>
        <li>Las páginas de situación de suscripción con confirmación donde cargas una página que indica que hemos
        enviado un mail para que haga clic en el enlace.</li>
        <li>
        Los indicadores Estás aquí  en los mapas de los centros comerciales muestran a las personas dónde
         se encuentran actualmente para ayudarlas a comprender a dónde ir a continuación.  
        </li>
    </ul>
    <h2>Consejos</h2>
    
    <ul>
        <li>Comunicar claramente a los usuarios cuál es el estado del sistema: no se debe realizar ninguna acción que tenga consecuencias para los usuarios sin informarles.</li>
        <li>Presentar retroalimentación al usuario lo más rápido posible (idealmente, de inmediato).</li>
        <li>Generar confianza mediante una comunicación abierta y continua.</li>
    </ul>
    ...
    <h2>2: Correspondencia entre el sistema y el mundo real</h2>
    <p>El diseño debe hablar el idioma del usuario. Use palabras, frases y conceptos que le resulten familiares,
    en lugar de jerga interna. Siga las convenciones del mundo real, presentando la información en un orden
    natural y lógico.</p>

    <p>La forma de diseñar depende en gran medida de los usuarios específicos. Términos, conceptos, iconos e 
    imágenes que parecen perfectamente claros para usted y sus colegas pueden resultar desconocidos o confusos 
    para los usuarios.</p>

    <p>Cuando los controles de un diseño siguen las convenciones del mundo real y se corresponden con los resultados 
    deseados (lo que se denomina <strong>mapeo natural</strong>), a los usuarios les resulta más fácil aprender
    y recordar cómo funciona la interfaz. Esto contribuye a crear una experiencia intuitiva.</p>
    ...
    <li>
    otro ejemplo: cuando los controles de la estufa coinciden con 
    la disposición de los elementos de calefacción, los usuarios pueden comprender rápidamente qué control corresponde 
    a qué elemento de calefacción.
    </li>

    <h2>Consejos</h2>
    <ul>
        <li>Asegúrese de que los usuarios puedan comprender el significado sin tener que buscar la definición de una palabra.</li>
        <li>Nunca asuma que su comprensión de las palabras o conceptos coincidirá con la de sus usuarios.</li>
        <li>La investigación de usuarios descubrirá la terminología familiar de sus usuarios, así como sus modelos mentales 
        en torno a conceptos importantes.</li>
    </ul>
