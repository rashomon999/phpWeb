...
if ($_POST) {
   ...
   if ($respuesta_11 === 'modificacion') {  
     ...
     if ($respuesta_12 === 'funcionalidades') {  
     ...
     if ($respuesta_20 === 'intercambiables') {  
...
<div class="seccion izquierda">
    ...
    <p> Autores como Robert C. Martin y Michael Feathers han buscado motivar al desarrollo de diseños
    más 
    ...
    . Logrando un código
    fácil de leer, entender y testear. En esta sección se presentan los principios SOLID que son:</p>
    

    <strong>Single responsibility</strong>
    <p>En este principio se plantea que cada clase debe tener una 
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="8">      
    responsabilidad, por lo tanto,
    cada clase tendrá una única 
    ...
    <p>Este principio requiere que las clases se encuentren 
    ...
    . La modificación hace referencia a añadir más 
    ...
    tocar el código
    existente. ¿Cómo se logra esto? Con el uso de interfaces y clases abstractas. </p>
    
    <strong>Liskov Substitution</strong>
    <p> El principio de sustitución propone que en los 
    ...
    agrupaciones de clases.</p>
    <p>
    El principio de Sustitución de Liskov establece que las clases derivadas o subclases deben ser 
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="8">          
    con sus clases base o superclases sin afectar el correcto funcionamiento de la aplicación.
    </p>
    ...
    <p>Este principio se enfoca en la definición de 
