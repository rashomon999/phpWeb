...
<div class="seccion izquierda"> 
  ...
  <h1>Docker Compose</h1>
    <h2>Opciones de la página</h2>

    <p>Docker Compose es una herramienta para definir y ejecutar aplicaciones multicontenedor. Es la clave para desbloquear una experiencia de desarrollo y despliegue ágil y eficiente.</p>

    <p>Compose simplifica el control de toda su pila de aplicaciones, haciendo fácil gestionar servicios, redes y volúmenes en un único archivo de configuración YAML. Luego, con un solo comando, crea e inicia todos los servicios desde su archivo de configuración.</p>

    <p>Compose funciona en todos los entornos: producción, staging, desarrollo, pruebas, así como en flujos de trabajo de CI. También dispone de comandos para gestionar todo el ciclo de vida de su aplicación:</p>

    <ul>
      <li>Iniciar, detener y reconstruir servicios</li>
      <li>Ver el estado de los servicios en ejecución</li>
      <li>Transmitir la salida de registro de los servicios en ejecución</li>
      <li>Ejecutar un comando puntual en un servicio</li>
    </ul>
