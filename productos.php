...
$links = ["musica/CM.php",  "java/index.php","fisica/Menu.php", "operaciones_basicas/index.php","SistemaDatos/Menu.php","Estadistica/Menu.php","discretas/menu.php","scala/Menu.php","ingesoft/Menu.php","Ingles/Menu.php","Matematicas/Menu.php"];
