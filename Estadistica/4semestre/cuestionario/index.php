...
if ($_POST) {
   ...
   if ($respuesta_11 === 'hipoteticamente') {  
...
<div class="seccion izquierda">
   ...
   <strong> Hipótesis nula \( Ho \)</strong>
    ...
    que se probará, por lo
    que su especificación es muy importante</li>
    <li>Los datos pueden mostrar 
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_18; ?>" size="8">      
    a 
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_18; ?>" size="8">  
    </li>
    <li>No debería ser 
    ...
    \(   \)
     ...
     cuando es cierta</li>
    <br><br>
    <input type="text" name="respuesta_23" size="8" id="respuesta_23" oninput="actualizarFormula()" value=<?php echo $respuesta_23?>>
    <br><br>
    <button type="submit">Enviar</button>
    ...
    <li>Zona donde están los valores    
    ...
    la Tabla de Distribución Normal es la que se usa para la prueba 
