...
<div class="seccion izquierda">
    ...
    <h3>Resumen de los 3 Casos</h3>
    <table>
    <tr>
        <th>Tipo de Prueba</th>
        <th>Hipótesis Alternativa H₁</th>
    ...
    <tr>
        ...
        <td>\(μ₁ ≠ μ₂ \)</td>
        <td>\(α/2 \) en cada cola  </td>
        <td>\(t_c > t_{α/2, gl}\) o \( t_c < -t_{α/2, gl} \)</td>
    </tr>
    <tr>
        <td><strong>Unilateral Derecha</strong></td>
        <td>\(μ₁ > μ₂ \)</td>
        <td>\(α \) en la cola derecha  </td>
        <td>\( t_c > t_{α, gl} \)</td>
    </tr>
    <tr>
        <td><strong>Unilateral Izquierda</strong></td>
        <td>\(μ₁ < μ₂ \)</td>
        <td>\(α\)  en la cola izquierda  </td>
        <td>\( t_c < -t_{α, gl} \) </td>
    </tr>
    </table>
    </form>
