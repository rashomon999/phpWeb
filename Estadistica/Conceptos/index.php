...
<div class="seccion izquierda">
    ...
    DIAPO_0
    <hr>
    <strong>Porque estudiar estadistica?</strong> <br><br>
    ...
    y  <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="8">
    la  <input type="text" name="respuesta_7" value="<?php echo $respuesta_7; ?>" size="8">
    de los  <input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>" size="15">
    que vemos 
    ...
    <hr>
    <br>
    <strong>La estadistica es la ciencia de:</strong> <br><br>
    <li>
    ...
    <input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>" size="8"> y 
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="8"> de los 
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="8">
     ...
     que presenta 
     <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="8"> o 
     <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="8">
     para su estudio metodico, con el objetivo de
    </p>
    <li>
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="8">:
    </li>
    <p>
        deducir leyes que rigen estos fenomenos.
    </p>
    <li>
        Inferencia:
    </li>
    ...
    <br><br>
    <strong>Estadistica descriptiva:</strong> <br><br>
    Es la 
    <input type="text" name="respuesta_23_2" value="<?php echo $respuesta_23_2; ?>" size="8">
    estadistica que 
    ...
    <input type="text" name="respuesta_23" value="<?php echo $respuesta_23; ?>" size="8">y 
    ...
    con el proposito de facilitar su 
    ...
    <input type="text" name="respuesta_29" value="<?php echo $respuesta_29; ?>" size="12">o 
    ...
    <hr>
    <strong>Estadistica inferencial</strong>
    Es la 
    <input type="text" name="respuesta_35" value="<?php echo $respuesta_35; ?>" size="8">
    de la Estadistica que 
    <input type="text" name="respuesta_36" value="<?php echo $respuesta_36; ?>" size="8"> los 
    ...
    <br>
    <strong>Definiciones basicas</strong> <br><br>
    <strong>Poblacion</strong> <br><br>
    Es todo 
    ...
    <input type="text" name="respuesta_54" value="<?php echo $respuesta_54; ?>" size="8"> u 
    <input type="text" name="respuesta_55" value="<?php echo $respuesta_55; ?>" size="8">,
    <input type="text" name="respuesta_56" value="<?php echo $respuesta_56; ?>" size="8">o 
...
<div class="seccion derecha">
    ...
    <?php echo $verificar_66 ?>
    <br>
    Razones para no realizar un censo
    <li>
    - Costos en dinero
    </li>
    <li>
    ...
    <li>
    - Logística, imposibilidad de llegar a ciertos sitios
    </li>
    <hr><br>
    <strong>Muestra</strong> <br>
    Todas las ocaciones en las que no es posible realizar un 
    <input type="text" name="respuesta_71" value="<?php echo $respuesta_71; ?>" size="8">. 
    lo que
    hacemos es trabajar con una muestra,
    entendiendo por tal una parte
    representativa de la población.

    <br><br>
    Para que una muestra sea representativa, y
    por lo tanto útil, debe de reflejar las
    ...
    encontradas en la
    población, ejemplificar las características de
    la misma.
    ...
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_71 ?> <?php echo $verificar_72 ?>
    <?php echo $verificar_73 ?> <?php echo $verificar_74 ?>
    <?php echo $verificar_75 ?>
    <br><br>
    <strong>Muestreo</strong> <br>
    Es el proceso de 
    ...
    <hr>
    <br>
    <strong>Método de muestreo</strong> <br>
    Es la manera como serán 
    ...
    <button type="submit">Enviar</button>
    <hr>   
    <strong> Unidad de muestreo </strong>
    Es el 
    ...
    el cual se planteó la investigación y al
    cual se le realizan las 
    ...
    <strong>Dato</strong>
    Es una 
    <input type="text" name="respuesta_92" value="<?php echo $respuesta_92; ?>" size="12">
    (numérica o no numérica) que 
    ...
    Población: Estudiantes de la universidad ICESI
    <br><br>
    <li>
    – La altura media de los estudiantes de la universidad ICESI
    </li>
    <li>
    – La varianza de la estatura de los estudiantes de la universidad ICESI
    </li>
    ...
    <hr>
    Estadístico(a) o estadígrafo: Es un resultado o medida (cantidad numérica) que
    representa a una característica de la 
    <input type="text" name="respuesta_100" value="<?php echo $respuesta_100; ?>" size="8"> 
    .
    Por ejemplo:
    Se selecciona una muestra de tamaño n de los estudiantes de la universidad ICESI
    - La altura media del subconjunto de estudiantes seleccionados
    - La varianza de la estatura de los estudiantes seleccionados
    ...
    , pero por la dificultad que conlleva
    estudiar a *TODA* la población, calculamos un estimador sobre una muestra y
    “confiamos” en que sean próximos. <br><br>     
    <button type="submit">Enviar</button>
    <?php echo $verificar_100 ?>
    <?php echo $verificar_101 ?> <br><br>
 </form>
</div>
