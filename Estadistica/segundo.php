...
if ($_POST) {
   ...
   if ($respuesta_3 === 'caracteristica observable') { 
   ...
   if ($respuesta_8 === 'ninguna relacion') {  
...
// Verificar la respuesta de la novena pregunta (17 * 10)
...
<div class="seccion izquierda">
    <form action="./segundo.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
            ...
            individuos de una población o muestra. La información que disponemos de cada
            individuo (dato) es resumida en variables.
            En los individuos de la población universitaria, de uno a otro es variable:
            <li>
            - El grupo sanguíneo
            ...
            , es decir, al ser evaluadas el resultado es
            una categoría o modalidad.
            <br><br>
            Nominales: No presenta 
            <input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>" size="8">
            entre las categorías, no pueden
            ordenarse.
            <br><br>
            Ordinales: Utiliza los números no solo para clasificar los elementos de un conjunto
            de categorías, sino para determinar un orden o identidad entre las categorías.
            <br><br>
            Las categorías deben formar un sistema exhaustivo y excluyente
            Exhaustivo: No podemos 
            <input type="text" name="respuesta_9" value="<?php echo $respuesta_10; ?>" size="8">
            posible valor de la variable
            Excluyente: Nadie puede presentar
            ...
            <hr>
            <br>
            <strong>Cuantitativas o Numéricas</strong> <br><br>
            Discretas: Es aquella cuya naturaleza hace que el conjunto de valores que puede
            tomar sean 
            <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="8">
            enteros, es decir, no admiten otro valor entre dos valores
            distintos y consecutivos
            <br><br>
            Continuas: Es aquella que puede tomar valores reales, es decir, puede tomar
            <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="8">
             de valores entre dos valores consecutivos.
             <button type="submit">Enviar</button>
            ...
            Permite definir una unidad de medida convencional (ej: número de preguntas acertadas en un
            ejercicio escolar). Teniendo en cuenta, que el cero en este tipo de escala no significa 
            en ningún caso la 
            <input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>" size="8">
            de la propiedad que se intenta medir (es arbitrario). 
            De esta forma, es plausible en este
            tipo de medida obtener puntuaciones negativas, por ejemplo la temperatura corporal medida en
            grados Celsius. 
            <br><br>
            Escala de razón
            La escala de razón es el nivel más alto de medición.
            Es usada cuando no solamente el orden y el tamaño del intervalo entre medidas son importantes, sino
            también la razón (o cociente) entre 2 medidas. Si es razonable hablar de que una cantidad es “tantas veces”
            otra cantidad, entonces la escala de razón es apropiada para la medición, como cuando se miden longitudes,
            pesos, estaturas, etc. 
            Realmente la única diferencia entre la escala de razón y la de intervalo, es que la de
            razón tiene un punto cero 
            <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="8">
            , mientras que en la de intervalo éste es arbitrario. En ambas escalas la
            ...
            <button type="submit">Enviar</button>
             ...
             <br>
             <img src="..\img\WhatsApp Image 2025-02-04 at 4.25.29 PM.jpeg" alt="" width="400">
