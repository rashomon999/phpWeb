...
<div class="seccion izquierda">
    <form action="./index.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
        <p>En el restaurante universitario, hay una máquina de refrescos que se encuentra ajustada de
        modo que la cantidad de bebida que sirva esté distribuida de forma aproximadamente
        normal con una media de llenado de 250 ml y una desviación estándar de 12 ml. La
        máquina se verifica periódicamente con una muestra de 25 bebidas y en la última revisión
        se encontró que sirve en promedio 258 ml.
        </p>
        <li>
        a. Con un nivel de significancia del 5%, se puede asegurar el contenido que sirve la
        maquina difiere de lo asegurado?
        </li>
        \[ H_0: \mu = 250 \]
        \[ H_1: \mu \ne 250 \]
        ...
        <hr>
        <p>
        Un contratista ordena un gran número de vigas de madera con longitud promedio de
        ...
        <li>
        a. Con una significancia 5%, el contratista puede concluir que las vigas son más
        pequeñas de lo requerido.
        </li>
        <li>
        b. El contratista debe devolver el lote de vigas? Porque? 
        </li>
        \[ H_1: \mu \ge 5\]
        \[ H_1: \mu < 5 \]
        <hr>
        <p>
        Actualmente las empresas estudian con más detalle las hojas de vida de los aspirantes
        ...
        errores de incongruencia? Utilice una significancia del 2.5%.
        </li>
        \[ H_0: \pi \le 0.50 \]
        \[ H_1:  \pi  > 0.50  \]
        ...
        <hr>
        <p>
        Una empresa que fabrica artículos electrónicos recibe lotes de pilas de un
        ...
        superior a lo acordado?
        </li>
        \[ H_0: \sigma^2 \le 4 \]
        \[ H_1: \sigma^2 > 4 \]
        <hr>
        <strong>Hipotesis Dos muestras</strong>
        <p>
        Existen dos tipos de plástico apropiados para su uso por un fabricante de componentes
