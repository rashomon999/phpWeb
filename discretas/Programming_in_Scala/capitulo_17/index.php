...
<div class="seccion izquierda">
    ...
    <hr>
    <strong>parentesis, apuntes clase</strong>
    <h1>Comportamiento de Map en Scala</h1>
    
    <table>
        <thead>
            <tr>
                <th>Característica</th>
                <th>Comportamiento en Scala</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>Claves duplicadas en un <span class="code">Map</span></td>
                <td>Se sobrescribe con el último valor.</td>
            </tr>
            <tr>
                <td>Verificar duplicados</td>
                <td>Usar <span class="code">distinct</span> o <span class="code">groupBy</span>.</td>
            </tr>
            <tr>
                <td>Agrupar valores por clave</td>
                <td>Usar <span class="code">groupBy + mapValues</span>.</td>
            </tr>
            <tr>
                <td>Mutabilidad</td>
                <td><span class="code">mutable.Map</span> permite actualizar valores.</td>
            </tr>
        </tbody>
    </table>
    <hr>
