...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
        // Establecer todas las respuestas correctas para las tablas de multiplicar
          ...
          $respuesta_1 = '\frac{n(n+1)}{2}';
    $respuesta_2 = 'n(n+1)+n';
    $respuesta_3 = '\frac{n(n+1)+n}{n}';
    $respuesta_4 = 'n+2';
    $respuesta_5 = 'n(n+1)';
    $respuesta_6 = 'compara';
    $respuesta_7 = 'intercambia';
    $respuesta_8 = 'i-1';
    $respuesta_9 = 'n-i';
    $respuesta_10 = '\frac{(n-1)n}{2}';
    $respuesta_11 = 'ordenada';
    
    $respuesta_12 = 'n^2';
    $respuesta_13 = '2';
    $respuesta_14 = '1';
    $respuesta_15 = 'j-1';
    $respuesta_16 = 'busqueda lineal';
    $respuesta_17 = 'aj';
    $respuesta_18 = 'j';
    $respuesta_19 = '\frac{n(n+1)}{2}-1';
    $respuesta_20 = 'pequeños';
    $respuesta_21 = 'n^2';
    $respuesta_22 = 'n^2';
    
    $respuesta_23 = 'nlogn';
    $respuesta_24 = '45';
    $respuesta_25 = 'fori:=1tom';
    $respuesta_26 = 'forj:=1ton';
    $respuesta_27 = 'cij:=0';
    $respuesta_28 = 'forq:=1tok';
    $respuesta_29 = 'cij:=cij+aiq*bqj';
    $respuesta_30 = 'i';
    $respuesta_31 = 'j';
    $respuesta_32 = 'constantes';
    $respuesta_33 = 'contiene';
    $respuesta_34 = 'filas';
    $respuesta_35 = 'columnas';
    $respuesta_36 = 'n^2';
...
return C {C = [cij] is the product of A and B}
 ...
 <button onmousedown="mostrarImagen5()" onmouseup="ocultarImagen5()">Ayuda</button>
    ...
    <img id="imagenMostrada5" src="../../../../img/guia_344.png" style="display: none; max-width: 100%" width="560">
