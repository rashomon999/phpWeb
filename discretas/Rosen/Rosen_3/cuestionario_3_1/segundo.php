...
<div class="seccion izquierda">
    ...
    <p>Consideremos el problema de dar cambio por <em>n</em> centavos usando monedas de 25, 10, 5 y 1 centavo, 
    y utilizando el 
    <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="8">  
    número total de monedas. Podemos idear un algoritmo voraz para dar cambio de <em>n</em> 
    centavos haciendo una elección localmente óptima en cada paso; es decir, en cada paso elegimos la moneda de 
    <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="8">
    denominación posible para agregar al monto del cambio sin exceder <em>n</em> centavos. Por ejemplo, 
    para dar cambio por 67 centavos, primero seleccionamos una moneda de 25 (quedando 42 centavos). Luego 
    seleccionamos otra moneda de 25 (quedando 17 centavos), seguida de una de 10 (quedando 7 centavos), 
...
c1 > c2 > ⋯ > cr; n: un entero positivo)
    <input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>" size="15">
        ...
        while <input type="text" name="respuesta_4" value="<?php echo $respuesta_4; ?>" size="15"> 
...
<p>
    n es el monto total (una cantidad entera positiva) que se quiere cambiar usando monedas.
</p>

<p>Hemos descrito el algoritmo del cajero, un algoritmo voraz para dar cambio, usando cualquier conjunto 
finito de monedas con denominaciones <em>c₁, c₂, …, cᵣ</em>. En el caso particular donde las cuatro 
denominaciones son 25, 10, 5 y 1 centavo, tenemos <em>c₁ = 25</em>, <em>c₂ = 10</em>, <em>c₃ = 5</em> y <em>c₄ = 1</em>.
 Para este caso, mostraremos que este algoritmo conduce a una solución óptima en el sentido de que 
 utiliza la menor cantidad de monedas posible. Antes de embarcarnos en nuestra demostración, mostraremos
  que hay conjuntos de monedas para los cuales el algoritmo del cajero (Algoritmo 7) 
  <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="4"> 
  necesariamente
   produce cambio usando la menor cantidad de monedas posible. Por ejemplo, si solo tuviéramos monedas 
   de 25, 10 y 1 centavo (y no de 5), el algoritmo del cajero daría cambio por 30 centavos usando seis 
   monedas —una de 25 y cinco de 1— mientras que podríamos haber usado tres monedas, es decir, tres de 10.</p>
