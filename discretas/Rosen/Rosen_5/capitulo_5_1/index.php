...
<div class="seccion izquierda">
    ...
    <ul>
    <li>\( n! \leq n^n \)</li>
    <li>\( n^3 - n \) es divisible por 3</li>
    <li>Un conjunto con \( n \) elementos tiene \( 2^n \) subconjuntos</li>
    <li>La suma de los primeros \( n \) enteros positivos es \( \frac{n(n + 1)}{2} \)</li>
    </ul>
    ...
    positivo, entonces también debe serlo para el siguiente número entero.</p>
     ...
     <p>
        La inducción matemática se basa en la regla de inferencia que nos dice que si
        \( P(1) \) es verdadero y
        \( \forall k,\ (P(k) \rightarrow P(k+1)) \) es verdadero en el dominio de los enteros positivos,
        entonces \( \forall n,\ P(n) \) también es verdadero.
    </p>
