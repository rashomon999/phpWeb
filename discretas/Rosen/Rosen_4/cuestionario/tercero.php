...
if ($_POST) {
    ...
    if ($mostrar_solucion === 'mostrar_solucion') {
          $respuesta_1 = '2';
    $respuesta_2 = '(a+b)modm';
    $respuesta_3 = '(a*b)modm';
    $respuesta_4 = 'aritmetica modulo m';
    $respuesta_5 = '16mod11=5';
    $respuesta_6 = '63mod11=8';
    $respuesta_7 = '5';
    $respuesta_8 = '8';
    $respuesta_9 = 'multiplicativos';
    $respuesta_10 = 'multiplicativo';
   ...
   if ($respuesta_10 === 'multiplicativo') {  
