...
// Eliminar los espacios en blanco de la respuesta y de la respuesta correcta
$respuesta_1_sin_espacios = str_replace(' ', '', $respuesta_1);
$respuesta_correcta_1 = '5x\equiv2\mod{3}'; // Sin espacios

if ($respuesta_1_sin_espacios === str_replace(' ', '', $respuesta_correcta_1)) {  
...
// Verificar la respuesta de la segunda pregunta sin tener en cuenta los espacios
$respuesta_24 = isset($_POST['respuesta_24']) ? $_POST['respuesta_24'] : '';
$respuesta_24_sin_espacios = str_replace(' ', '', $respuesta_24);
$respuesta_correcta = 'sa+tm=1';

if ($respuesta_24_sin_espacios === $respuesta_correcta) {  
    ...
    if ($respuesta_25 === 'sa + tm \equiv 1 \pmod{m}') { 
    ...
    if ($respuesta_26 === 'tm \equiv 0 \pmod{m}') {  
    ...
    if ($respuesta_27 === 'sa \equiv 1 \pmod{m}') {  
...
<div class="seccion izquierda">
    ...
    <strong>nota: utiliza \mod{a} \equiv, \overline{a}</strong>    
    <hr>
    <p>
    ¿Cómo puedo simplificar la congruencia 
    \( 5x \equiv 26 \mod 3 \), 
    sabiendo que 
    \( 26 \equiv 2 \mod 3 \)?
    </p>
    ...
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="20" 
    id="respuesta_15" oninput="actualizarFormula2()">
    <br><br>
    <button type="submit">Enviar</button>
    ...
    es un inverso de \( a \) módulo \( m \).<br>
    ...
    id="respuesta_25" oninput="actualizarFormula3()">
    <br>
    <input type="text" name="respuesta_26" value="<?php echo $respuesta_26; ?>" size="20" 
    id="respuesta_26" oninput="actualizarFormula4()">
    <br>
    <input type="text" name="respuesta_27" value="<?php echo $respuesta_27; ?>" size="20" 
    id="respuesta_27" oninput="actualizarFormula5()">
    <br>
    <button type="submit">Enviar</button>
