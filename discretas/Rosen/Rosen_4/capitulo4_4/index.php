...
<div class="seccion izquierda">
    ...
    <h3>Teorema 1</h3>
    <p>
    Si \( a \) y \( m \) son enteros primos relativos y \( m &gt; 1 \), entonces existe un inverso
    de \( a \) módulo \( m \).<br>
    Además, este inverso es único módulo \( m \). (Es decir, existe un único entero positivo \( \overline{a} \) 
    menor que \( m \) que es inverso de \( a \) módulo \( m \), 
    y cualquier otro inverso de \( a \) módulo \( m \) es congruente con \( \overline{a} \)
    módulo \( m \).)
    </p>
