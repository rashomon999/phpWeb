...
<div class="seccion izquierda">
    ...
    <p><strong>Ejemplo 3</strong> Usar inducción matemática para demostrar que</p>

    <p>\[
    1 + 2 + 2^2 + \cdots + 2^n = 2^{n+1} - 1
    \]</p>

    <p>para todos los enteros no negativos \( n \).</p>

    <p><strong>Solución:</strong> Sea \( P(n) \) la proposición de que</p>

    <p>\[
    1 + 2 + 2^2 + \cdots + 2^n = 2^{n+1} - 1
    \]</p>

    <p>para el entero \( n \).</p>

    <p><strong>Paso Base:</strong> \( P(0) \) es verdadera porque \( 2^0 = 1 = 2^1 - 1 \). Esto completa el paso base.</p>

    <p><strong>Paso Inductivo:</strong> Para la hipótesis de inducción, asumimos que \( P(k) \) es verdadera 
    para un entero no negativo \( k \). Es decir, asumimos que</p>

    <p>\[
    1 + 2 + 2^2 + \cdots + 2^k = 2^{k+1} - 1.
    \]</p>

    <p>Para completar el paso inductivo usando esta suposición, debemos demostrar que si asumimos que 
    \( P(k) \) es verdadera, entonces \( P(k + 1) \) también lo es. Es decir, debemos demostrar que</p>

    <p>\[
    1 + 2 + 2^2 + \cdots + 2^k + 2^{k+1} = 2^{(k+1)+1} - 1 = 2^{k+2} - 1
    \]</p>

    <p>asumiendo la hipótesis de inducción \( P(k) \). Bajo esta suposición, observamos que</p>

    <p>\[
    1 + 2 + 2^2 + \cdots + 2^k + 2^{k+1} = (1 + 2 + 2^2 + \cdots + 2^k) + 2^{k+1}
    \]</p>

    <p><strong>Usando la hipótesis de inducción IH:</strong></p>
    ...
    <p>Notamos que usamos la hipótesis de inducción en la segunda ecuación de esta cadena de igualdades 
    para reemplazar \( 1 + 2 + 2^2 + \cdots + 2^k \) por \( 2^{k+1} - 1 \). Hemos completado el paso inductivo.</p>

    <p>Debido a que hemos completado el paso base y el paso inductivo, por inducción matemática sabemos 
    que \( P(n) \) es verdadera para todos los enteros no negativos \( n \). Es decir,</p>
    ...
    <p>La fórmula dada en el Ejemplo 3 es un caso especial de un resultado general para la suma de términos 
    de una progresión geométrica (Teorema 1 en la Sección 2.4). Usaremos inducción matemática para proporcionar
    una prueba alternativa de esta fórmula.</p>
