...
<div class="seccion izquierda"> 
 ...
 <h2>Expresiones Regulares - Ejercicios y Soluciones</h2>

<h3>1. Todas las cadenas sobre \( \{a, b\} \) que comienzan con <em>aa</em> y terminan con <em>bb</em></h3>
...
<h3>2. Todas las cadenas sobre \( \{a, b\} \) que contienen exactamente tres <em>b</em></h3>
<p><strong>Solución:</strong></p>
\[
(a^*b a^*b a^*b a^*) 
\]
<em>Explicación:</em> Se permite cualquier número de <em>a</em> antes, entre y después de los tres <em>b</em>, 
asegurando exactamente tres <em>b</em> en total.

<hr>

<h3>3. Todas las cadenas sobre \( \{a, b\} \) que comienzan y terminan con símbolos diferentes</h3>
<p><strong>Solución:</strong></p>
\[
a(a \cup b)^*b \; \cup \; b(a \cup b)^*a
\]
<em>Explicación:</em> Se consideran las dos posibilidades: comienza con <em>a</em> y termina con <em>b</em>, o 
comienza con <em>b</em> y termina con <em>a</em>.
<hr>
