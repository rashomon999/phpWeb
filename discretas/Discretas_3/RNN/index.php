...
<div class="seccion izquierda"> 
   ...
   <h3>En términos generales, ¿qué es una red neuronal recurrente?</h3>

<ul>
    <li>
        Es un tipo de red neuronal artificial comúnmente utilizada en reconocimiento de voz y procesamiento de lenguaje natural.
    </li>

    <li>
        Las redes neuronales recurrentes reconocen las características secuenciales de los datos y utilizan patrones para predecir el siguiente escenario más probable.
    </li>

    <li>
        Son especialmente potentes en casos de uso donde el contexto es fundamental para predecir un resultado.
    </li>

    <li>
        Se diferencian de otros tipos de redes neuronales artificiales porque utilizan bucles de retroalimentación para procesar una secuencia de datos que informa la salida final.
    </li>

    <li>
        Estos bucles de retroalimentación permiten que la información persista.
    </li>

    <li>
        Este efecto suele describirse como memoria.
    </li>
</ul>
</div>
