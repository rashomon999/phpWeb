...
<div class="seccion izquierda"> 
    ...
    <p>
        Un <strong>alfabeto</strong> es un conjunto finito no vacío cuyos elementos se llaman
        <em>símbolos</em>. Denotamos un alfabeto arbitrario con la letra
        \( \Sigma \).
    </p>

    <p>
        Una <strong>cadena</strong> o <strong>palabra</strong> sobre un alfabeto \( \Sigma \) es cualquier
        sucesión (o secuencia) finita de elementos de \( \Sigma \).
        Admitimos la existencia de una única cadena que no tiene símbolos,
...
<p>
Obsérvese que <i>aba</i> ≠ <i>aab</i>. El orden de los símbolos en una cadena es
significativo ya que las cadenas se definen como sucesiones, es decir,
conjuntos secuencialmente ordenados.
</p>

<div class="ejemplo">
    <span class="label">Ejemplo</span>
    El alfabeto \( \Sigma = \{0,1\} \) se conoce como <i>alfabeto binario</i>.
...
<div class="ejemplo">
    ...
    el alfabeto del idioma castellano. Las palabras oficiales del castellano
...
<div class="ejemplo">
    ...
    (como Pascal o C) es el conjunto de caracteres ASCII
...
<p>
El conjunto de <i>todas</i> las cadenas sobre un alfabeto \( \Sigma \),
incluyendo la cadena vacía, se denota por \( \Sigma^* \).
</p>
...
<div class="nota">
    ...
    <p>
        ✎ Si bien un alfabeto \( \Sigma \) es un conjunto finito,
        \( \Sigma^* \) es siempre un conjunto infinito (enumerable).
    ...
    <p>
        ...
        que son todos diferentes entre sí:
...
<ol>
    <li>
        ...
        con la cadena vacía, a izquierda o a derecha, es igual a \( u \).
    </li>
...
\( u \) y a continuación los símbolos de \( v \).
</p>
...
<ol>
    <li>\( u \cdot \lambda = \lambda \cdot u = u \).</li>
    <li>\( u \cdot (va) = (u \cdot v)a \).</li>
</ol>

<div class="propiedad">
    <p>
        <b>Propiedad.</b> La concatenación de cadenas es una operación asociativa.
...
<div class="solucion">
    ...
    <p>
    Caso \( n, m \ge 1 \).
    \( |w^{n+m}| = \left|\underbrace{ww\cdots w}_{n+m\text{ veces}}\right|
    = (n+m)|w| \).
    Por otro lado,
    </p>
    ...
    <p>
    \( |w^n| + |w^m|
    = \left|\underbrace{ww\cdots w}_{n\text{ veces}}\right|
    + \left|\underbrace{ww\cdots w}_{m\text{ veces}}\right|
    = n|w| + m|w|. \)
    </p>
...
a_n \cdots a_2 a_1, & \text{si } u = a_1 a_2 \cdots a_n.
\end{cases}
\]
</div>
...
<p>
Una cadena \( v \) es una <b>subcadena</b> o una <b>subpalabra</b> de \( u \)
si existen cadenas \( x, y \) tales que \( u = xvy \).
Nótese que \( x \) o \( y \) pueden ser \( \lambda \) y, por lo tanto,
la cadena vacía es una subcadena de cualquier cadena y toda cadena
es subcadena de sí misma.
</p>

<p>
Un <b>prefijo</b> de \( u \) es una cadena \( v \) tal que
\( u = vw \) para alguna cadena \( w \in \Sigma^* \).
Se dice que \( v \) es un <b>prefijo propio</b> si \( v \neq u \).
</p>

<p>
Similarmente, un <b>sufijo</b> de \( u \) es una cadena \( v \) tal que
\( u = wv \) para alguna cadena \( w \in \Sigma^* \).
Se dice que \( v \) es un <b>sufijo propio</b> si \( v \neq u \).
</p>

<p>
Obsérvese que \( \lambda \) es un prefijo y un sufijo de toda cadena \( u \)
...
<p>
Un <b>lenguaje</b> \( L \) sobre un alfabeto \( \Sigma \) es un subconjunto de
\( \Sigma^* \), es decir,
</p>
...
<h2>1.9. Concatenación de lenguajes</h2>

<p>
La concatenación de dos lenguajes \( A \) y \( B \) sobre \( \Sigma \),
notada \( A \cdot B \) o simplemente \( AB \), se define como
</p>
...
<h3>1️⃣ ¿Qué es la <strong>propiedad asociativa</strong>?</h3>

<p>
La <strong>asociativa</strong> dice <strong>cómo se agrupan</strong>, no <strong>el orden</strong>.
</p>

<p>
Por ejemplo, en una operación <strong>*</strong>:
</p>
...
<p>
👉 Lo importante son los <strong>paréntesis</strong>, no quién va primero o después.
</p>

<p>Ejemplo con suma:</p>

<p>
<code>(2 + 3) + 4 = 2 + (3 + 4)</code>
</p>

<hr>

<h3>2️⃣ ¿Qué propiedad compara <strong>AB</strong> con <strong>BA</strong>?</h3>

<p>
Eso <strong>NO es asociativa</strong>, eso es la <strong>propiedad conmutativa</strong>.
</p>
...
<h3>3️⃣ Entonces, ¿por qué <strong>AB ≠ BA</strong>?</h3>

<p>
Porque estás pensando en <strong>concatenación de símbolos o palabras</strong>, y
<strong>esa operación NO es conmutativa</strong>.
</p>
...
<p>
Pero ojo 👀<br>
Eso <strong>no falla por el alfabeto</strong>, falla porque
<strong>la concatenación depende del orden</strong>.
</p>

<hr>

<h3>4️⃣ ¿La concatenación es asociativa?</h3>
...
<p>
👉 Mismo resultado → <strong>asociativa</strong><br>
👉 Distinto orden → <strong>no conmutativa</strong>
</p>

<hr>

<h3>5️⃣ Resumen corto y claro 🧠</h3>
...
<h3>🔑 Frase para que no se te olvide</h3>

<blockquote>
    <strong>Asociativa = cómo agrupo</strong><br>
    <strong>Conmutativa = a quién pongo primero</strong>
</blockquote>
    </div>
...
<div class="ejemplo">
    ...
    Si \( \Sigma = \{a, b, c\} \),
    \( A = \{ba, bc\} \),
    \( B = \{b^n : n \ge 0\} \), entonces
    <p>
        \( AB = \{bab^n : n \ge 0\} \cup \{bcb^n : n \ge 0\}. \)
        <br>
        \( BA = \{b^nba : n \ge 0\} \cup \{b^nbc : n \ge 0\} \).
    </p>

    <p>
        \( = \{b^{n+1}a : n \ge 0\} \cup \{b^{n+1}c : n \ge 0\} \)
        <br>
        \( = \{b^na : n \ge 1\} \cup \{b^nc : n \ge 1\}. \)
    </p>
</div>

<p>
<b>Propiedades de la concatenación de lenguajes.</b>
Sean \( A, B, C \) lenguajes sobre \( \Sigma \), es decir,
\( A, B, C \subseteq \Sigma^* \). Entonces:
</p>

<ol>
    <li>
        \( A \cdot \varnothing = \varnothing \cdot A = \varnothing. \)
    </li>
    <li>
    ...
    <li>
        <b>Distributividad</b> de la concatenación con respecto a la unión:
        <div class="formula-centro">
    ...
    <li>
        <b>Propiedad distributiva generalizada.</b>
        Si \( \{B_i\}_{i \in I} \) es una familia cualquiera de lenguajes
        sobre \( \Sigma \), entonces
        <div class="formula-centro">
            \( A \cdot \bigcup_{i \in I} B_i
            = \bigcup_{i \in I} (A \cdot B_i), \)
            <br>
            \( \left(\bigcup_{i \in I} B_i\right) \cdot A
            = \bigcup_{i \in I} (B_i \cdot A). \)
        </div>
    </li>
</ol>
