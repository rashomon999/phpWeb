...
<p>An alphabet is any non-empty set of symbols.</p>
...
<p>The notion of word has no associated semantics.</p>

<hr>

<h2>String or Word</h2>

<p>A word is a finite sequence of symbols from a given alphabet.</p>
...
<p>
The empty string \( \varepsilon \) represents a word that has 0 symbols, that is, an empty tape.
</p>

<p>
A machine accepts a specific set of words that can be generated from an alphabet.
</p>
...
<p>A language is a particular set of words.</p>
...
<ul>
    <li>
        It is denoted as \( \Sigma^* \) and is also known as the closure.
    </li>
    <li>
...
<ul>
    <li>
        If \( \Sigma = \{a,b,c\} \)
        <br>
        \( \Sigma^* = \{\varepsilon, a, b, c, aa, ab, ac, ba, bb, bc, \dots \} \)
    </li>
    <br>
    <li>
        If \( \Sigma = \{1\} \)
        <br>
        \( \Sigma^* = \{\varepsilon, 1, 11, 111, 1111, \dots \} \)
    </li>
</ul>
...
<ul>
    <li>
        \( \varepsilon \) is always in \( \Sigma^* \) because the empty string can be obtained from any alphabet.
    </li>
    <li>
        For any alphabet \( \Sigma \), \( \Sigma^* \) is infinite because \( \Sigma \) cannot be empty.
    </li>
</ul>
