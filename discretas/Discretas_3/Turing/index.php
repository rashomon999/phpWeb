...
y termina el proceso.
      ...
      <h2>Construir una MT que acepte \( L = \{a^n b^n,\; n \geq 1\} \)</h2>

  <p>
    Idea: comenzar con la <strong>a</strong> más a la izquierda y convertirla en 
    <strong>c</strong>, luego moverse hacia la derecha hasta encontrar la primera 
    <strong>b</strong> y reemplazarla por <strong>d</strong>. Después, moverse hacia 
    la izquierda hasta encontrar una <strong>c</strong> y repetir el proceso.
  </p>

  <p>
    La máquina realiza la transición a un estado de aceptación únicamente si no quedan 
    <strong>a</strong> ni <strong>b</strong>.
  </p>
    <hr>
