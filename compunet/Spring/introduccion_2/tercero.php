...
<div class="seccion izquierda"> 
    <h5>📦 ¿Es algo solo de Java?</h5>

<p>Sí.</p>

<p>
Los Servlets son exclusivos del ecosistema Java.
</p>

<p>Otros lenguajes tienen sus propias tecnologías equivalentes:</p>
...
<p>
Pero <strong>Servlets es la tecnología base web de Java</strong>.
</p>

<hr>
<h5>🧩 ¿Dónde viven los Servlets?</h5>

<p>
Los Servlets no se ejecutan solos.
</p>

<p>
Necesitan un contenedor que los ejecute, por ejemplo:
...
<ul>
    <li>Crea los servlets</li>
    <li>Maneja el ciclo de vida</li>
    <li>Gestiona peticiones</li>
    <li>Implementa HttpServletRequest y HttpServletResponse</li>
</ul>


 <hr>

<h5>🧠 ¿Qué es exactamente HttpServlet?</h5>

<p>
<code>HttpServlet</code> es una clase que:
</p>

<ul>
    <li>Ya viene con lógica para manejar HTTP</li>
    <li>Tiene métodos como:</li>
</ul>
...
<blockquote>
Mi clase será un servlet HTTP.
</blockquote>

<hr>

<h5>🏛 Entonces tu aplicación realmente es:</h5>
...
<p>
Y encima de eso agregaste <strong>Spring</strong> para manejar los beans.
</p>

<hr>

<h5>🎯 Forma clara de introducirlo en tus apuntes</h5>

<blockquote>
Un Servlet es una tecnología exclusiva de Java que permite crear aplicaciones web del lado del servidor.
Forma parte de la especificación Jakarta EE.
Se ejecuta dentro de un contenedor como Apache Tomcat, que gestiona su ciclo de vida y las peticiones HTTP.
</blockquote>
