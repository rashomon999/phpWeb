...
<ul>
  <li>
    ...
    Proporciona directrices de alto nivel para diseñar mejores aplicaciones de software.
    No ofrecen guías de implementación y no están ligados a ningún lenguaje de programación.
    Los principios <strong>SOLID</strong> (
    Single Responsibility Principle (SRP),
    Open/Closed Principle (OCP), 
    Liskov Substitution Principle (LSP), 
    Interface Segregation Principle (ISP), 
    Dependency Inversion Principle (DIP)) son uno de los conjuntos más populares de principios de diseño.
  </li>
    <br>
  <li>
    <strong>Patrón de Diseño:</strong>
    Proporciona soluciones de bajo nivel relacionadas con la implementación de problemas comunes en la programación orientada a objetos.
    En otras palabras, un patrón de diseño sugiere una implementación específica para un problema concreto de programación orientada a objetos.
...
<div style="width: 600px; font-family: Arial, sans-serif; border: 2px solid #ccc;">
  ...
  <div style="display:flex; background:#2f5d8a; color:white; padding:12px;">
    ...
    <div style="width:120px; text-align:center; font-weight:bold;">Principle</div>
  </div>
...
<ul>
  <li>
    ...
    separa la lógica de la aplicación en tres componentes con responsabilidades únicas.
  </li>

  <li>
    <strong>Framework de Inyección de Dependencias (DI):</strong>
    te permite inyectar dependencias en tus clases o módulos en lugar de crearlas internamente, reduciendo el acoplamiento y aumentando la cohesión.
  </li>

  <li>
    <strong>Framework de Desarrollo Guiado por Pruebas (TDD):</strong>
    fomenta escribir pruebas antes del código para ayudar a seguir el principio de responsabilidad única (SRP) y refactorizar el código para lograr mayor cohesión y menor acoplamiento.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Spring se enfoca en la “infraestructura” (plumbing) de las aplicaciones empresariales
...
<ul>
  <li>
    ...
    <ul>
      <li>Crea objetos y los pone a disposición de tu aplicación.</li>
      <li>
  ...
  <li>
    ...
    <ul>
      <li>
        Proporciona una infraestructura de clases que facilita la realización de tareas.
      </li>
      <li>
  ...
  <li>
    ...
    <ul>
      <li>
        ...
        Un framework MVC similar a Struts, pero más potente y fácil de usar.
      </li>

      <li>
        <strong>Capa de Negocio:</strong>
        Contenedor IoC ligero y soporte para AOP.
      </li>

      <li>
        <strong>Capa de Persistencia:</strong>
        Soporte de plantillas DAO para ORMs populares y JDBC.
      </li>
    </ul>
  </li>
</ul>
...
<ul>
  <li>
    ...
    deben crearse mediante reglas definidas, por ejemplo, en clases factory y/o
    archivos de configuración.
  </li>

  <li>
    Posteriormente, el código de tu aplicación no conecta directamente los componentes
    de implementación entre sí, sino que utiliza abstracciones, como interfaces,
...
<ul>
  <li>
    La inyección de dependencias es un patrón utilizado para crear instancias de objetos
    que delegan responsabilidades a otros objetos. Sin embargo, en tiempo de compilación,
    la “clase llamadora” no tiene conocimiento de la implementación concreta de la clase
    de la dependencia a la que delegará en tiempo de ejecución. Esto se debe a que el código
    de la clase delegadora está programado en función de la abstracción de la interfaz de la clase delegada.
  </li>

  <li>
    Con Spring, la implementación de la inyección de dependencias puede lograrse
    mediante técnicas de inyección por <em>setter</em> y/o por constructor.
  </li>
</ul>
...
<div style="font-family: Arial, sans-serif; max-width: 900px;">
  ...
  <div style="
    ...
    margin-bottom:10px;
  ">
    <div style="background:#3e4a5e; color:white; padding:20px; text-align:center;">Spring Core</div>
    <div style="background:#3e4a5e; color:white; padding:20px; text-align:center;">Spring MVC</div>
    <div style="background:#3e4a5e; color:white; padding:20px; text-align:center;">Spring Persistencia</div>

    <div style="background:#3e4a5e; color:white; padding:20px; text-align:center;">Spring Security</div>
    <div style="background:#3e4a5e; color:white; padding:20px; text-align:center;">Spring Cloud</div>
    <div style="background:#3e4a5e; color:white; padding:20px; text-align:center;">Otros proyectos Spring</div>
  </div>
...
<ul>
    <li>
        <strong>Core y Beans:</strong> estos módulos proporcionan características de IOC e inyección de dependencias.
    </li>
    <li>
        <strong>Context:</strong> este módulo soporta internacionalización (I18N), EJB y JMS.
    </li>
    <li>
        <strong>Lenguaje de Expresiones:</strong> es una extensión del EL definido en JSP. Proporciona soporte para establecer y obtener valores de propiedades e incluso para la invocación de métodos.
    </li>
    <li>
        <strong>AOP, Aspectos e Instrumentación:</strong> estos módulos soportan la implementación de programación orientada a aspectos, donde se pueden usar Advices y Pointcuts.
    </li>
    <li>
        <strong>Aspectos:</strong> el módulo de aspectos proporciona soporte para la integración con AspectJ.
    </li>
    <li>
        <strong>Acceso a Datos / Integración:</strong> estos módulos básicamente proporcionan soporte para interactuar con la base de datos.
    </li>
    <li>
        <strong>Web:</strong> este grupo proporciona soporte para crear aplicaciones web.
    </li>
</ul>
...
<ul>
    <li>
        <strong>API del programador (ApplicationContext):</strong>
...
<ul>
    <li>
        Define cómo los <strong>beans</strong> están relacionados entre sí.
    </li>
    <li>
        Puede realizarse usando <strong>XML, Anotaciones o Java</strong>.
    </li>
</ul>

<h3>Representación de objetos de la configuración</h3>
<ul>
    <li>
        <strong>BeanDefinitions:</strong> cada bean tiene una definición con un identificador.
    </li>
</ul>
...
<ul>
    <li>
        Actúa como un <strong>caché de instancias de clases</strong> creadas a partir de las BeanDefinitions.
    </li>
</ul>



<h2>Spring conecta los Beans (instancias de clases)</h2>
<p><em>El código de “plomería” lo hace Spring por ti</em></p>

<table>
    <tr>
        <td style="text-align:center; vertical-align:top;">
            <h3>Sin Spring</h3>
            <p>Tú ensamblas el producto manualmente</p>
            <img src="../../../img/guia_347.png" alt="Ensamblaje manual sin Spring" width="250">
        </td>

        <td style="text-align:center; vertical-align:top;">
            <h3>Usando Spring</h3>
            <p>
                <strong>|</strong> Spring ensambla el producto por ti mediante la configuración
                y lo deja listo para usar
            </p>
            <img src="../../../img/guia_348.png" alt="Producto ensamblado usando Spring" width="250">
        </td>
    </tr>
</table>

<h2>Contenedores IoC de Spring</h2>

<ul>
    <li>
        Los contenedores de Spring forman el núcleo del framework Spring.
    </li>
    <li>
        El contenedor instancia, configura y ensambla las dependencias entre los objetos.
    </li>
    <li>
        El contenedor IoC construye un objeto de la clase seleccionada.
    </li>
    <li>
        Además, inyecta los objetos de dependencia:
        <ul>
            <li>mediante un constructor,</li>
            <li>mediante una propiedad, o</li>
            <li>mediante un método,</li>
        </ul>
        todo esto en tiempo de ejecución y libera los recursos en el momento adecuado.
    </li>
</ul>
<img src="../../../img/guia_349.png" alt="Producto ensamblado usando Spring" width="450">
