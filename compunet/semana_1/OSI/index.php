...
<div class="seccion izquierda"> 
 ...
 <p><b>TEMA 2 — EL MODELO OSI</b></p>
    ...
    <p>
    El Modelo de interconexión de sistemas abiertos (OSI) se utiliza para describir protocolos de red. Debido a que 
    rara vez se implementa en redes reales, se considera una referencia para estandarizar el desarrollo de las redes 
    reales. OSI fue la primera definición abierta no propietaria para redes.
    </p>

    <p>
    El modelo OSI define grupos de funcionalidad requeridos para los equipos de la red en capas, donde cada capa 
    implementa un protocolo estándar para su funcionalidad. Hay siete capas del modelo OSI, que se muestran en la 
    figura 3.2
    </p>

    <div class="osi-container">
        <div class="title">Figura 3.2—Las capas de OSI</div>
        <div class="layer">7. Aplicación</div>
        <div class="layer">6. Presentación</div>
        <div class="layer">5. Sesión</div>
        <div class="layer">4. Transporte</div>
        <div class="layer">3. Red</div>
        <div class="layer">2. Enlace de datos</div>
        <div class="layer">1. Físico</div>
    </div>
    ...
    <ul>
    <li><b>La capa física (Capa 1)</b> — Gestiona señales entre los sistemas de red</li>
    <li><b>La capa de enlace de datos (Capa 2)</b> — Divide los datos en tramas que pueden ser transmitidas 
    por la capa física</li>
    <li><b>La capa de red (Capa 3)</b> — Traduce direcciones de red y dirige los datos del emisor al receptor</li>
    <li><b>La capa de transporte (Capa 4)</b> — Asegura que los datos se transfieren de forma fiable en la 
    secuencia correcta</li>
    <li><b>La capa de sesión (Capa 5)</b> — Coordina y gestiona las conexiones de usuario</li>
    <li><b>La capa de presentación (Capa 6)</b> — Da formato, cifra y comprime los datos</li>
    <li><b>La capa de aplicación (Capa 7)</b> — Media entre aplicaciones de software y otras capas de 
    servicios de red</li>
    </ul>
...
a partir de un protocolo de enlace de tres vías (<i>three-way handshake</i>), y por lo tanto son orientadas a conexión, tal y como se
...
<ul>
  ...
  <li>Cada capa agrega su propia <strong>información de control</strong> para que los datos lleguen completos y a la persona correcta.</li>
</ul>
<p>
