...
<div class="seccion izquierda"> 
    ...
    <p>Al calcular subnets, se debe usar el siguiente proceso. Cada paso del proceso se describirá en detalle más adelante 
    en este documento:</p>
    <ol>
    <li>Determinar el espacio de direcciones IP asignado.</li>
    <li>Determinar el número de subnets requeridas en función del diseño de la red existente, junto con la estructura de 
    la organización. Es común asignar una subnet a cada departamento dentro de la organización.</li>
    <li>Con base en la clase del espacio de direcciones IP y el número de subnets requeridas, determinar cuántos bits de 
    host deben ser tomados prestados. También determinar cuántos hosts puede soportar cada subnet.</li>
    <li>Calcular el valor decimal y el valor de prefijo de la nueva máscara de subred.</li>
    <li>Aplicar la máscara de subred al espacio de direcciones IP asignado para calcular la dirección de red de las nuevas 
    subnets posibles, la dirección de broadcast para cada subnet posible, y el rango de direcciones IP utilizables en cada 
    subnet posible.</li>
    <li>Asignar direcciones IP a todos los dispositivos, incluyendo las interfaces de router que estén conectadas a esa 
    subnet.</li>
    </ol>
  ...
  <table border="1" cellspacing="0" cellpadding="5">
    ...
    <tr><td>1</td><td>2<sup>1</sup></td><td>
    <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>">
    </td><td>12</td><td>2<sup>12</sup></td><td>
    <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>">    
    </td></tr>
    <tr><td>2</td><td>2<sup>2</sup></td><td>
    <input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>">
    </td><td>13</td><td>2<sup>13</sup></td><td>
    <input type="text" name="respuesta_4" value="<?php echo $respuesta_4; ?>">
    </td></tr>
    <tr><td>3</td><td>2<sup>3</sup></td><td>
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>">
    </td><td>14</td><td>2<sup>14</sup></td><td>
    <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>">
    </td></tr>
    <tr><td>4</td><td>2<sup>4</sup></td><td>
    <input type="text" name="respuesta_7" value="<?php echo $respuesta_7; ?>">
    </td><td>15</td><td>2<sup>15</sup></td><td>
    <input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>">
    </td></tr>
    <tr><td>5</td><td>2<sup>5</sup></td><td>
    <input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>">
    </td><td>16</td><td>2<sup>16</sup></td><td>
    <input type="text" name="respuesta_10" value="<?php echo $respuesta_10; ?>">
    </td></tr>
    <tr><td>6</td><td>2<sup>6</sup></td><td>
    <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>">
    </td><td>17</td><td>2<sup>17</sup></td><td>
    <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>">
    </td></tr>
    <tr><td>7</td><td>2<sup>7</sup></td><td>
    <input type="text" name="respuesta_13" value="<?php echo $respuesta_13; ?>">
    </td><td>18</td><td>2<sup>18</sup></td><td>
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>">
    </td></tr>
    <tr><td>8</td><td>2<sup>8</sup></td><td>
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>">
    </td><td>19</td><td>2<sup>19</sup></td><td>
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>">
    </td></tr>
    <tr><td>9</td><td>2<sup>9</sup></td><td>
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>">
    </td><td>20</td><td>2<sup>20</sup></td><td>
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>">
    </td></tr>
    <tr><td>10</td><td>2<sup>10</sup></td><td>
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>">
    </td><td>21</td><td>2<sup>21</sup></td><td>
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>">
    </td></tr>
    <tr><td>11</td><td>2<sup>11</sup></td><td>
    <input type="text" name="respuesta_21" value="<?php echo $respuesta_21; ?>">
    </td><td>22</td><td>2<sup>22</sup></td><td>
    <input type="text" name="respuesta_22" value="<?php echo $respuesta_22; ?>">
    </td></tr>
  </table>
...
<div class="seccion derecha">
  ...
  <ol>
    ...
    <li>Reescribir la fórmula como <b>2<sup>h</sup> - 2 &gt; (número de hosts requeridos)</b>, donde <i>h</i> es el número de bits de host que deben guardarse.</li>
    <li>Resolver para <i>h</i>, encontrando el exponente de 2 cuyo valor sea lo más cercano posible al número de hosts requeridos sin quedar por debajo. Ese exponente es el valor de <i>h</i>.</li>
    <li>Todos los demás bits que no se guardan como bits de host se convierten en bits de red. Use la siguiente fórmula para determinar cuántos bits de host se dan a la porción de red: <b>(Número de Bits de Host Disponibles) - h</b>.</li>
    <li>Calcular la nueva máscara de subred y el prefijo.</li>
  </ol>

  <h2>Concepto de guardar bits de host</h2>
  <p>Comprender el concepto de guardar bits de host es crítico. Recuerde, los bits de host son siempre los bits más a la derecha de la dirección IP. Entonces, al guardar bits de host, comience con el bit más a la derecha (el último bit del último octeto) y cuente hacia la izquierda. Los bits de host restantes se dan a la porción de red.</p>
