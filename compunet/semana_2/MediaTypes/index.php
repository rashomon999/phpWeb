...
<div class="seccion izquierda"> 
    ...
    <a class="btn btn-primary btn-lg" href="./explicacion.php" role="button">intro,explicaciones</a>

    <h3>Tipos de medios: conectando todo junto</h3>

    <p>Aunque probablemente eres más que consciente de que la mayoría de las redes están cableadas, debes tener en cuenta 
    que no todos los estándares de cableado son iguales. Si lo fueran, solo necesitaríamos uno. Tal como está, todavía 
    hay numerosos estándares diferentes en operación, desde cables heredados que funcionan a 10 Mbps hasta fibra de 
    alta velocidad que opera a más de 40 Gbps. Como ingeniero de redes, es imperativo que entendamos los casos de uso y 
    las limitaciones de las diversas opciones de cableado disponibles para nosotros.</p>

    <p>Este capítulo seguirá la progresión del cableado desde los cables coaxiales, pasando por los cables de par trenzado, 
    hasta los cables de fibra óptica, todo mientras explica las características de cada uno, incluidos sus conectores y 
    sus usos.</p>

    <p>Los siguientes temas se cubrirán en este capítulo:</p>

    <ul>
    <li>Comprender los cables coaxiales y sus tipos</li>
    <li>Comprender los cables de par trenzado y sus tipos</li>
    <li>Comprender los cables de fibra óptica y sus tipos</li>
    </ul>
    ...
    <h3>Comprender los cables coaxiales y sus tipos</h3>

    <p>Recuerdo cuando estaba aprendiendo sobre redes en el año 2000 y se introdujeron los cables coaxiales. Pensé para 
    mí mismo: nadie va a usar eso por mucho tiempo más. Para mí, era una tecnología anticuada que estaba siendo reemplazada. 
    Sin embargo, todavía está aquí. Ha resistido la prueba del tiempo y se utiliza en redes, audio y video.</p>

    <p>Un cable coaxial consiste en un núcleo de cobre rodeado por un aislante. Este, a su vez, está rodeado por un escudo 
    de cobre trenzado que está encerrado en una cubierta plástica exterior. Esto puede verse en el siguiente diagrama:</p>


    <img src="../../../img/guia_86.png" alt="">

    <p>Uno de los problemas al usar cobre para transmitir datos es que emite un campo electromagnético y también puede verse 
    afectado por campos electromagnéticos externos generados por otros objetos cercanos, incluidos otros cables de red. 
    Dicho simplemente, cuando se aplica voltaje a un cable conductor, se genera un campo electromagnético, que puede 
    afectar otros sistemas eléctricos en proximidad cercana. Cuando hace esto, se le denomina interferencia electromagnética 
    (EMI, Electromagnetic Interference).</p>

    <p>La EMI puede ser un problema importante en redes que usan cable de cobre, y por lo tanto, cómo se colocan los cables 
    debe pensarse cuidadosamente. Las principales fuentes de EMI que pueden afectar tu red incluyen luces fluorescentes 
    y maquinaria de ascensores. El escudo de cobre trenzado actúa para prevenir estos campos magnéticos. Ayuda a mantener 
    la señal de datos interna dentro de los límites del cable y proporciona protección contra campos electromagnéticos 
    externos.</p>


    <p>Debe tenerse en cuenta que el escudo no protegerá el cable al 100%, y puede ocurrir cierta fuga e interferencia 
    con los datos.</p>

    <p>Existen dos tipos principales de cable coaxial en uso en redes. Estos son 10base5 y 10base2. Estos nombres 
    siguen una convención de nomenclatura que aproximadamente sigue esta sintaxis:</p>

    <p>&lt;velocidad&gt;&lt;tipo de señal&gt;&lt;medio&gt;</p>

    <p>A partir de esto, podemos ver que ambos tienen una velocidad de 10 Mbps y usan el tipo de señalización de 
    banda base. La banda base utiliza el ancho de banda disponible para una señal. Otro término que escucharás es 
    banda ancha. La banda ancha divide el ancho de banda disponible entre múltiples señales.</p>
    ...
    <p>10base5 se conoce como thicknet
    (red gruesa)    
    . Utiliza cableado RG-8 y puede tener una longitud máxima de 500 m. Si lo hicieras 
...
<div class="seccion derecha">
    ...
    <p>En contraste, 10base2 se conoce como thinnet. Utiliza cableado RG-58 y puede tener una longitud máxima de 185 m. 
    ...
    una variante del cableado de par trenzado, mientras que RJ-45 se refiere al tipo de conector que se usa con un cable 
    de par trenzado.</p>
