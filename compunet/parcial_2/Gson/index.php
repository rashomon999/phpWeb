...
<div class="seccion izquierda"> 
    ...
    <h3>🧩 fromJson() y toJson() en Gson</h3>

<p>Estos dos métodos son las dos caras de la misma moneda:</p>
...
<table border="1" cellpadding="5">
  ...
  <tr>
    <td><strong>fromJson()</strong></td>
    <td>📥 JSON → Objeto Java</td>
    <td>Convierte un texto JSON en un objeto Java</td>
  </tr>
  <tr>
    <td><strong>toJson()</strong></td>
    <td>📤 Objeto Java → JSON</td>
    <td>Convierte un objeto Java en texto JSON</td>
  </tr>
</table>

<h3>🧭 1️⃣ fromJson()</h3>
<p><strong>🔹 Sintaxis:</strong></p>
<p><strong>gson.fromJson(jsonString, Clase.class)</strong></p>

<p><strong>🔹 Qué hace:</strong></p>
<p>Toma un texto JSON y crea una instancia Java de la clase que le indiques.</p>

<p><strong>Ejemplo:</strong></p>
<pre>
String json = "{\"nombre\":\"Luis\",\"edad\":25}";
Persona p = gson.fromJson(json, Persona.class);
</pre>

<p>Si tienes esta clase:</p>
<pre>
class Persona {
    String nombre;
    int edad;
...
<p>Entonces después de esa línea:</p>
<p><strong>p.nombre → "Luis"<br>p.edad → 25</strong></p>

<p>✅ Gson leyó el JSON, encontró las claves <strong>"nombre"</strong> y <strong>"edad"</strong>, y las asignó a los campos de la clase.</p>

<h3>2️⃣ toJson()</h3>
<p><strong>🔹 Sintaxis:</strong></p>
<p><strong>gson.toJson(objetoJava)</strong></p>

<p><strong>🔹 Qué hace:</strong></p>
<p>Toma un objeto Java y lo convierte en un texto JSON.</p>
