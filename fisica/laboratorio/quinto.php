...
<div class="seccion izquierda">
    ...
    <strong>2-9 Método General para la Incertidumbre en Funciones de Dos o Más Variables</strong>
    ...
    \[
    dz = \frac{\partial f}{\partial x} dx + \frac{\partial f}{\partial y} dy \quad \text{(2-2)}
    \]
    ...
    z = xy
    \]
    Para usar la ecuación (2-2), necesitamos los valores de \( \frac{\partial z}{\partial x} \) y \( \frac{\partial z}{\partial y} \). Estos son:
    \[
    ...
    <p>
    El caso más general de una función compuesta, que se encuentra muy comúnmente en la física, implica un producto algebraico que tiene componentes elevadas a diferentes potencias. Sea:
    \[
    z = x^a y^b
    \]
    ...
    \]
    Nótese que este proceso da la incertidumbre relativa de manera directa, y eso con frecuencia es conveniente. Si se requiere la incertidumbre absoluta \( \delta z \), se puede evaluar simplemente multiplicando la incertidumbre relativa por el valor calculado \( z_0 \), que normalmente está disponible.
    </p>

    <p>
    Esta forma de diferenciación implícita sigue siendo el procedimiento más sencillo, aun cuando la misma \( z \) esté elevada a alguna potencia. Porque, si la ecuación es:
    \[
    z^2 = xy
    \]
