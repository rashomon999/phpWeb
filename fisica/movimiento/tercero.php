...
if ($_POST) {
   ...
   if ($respuesta_11 === '180') {  
     ...
     if ($respuesta_16 === 'xi+vit+\frac{1}{2}at^2' ||
     $respuesta_16 === 'xi+vit+\frac{1}{2}at^{2}') {  
...
<div class="seccion izquierda">
    ...
    <p>
    5) Un automóvil viaja por un camino y las lecturas de su odómetro se grafican contra
    el tiempo en la fi gura 1. Encuentre la rapidez instantánea del vehículo en los
    puntos A y B. ¿Cuál es la rapidez promedio del automóvil?
    <br><br>
    <img src="..\..\img\distancia_tiempo.jpeg" alt="">
    <br><br>
    rapidez instantanea en A: <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="8">m/s
    <br><br>
    rapidez instantanea en B: <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="8">m/s
    <br><br>
    rapidez promedio del automovil:
    <input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>" size="8">m/s    
    </p>
    Esto ocurre porque en el MRU la 
    ...
    <hr>
    6) Un muchacho está a 6.00 m de la base de una asta bandera de 8.00 m de altura.
    Determine la magnitud del desplazamiento del águila de bronce en la punta de la
    asta con respecto a los pies del joven.
    <br><br>
    <input type="text" name="respuesta_5" value="<?php echo $respuesta_5; ?>" size="8">m
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo  $verificar_5 ?>
    <hr>
    7) Un corredor da una vuelta por una pista de 200 m en un tiempo de 25 s. ¿Cuáles
    son :
    <br><br>
    a) la rapidez promedio 
    <input type="text" name="respuesta_6" value="<?php echo $respuesta_6; ?>" size="8">m/s
    <br><br>
    b) la velocidad promedio del corredor?
    <input type="text" name="respuesta_7" value="<?php echo $respuesta_7; ?>" size="8">m/s
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo  $verificar_6 ?>
    <?php echo  $verificar_7 ?>
    <hr>
    9) Encuentre las componentes x y y de un desplazamiento de 25.0 m con un ángulo de
    210.0°.
    <br><br>
    El seno de 210° es igual al seno de 
    <input type="text" name="respuesta_8" value="<?php echo $respuesta_8; ?>" size="2">
    °, pero negativo porque está en el tercer cuadrante
    <br><br>
    <input type="text" name="respuesta_9" value="<?php echo $respuesta_9; ?>" size="2">=
    Sin(210)25 = -12.5.
    <br><br>
    ...
    <br><br>
    ¡Exacto! Para cualquier ángulo en el tercer cuadrante (180° a 270°), podemos restarle 
    <input type="text" name="respuesta_11" value="<?php echo $respuesta_11; ?>" size="2">
    °para encontrar su ángulo de referencia.
    <br><br>
    <button type="submit">Enviar</button>
    ...
    <li>En el primer cuadrante (0° a 90°), tanto seno como coseno son positivos.</li>
    <li>En el segundo cuadrante (90° a 180°), el seno sigue siendo positivo, pero el coseno es negativo.</li>
    <li>En el tercer cuadrante (180° a 270°), tanto seno como coseno son negativos.</li>
    <li>En el cuarto cuadrante (270° a 360°), el coseno es positivo y el seno es negativo.</li>
...
<div class="seccion derecha">
    <form action="./tercero.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
    Los triangulos que se forman el circulo unitario para usar cos, sin, deben ser siempre con angulo 
    <input type="text" name="respuesta_12" value="<?php echo $respuesta_12; ?>" size="8">.
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo  $verificar_12 ?>
    <br><br>
    Siempre se forma el triángulo rectángulo tomando como referencia el eje X.
    <hr>
    La magnitud siempre es 
    ...
    <hr>
    <strong>Formulas MRUA: </strong>
    <span id="formula">
    \( Vf =  \)
    </span> 
    <br><br>
    <input type="text" name="respuesta_14" value="<?php echo $respuesta_14; ?>" size="30"
    id="respuesta_14" oninput="actualizarFormula()">
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_14 ?>
    <hr>
    ¿Cuándo rapidez y velocidad son lo mismo en MRUA?
    <br><br>
    Si el movimiento es en línea 
    <input type="text" name="respuesta_15" value="<?php echo $respuesta_15; ?>" size="8">.
    y en una sola dirección (por ejemplo, solo hacia la derecha o solo hacia arriba),
    rapidez y velocidad tienen el mismo valor numérico.
    <br><br>
    <button type="submit">Enviar</button>
    ...
    <br><br>
    <input type="text" name="respuesta_16" value="<?php echo $respuesta_16; ?>" size="30"
    id="respuesta_16" oninput="actualizarFormula2()">
    <br><br>
    <button type="submit">Enviar</button>
    ...
    La formula anterior puede hacer referencia a la distancia 
    ...
    <hr>
    3) Un objeto parte del reposo con una aceleración constante de \( 8.00 m/s^2 \) a lo largo de una línea
    recta.
    <br><br>
    cual es la velocidad inicial:
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="8">m/s
    <br><br>
    ...
    <hr>
    Estas graficas son de (Siglas): <br><br>
    <img src="..\..\img\graficas_velocidad.jpeg" alt="" width="400"> <br><br>
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="8">
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_20 ?>
    <hr>
    En el MRU la acelelarcion es  <br><br>
    <input type="text" name="respuesta_21" value="<?php echo $respuesta_21; ?>" size="8">
    <br><br>
    En el MRUA la aceleracion es 
    <br><br>
