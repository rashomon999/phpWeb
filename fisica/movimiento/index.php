...
<div class="seccion izquierda">
    <strong>Introduccion: </strong> <br><br>
    ...
    , así como de los conceptos relacionados
    de 
    ...
    ; y dinámica, que trata con el concepto de 
    ...
    <hr>
    movimiento de 
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="8">: <br>
    <img src="..\..\img\rotacion.jpeg" alt=""> 
    <br>
    Ocurre cuando un objeto gira alrededor de un eje fijo o móvil.
    <br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_17 ?>
    <hr>
    movimiento de 
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="8"> <br>
    <img src="..\..\img\vibracion.jpeg" alt=""><br>
    Ocurre cuando un objeto oscila alrededor de una posición de equilibrio, experimentando
    desplazamientos repetitivos en un intervalo de tiempo.
    <br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_18 ?>
    <hr>
    movimiento de 
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="8"> <br>
    <img src="..\..\img\traslacion.jpeg" alt=""> <br><br>
    Ocurre cuando un objeto se desplaza sin girar ni oscilar.
    <br>
    <button type="submit">Enviar</button>
...
<div class="seccion derecha">
    <strong>Concepto particula</strong>: 
    <form action="./index.php" method="POST" onsubmit="handleSubmit(event)" autocomplete="off">
    Un 
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="8"> <br>
    cualquiera puede 
    ...
    .
    <br><br>
    A menudo usaremos el concepto, o modelo, de partícula idealizada, que se considera como 
    un punto matemático sin extensión espacial (sin tamaño). Una partícula
    puede tener sólo movimiento traslacional. El modelo de partícula es útil en muchas 
    situaciones reales, donde nos interesa sólo un movimiento traslacional y no es
    importante el tamaño del objeto. 
    <br>
    <button type="submit">Enviar</button>
    ...
    de una partícula se conoce por 
    ...
    .
    <br><br>
    <strong>Vector posicion: </strong>
    <p>Si un objeto se ubica en un 
    ...
    , podemos denotar este punto con 
    su <strong>vector de posición</strong>. 
    Una notacion es el símbolo <span>\(\vec{r}\)</span>  para denotar el
    ...
    <br><br>
    <p>
    La posición de un objeto puede cambiar como función del tiempo, t; es decir, el objeto se
    puede mover.
    
    Por lo tanto, podemos escribir de manera formal el <strong>vector de posición</strong> en notación de función:</p>

    \(
    \vec{r} = \vec{r}(t)
    \)

    <p>En una dimensión, esto significa que el componente \( x \) del vector es una función del tiempo:</p>

    \(
    x = x(t)
    \)

    <p>Si deseamos especificar la posición en algún tiempo específico \( t_1 \), usaremos la notación:</p>
    ...
    <hr>
    <p>El <strong>desplazamiento</strong> es simplemente la diferencia entre el vector de posición 
    <input type="text" name="respuesta_38" value="<?php echo $respuesta_38; ?>" size="8">    

    , 
    \( \vec{r}_2 \equiv \vec{r}(t_2) \), al final de un movimiento, y el vector de posición 
    <input type="text" name="respuesta_39" value="<?php echo $respuesta_39; ?>" size="8">    

    , 
    \( \vec{r}_1 \equiv \vec{r}(t_1) \).</p>

    <p>Escribimos el <strong>vector de desplazamiento</strong> como:</p>

    \(
    \Delta \vec{r} = \vec{r}_2 - \vec{r}_1
    \)
    <br>
    En notacion de 1 dimencion: <br>
    \( \Delta_x =  \)
    ...
    Considere, por ejemplo, a los jugadores de baloncesto de la Figura 2.2. 
    Si un jugador corre desde la canasta de 
    su propio equipo a lo largo de la cancha hasta la canasta del otro equipo y luego regresa 
    a su propia canasta, el  desplazamiento del jugador durante este intervalo 
    de tiempo es 
    <input type="text" name="respuesta_44" value="<?php echo $respuesta_44; ?>" size="8">     
    porque terminó en el mismo punto del que partió:

    \(
    x_f - x_i = \)
    <input type="text"  value="<?php echo $respuesta_44; ?>" size="8">     
    ...
    Sin embargo, durante este intervalo, el jugador se movió a lo largo de una distancia equivalente 
    al doble de la longitud de la cancha de baloncesto.  

    La \textbf{distancia} siempre se representa como un número positivo, mientras que el \textbf{desplazamiento} 
