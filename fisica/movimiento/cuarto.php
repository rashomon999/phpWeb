...
<div class="seccion izquierda">
    ...
    <p>
    7) Se deja caer una pelota, inicialmente en reposo, desde una altura de 50 m sobre el nivel del
    suelo. a) ¿Cuál será la rapidez de la pelota justo en el momento anterior al choque contra el
    suelo? b) ¿Cuánto tiempo requiere para llegar al suelo?
    </p>
    Formula rapidez para el punto a): 
    <br>
    <span id="formula">
    \( V^2y =  \)
    </span> 
    <br><br>
    <input type="text" name="respuesta_1" value="<?php echo $respuesta_1; ?>" size="30"
    id="respuesta_1" oninput="actualizarFormula()">
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_1 ?>
    <hr>
    Este problema es sobre 
    <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>" size="8">
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_2 ?>
    <hr>
    La altura final y es = 
    <input type="text" name="respuesta_3" value="<?php echo $respuesta_3; ?>" size="8">
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_3 ?>
    <hr>
    dentro de que tema cae el problema:
    <p>
    12) Una piedra se lanza verticalmente hacia arriba y se eleva a una altura de 20 m. ¿Con qué rapidez
    se lanzó?
    </p>
    ...
    <br><br>
    cual es la rapidez inicial \( V_{y0} \)
