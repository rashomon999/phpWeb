...
<div class="seccion izquierda">
    ...
    <h4>2. Cuando \( D_{\vec{u}}f(a,b) \) es máximo</h4>
  <p>Esto sucede cuando \( \vec{u} \) apunta en la misma dirección que el gradiente:</p>
  <p>\[
    \vec{u} = \frac{(4,3)}{5} = \left( \frac{4}{5}, \frac{3}{5} \right)
  \]</p>

  <h4>3. Cuando \( D_{\vec{u}}f(a,b) \) es mínimo</h4>
  <p>Esto ocurre cuando \( \vec{u} \) es opuesto al gradiente:</p>
  <p>\[
    \vec{u} = -\frac{(4,3)}{5} = \left( -\frac{4}{5}, -\frac{3}{5} \right)
  \]</p>
  ...
  <h3>📘 Ejercicio:</h3>
  <p>
    Dada la temperatura \( T(x,y) = 4x^2 + y^2 \), ¿en qué dirección debe moverse un insecto en el punto \( (1,2) \) para enfriarse más rápidamente?
  </p>

  <h4>✅ Paso 1: Gradiente de la función</h4>
  <p>
    El gradiente de \( T \) es:
  </p>
  <p>
    \[
    \nabla T(x, y) = \left( \frac{\partial T}{\partial x}, \frac{\partial T}{\partial y} \right) = (8x, 2y)
    \]
  </p>
  <p>
    Evaluamos en \( (1,2) \):
  ...
  <h4>✅ Paso 2: Dirección de enfriamiento más rápido</h4>
  <p>
    Para enfriarse más rápido, el insecto debe moverse en la dirección opuesta al gradiente:
  </p>
  <p>
    \[
    -\nabla T(1,2) = (-8, -4)
  ...
  <p>
    Pero una dirección debe expresarse como un <strong>vector unitario</strong> (con longitud 1), así que normalizamos:
  </p>
  <p>
    \[
  ...
  <p>
    \[
    \vec{u} = \left( \frac{-8}{4\sqrt{5}}, \frac{-4}{4\sqrt{5}} \right) = \left( \frac{-2}{\sqrt{5}}, \frac{-1}{\sqrt{5}} \right)
    \]
  </p>

  <h4>🎯 Respuesta final:</h4>
  <p>
    El insecto debe moverse en la dirección:
  </p>
  <p>
    \[
    \boxed{ \left( \frac{-2}{\sqrt{5}}, \frac{-1}{\sqrt{5}} \right) }
    \]
  </p>
</div>
