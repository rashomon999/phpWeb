...
if ($_POST) {
    ...
    $respuesta_1 = 'Ip% periodica';
    $respuesta_2 = 'nominal anual';
    $respuesta_3 = 'Efectiva anual';
    $respuesta_4 = 'Ip% periodica anticipada';
    $respuesta_5 = 'int% periodica vencida';
    $respuesta_6 = 'Ip% vencida';
    $respuesta_7 = 'Efectiva Anual';
    $respuesta_8 = 'Efectiva anual';
    $respuesta_9 = 'periodica';
    $respuesta_10 = 'tasa vencida';
    $respuesta_11 = 'efectivas anticipadas';
    $respuesta_12 = 'son vencidas';

    $respuesta_13 = 'Interes Compuesto';
    $respuesta_14 = 'negociacion';
    $respuesta_15 = 'periodicidad';
    $respuesta_16 = 'consistente';
    $respuesta_17 = 'VP';
    $respuesta_18 = 'VF';
    $respuesta_19 = 'Ip%';
    $respuesta_20 = '0%';
    $respuesta_21 = 'presenta ganancias';
    $respuesta_22 = 'VP';

    $respuesta_23 = 'VF';
    $respuesta_24 = 'Ip%';
    $respuesta_25 = '0%';
    $respuesta_26 = 'presenta perdidas';
    $respuesta_27 = 'dinero fija';
    $respuesta_28 = 'inicio';
    $respuesta_29 = 'fin';
    $respuesta_30 = 'repite';
    $respuesta_31 = 'constante';
    $respuesta_32 = 'no se interrumpe';
    $respuesta_33 = 'NO CONTINUA';

    $respuesta_34 = 'unico movimiento';
    $respuesta_35 = 'movimientos no uniformes';
    $respuesta_36 = 'pago de intereses';
    $respuesta_37 = 'abona a capital';
    $respuesta_38 = 'saldo del capital';
    $respuesta_39 = 'se reduzca';
    $respuesta_40 = 'inferiores';
    $respuesta_41 = 'inicio';
    $respuesta_42 = 'vida del credito';
    $respuesta_43 = 'no se realizan pagos';
    $respuesta_44 = 'no se causan intereses';

    $respuesta_45 = 'permanece constante';
    $respuesta_46 = 'inicio';
    $respuesta_47 = 'no se realizan pagos';
    $respuesta_48 = 'CAUSACION';
    $respuesta_49 = 'obligacion aumenta';
   ...
   if ($respuesta_4 === 'Ip% periodica anticipada') {  
   ...
   if ($respuesta_5 === 'int% periodica vencida') {  
   ...
   if ($respuesta_11 === 'efectivas anticipadas') {  
    ...
    if ($respuesta_13 === 'Interes Compuesto') { 
    ...
    if ($respuesta_21 === 'presenta ganancias') {  
   ...
   if ($respuesta_26 === 'presenta perdidas') {  
   ...
   if ($respuesta_32 === 'no se interrumpe') {  
   ...
   if ($respuesta_33 === 'NO CONTINUA') {  
    ...
    if ($respuesta_34 === 'unico movimiento') { 
    ...
    if ($respuesta_35 === 'movimientos no uniformes') { 
    ...
    if ($respuesta_36 === 'pago de intereses') { 
    ...
    if ($respuesta_37 === 'abona a capital') { 
    ...
    if ($respuesta_38 === 'saldo del capital') { 
    ...
    if ($respuesta_42 === 'vida del credito') { 
    ...
    if ($respuesta_43 === 'no se realizan pagos') { 
    ...
    if ($respuesta_44 === 'no se causan intereses') { 
    ...
    if ($respuesta_45 === 'permanece constante') { 
    ...
    if ($respuesta_47 === 'no se realizan pagos') { 
    ...
    if ($respuesta_49 === 'obligacion aumenta') { 
 ...
 ***
  ...
  <p>Que opcion es mas beneficiosa para un inversionista (ahorrador) si el plazo es mayor a un periodo</p>
...
<p>
    <input type="text" name="respuesta_17" value="<?php echo $respuesta_17; ?>" size="2">
      < 
    <input type="text" name="respuesta_18" value="<?php echo $respuesta_18; ?>" size="2">
      con 
    <input type="text" name="respuesta_19" value="<?php echo $respuesta_19; ?>" size="2">
      >
    <input type="text" name="respuesta_20" value="<?php echo $respuesta_20; ?>" size="2">
     . Es decir, el Negocio Financiero
...
<hr>
<p>
<input type="text" name="respuesta_22" value="<?php echo $respuesta_22; ?>" size="2">
  > 
 ...
 <button type="submit">Enviar</button>
  <?php echo $verificar_22 ?>
    ...
    <input type="text" name="respuesta_27" value="<?php echo $respuesta_27; ?>" size="15">    
     , que tiene previsto un momento de 
    ...
    <p>
    Con movimientos del dinero de forma 
    ...
    <p>
    En las cuotas de crédito se realiza el
    <input type="text" name="respuesta_26" value="<?php echo $respuesta_36; ?>" size="15">
  de ese período y se
