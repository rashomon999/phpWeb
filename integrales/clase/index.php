...
if ($_POST) {
   ...
   if ($respuesta_6 === '\frac{1}{2}e^{x^2}+C') {  
...
function actualizarFormula() {
    ...
    var f = document.getElementById('quinto').value || "";
...
function actualizarFormula2() {
    ...
    var f = document.getElementById('sexto').value || "";
...
function mostrarMensaje() {
            ...
            if (mensaje.style.display === 'none' || mensaje.style.display === '') {
                ...
                MathJax.typeset([mensaje]); // Procesa el contenido matemático
            } else {
...
<div class="seccion izquierda">
    ...
    Aproxime el área de la regiómn plana \( R \) acotada superiormente por la gráfica de \( f(x)=2x \), inferiormente
    por el eje \(x\) sobre o en el intervalo \([0,4]\) geometricamente.
    <br><br>
    ...
    <hr>
    ¿Cuántos puntos de evaluación se usan en la regla de la mano izquierda para n subintervalos?
    <input type="text" name="respuesta_2" value="<?php echo $respuesta_2; ?>">
    <br><br>
    ¿Cuántos puntos de evaluación se usan en la regla de la mano derecha para n subintervalos?
    ...
    <p>
        Sirve cuando el integrando esta formado por un producto o una division que se podra escribir como producto.
    </p>
    <hr>
    indique si se integra por partes o no (si/no):
    <br><br>
    \( \int xe^{x^{2}} \)
    <br><br>
    ...
    <p id="mensaje" style="display:none;">El término <code>x</code> en el
    producto <code>x e<sup>-x<sup>2</sup></sup></code>
    es una pista clave de que proviene de la derivada del exponente <code>-x<sup>2</sup></code>. Esto es lo
    que hace que la 
    <strong>sustitución</strong> sea el método ideal para resolver esta integral.</p>
    <br><br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_4 ?>
    <hr>
    <strong>indique la derivada (factorizada)</strong>
    <br><br>
    \( x  e^{x^2} \)
    <br><br>
    <span id="formula">
    ...
    <br><br>
    <input type="text" name="respuesta_5" id="quinto" oninput="actualizarFormula()" value="<?php echo $respuesta_5; ?>">
    <br>
    <button type="submit">Enviar</button>
    <?php echo $verificar_5 ?>
    <hr>

    <strong>indique la integral</strong>
    <br><br>
    \( x  e^{x^2} \)
    <br><br>
    <span id="formula2">
    ...
    <br><br>
    <input type="text" name="respuesta_6" id="sexto" oninput="actualizarFormula2()" value="<?php echo $respuesta_6; ?>">
    <br>
    <button type="submit">Enviar</button>
